...
priority: P1
quality_grade: A
slug: 092-epicenter-design
subcategory: mgmt
tags:
- mgmt
title: 092 Epicenter Design
word_count: 1205
---
...
[Next: Three State Solution](09.3-three-state-solution.html)
...
Epicenter design focuses on the true essence of the page — the epicenter
— and then builds outward. This means that, at the start, you ignore the
extremities: the navigation/tabs, footer, colors, sidebar, logo, etc.
Instead, you start at the epicenter and design the most important piece
of content first.
...
<a href="09.3-three-state-solution.html" class="button">Three State
Solution →</a>
