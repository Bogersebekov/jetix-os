...
priority: P1
quality_grade: A
slug: 094-the-blank-slate
subcategory: mgmt
tags:
- mgmt
title: 094 The Blank Slate
word_count: 1402
---
...
[Next: Get Defensive](09.5-get-defensive.html)
...
make. The blank slate is your app’s first impression and you never get a
...
However, the natural state of the app is one that’s devoid of data. When
someone signs up, they start with a blank slate. Much like a weblog,
it’s up to them to populate it — the overall look and feel doesn’t take
shape until people enter their data: posts, links, comments, hours,
sidebar info, or whatever.
...
> think Jobs looks at the first-run experience and thinks, it may only
> be one-thousandth of a user’s overall experience with the machine, but
...
<a href="09.5-get-defensive.html" class="button">Get Defensive →</a>
