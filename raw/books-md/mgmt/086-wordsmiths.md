...
[Next: Interface First](09.1-interface-first.html)
...
They can put themselves in someone else’s shoes. They know what to omit.
They think clearly. And those are the qualities you need.
...
> and also helping (not making) other people understand things. It
> spills over into code, personal communications, instant messaging (for
> those long-distance collaborations), and even such esoteric concepts
> as professionalism and reliability.

—Dustin J. Mitchell, developer (from [Signal vs.
Noise](https://www.37signals.com/svn/archives2/hiring_tip.php))
...
of Georgia (from [How to Write More Clearly, Think More Clearly, and
Learn Complex Material More
Easily](https://web.archive.org/web/20050715023132/http://www.ai.uga.edu/mc/WriteThinkLearn_files/frame.htm))

<a href="09.1-interface-first.html" class="button">Interface First →</a>
