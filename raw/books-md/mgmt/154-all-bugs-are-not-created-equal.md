...
priority: P1
quality_grade: A
slug: 154-all-bugs-are-not-created-equal
subcategory: mgmt
tags:
- mgmt
title: 154 All Bugs Are Not Created Equal
word_count: 1166
---
...
[Next: Ride Out the Storm](15.5-ride-out-the-storm.html)
...
Just because you discover a bug in your product, doesn’t mean it’s time
to panic. All software has bugs — it’s just a fact of life.
...
you’ve noted the issue and are dealing with it. If it won’t be addressed
right away, explain why and say you’re focusing on areas of the product
that affect a greater number of people. Honesty is the best policy.

<a href="15.5-ride-out-the-storm.html" class="button">Ride Out the Storm
→</a>
