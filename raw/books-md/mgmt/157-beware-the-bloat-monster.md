...
priority: P1
quality_grade: A
slug: 157-beware-the-bloat-monster
subcategory: mgmt
tags:
- mgmt
title: 157 Beware The Bloat Monster
word_count: 1153
---
...
[Next: Go With The Flow](15.8-go-with-the-flow.html)
...
As things progress, don’t be afraid to resist bloat. The temptation will
be to scale up. But it doesn’t have to be that way. Just because
...
knife. You can just be a screwdriver. You don’t need to build a diving
watch that’s safe at 5,000 meters if your customers are land-lovers who
just want to know what the time is.
...
adding more and more and more, you just need to provide an ongoing
valuable service.

<a href="15.8-go-with-the-flow.html" class="button">Go With The Flow
→</a>
