...
<a href="governance.html#content-area"
...
- <span id="/community/contributing"><a href="contributing.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Contributing
  to MCP</span>

  </div>

  </div>
- <span id="/community/communication"><a href="communication.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Contributor
  Communication</span>

  </div>

  </div>
- <span id="/community/working-interest-groups"><a href="working-interest-groups.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Working and
  Interest Groups</span>

  </div>

  </div>
- <span id="/community/charter-template"><a href="charter-template.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Group
  Charter Template</span>
...
- <span id="/community/design-principles"><a href="design-principles.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Design
  Principles</span>

  </div>

  </div>
- <span id="/community/sep-guidelines"><a href="sep-guidelines.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/community/governance"><a href="governance.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Governance
  and Stewardship</span>

  </div>

  </div>
- <span id="/community/contributor-ladder"><a href="contributor-ladder.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/community/sdk-tiers"><a href="sdk-tiers.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">SDK Tiering
  System</span>

  </div>

  </div>
- <span id="/community/antitrust"><a href="antitrust.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Antitrust
  Policy</span>
...
- <span id="/community/inspector-v2/charter"><a href="inspector-v2/charter.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Inspector V2
  Working Group Charter</span>

  </div>

  </div>
- <span id="/community/interceptors/charter"><a href="interceptors/charter.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Interceptors
  Charter</span>

  </div>

  </div>
- <span id="/community/server-card/charter"><a href="server-card/charter.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Server Card
  Charter</span>

  </div>

  </div>
- <span id="/community/skills-over-mcp/charter"><a href="skills-over-mcp/charter.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Skills Over
  MCP Charter</span>

  </div>

  </div>
- <span id="/community/triggers-events/charter"><a href="triggers-events/charter.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Triggers and
  Events Charter</span>
...
- <span id="/development/roadmap"><a href="../development/roadmap.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Roadmap</span>
...
- <a href="governance.html#general-project-policies"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">General
  Project Policies</a>
- <a href="governance.html#technical-governance"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Technical
  Governance</a>
- <a href="governance.html#communication-channels"
  ...
  style="padding-left:1rem">Communication Channels</a>
- <a href="governance.html#roles"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Roles</a>
- <a href="governance.html#decision-process"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Decision Process</a>
- <a href="governance.html#processes"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Processes</a>
- <a href="governance.html#working-groups-and-interest-groups"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Working Groups and Interest Groups</a>
- <a href="governance.html#specification-enhancement-proposals-seps"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Specification Enhancement Proposals (SEPs)</a>
- <a href="governance.html#maintenance-responsibilities"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Maintenance Responsibilities</a>
- <a href="governance.html#communication"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Communication</a>
- <a href="governance.html#core-maintainer-meetings"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Core Maintainer Meetings</a>
- <a href="governance.html#public-chat"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Public Chat</a>
- <a href="governance.html#nominating-confirming-and-removing-maintainers"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Nominating,
  Confirming, and Removing Maintainers</a>
- <a href="governance.html#current-lead-maintainers"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Current
  Lead Maintainers</a>
- <a href="governance.html#current-core-maintainers"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Current
  Core Maintainers</a>
- <a href="governance.html#emeritus"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Emeritus</a>
- <a href="governance.html#current-maintainers-and-working-groups"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Current
  Maintainers and Working Groups</a>
...
Learn about the Model Context Protocol’s governance structure and how to
...
page-title="Governance and Stewardship"
page-href="/community/governance">

<span data-as="p">The Model Context Protocol (MCP) follows a formal
governance model to ensure transparent decision-making and community
participation. This document outlines how the project is organized and
how decisions are made.</span>
...
<span class="cursor-pointer">General Project Policies</span>

<span data-as="p">Model Context Protocol has been established as **Model
Context Protocol a Series of LF Projects, LLC**. Policies applicable to
Model Context Protocol and participants in Model Context Protocol,
including guidelines on the usage of trademarks, are located at
<a href="https://www.lfprojects.org/policies/" class="link"
target="_blank"
rel="noreferrer">https://www.lfprojects.org/policies/</a>. Governance
changes approved as per the provisions of this governance document must
also be approved by LF Projects, LLC.</span> <span data-as="p">Model
Context Protocol participants acknowledge that the copyright in all new
contributions will be retained by the copyright holder as independent
works of authorship and that no contributor or copyright holder will be
required to assign copyrights to the project.</span>
<span data-as="p">Except as described below, all code and specification
contributions to the project must be made using the Apache License,
Version 2.0 (available here:
<a href="https://www.apache.org/licenses/LICENSE-2.0" class="link"
target="_blank"
rel="noreferrer">https://www.apache.org/licenses/LICENSE-2.0</a>) (the
“Project License”).</span> <span data-as="p">All outbound code and
specifications will be made available under the Project License. The
Core Maintainers may approve the use of an alternative open license or
licenses for inbound or outbound contributions on an exception
basis.</span> <span data-as="p">All documentation (excluding
specifications) will be made available under Creative Commons
Attribution 4.0 International license, available at:
<a href="https://creativecommons.org/licenses/by/4.0" class="link"
target="_blank"
rel="noreferrer">https://creativecommons.org/licenses/by/4.0</a>.</span>
...
<span class="cursor-pointer">Technical Governance</span>

<span data-as="p">The MCP project adopts a hierarchical structure,
similar to Python, PyTorch, and other open source projects:</span>
...
- **Contributors** file issues, make pull requests, and contribute to
  the project.
- **Maintainers** drive components within the MCP project, such as SDKs,
  documentation, and Working Groups.
- **Core Maintainers** drive the overall project direction and oversee
  contributors and maintainers.
- **Lead Maintainers** are the final decision makers (also known as
  BDFL - Benevolent Dictator for Life).

<span data-as="p">Together, Maintainers, Core Maintainers, and Lead
Maintainers form the **MCP Steering Group**.</span>
<span data-as="p">All maintainers are expected to have a strong bias
towards MCP’s design philosophy. Membership in the technical governance
process is for individuals, not companies. That is, there are no seats
reserved for specific companies, and membership is associated with the
person rather than the company employing that person.</span>
...
<span class="cursor-pointer">Communication Channels</span>

<span data-as="p">Technical governance is facilitated through a shared
<a href="https://discord.gg/6CSzBmMkjX" class="link" target="_blank"
rel="noreferrer">Discord server</a> for all maintainers. Each maintainer
group can choose additional communication channels, but all decisions
and their supporting discussions must be recorded and made transparently
available on the Discord server.</span>
...
<span class="cursor-pointer">Roles</span>

<span data-as="p">The
<a href="contributor-ladder.html" class="link">Contributor Ladder</a> is
the canonical definition of each role — its requirements,
responsibilities, privileges, advancement process, and inactivity
policy. This section gives a conceptual overview of how the roles relate
to governance.</span> <span data-as="p">**Maintainers** steward specific
areas such as SDKs, documentation, or
<a href="working-interest-groups.html" class="link">Working Groups</a>.
They make decisions for their area independently and escalate to Core
Maintainers when needed. Maintainers have write access to their
respective repositories.</span> <span data-as="p">**Core Maintainers**
steer the MCP specification and overall project direction. They can veto
Maintainer decisions by majority vote, resolve disputes, and appoint or
remove Maintainers. Core Maintainers have admin access to all MCP
repositories but use the same pull-request workflow as outside
contributors.</span> <span data-as="p">**Lead Maintainers** hold final
authority and can veto any decision by Core Maintainers or Maintainers —
the role commonly known as Benevolent Dictator for Life (BDFL). Lead
Maintainers appoint and remove Core Maintainers, and are administrators
on all project infrastructure. They are part of the Core Maintainer
group and are expected to publicly articulate their reasoning.</span>
<span data-as="p">The
<a href="contributor-ladder.html" class="link">Contributor Ladder</a>
also defines the **Member** and **Community Moderator** roles, which sit
outside the Steering Group.</span>
...
<span class="cursor-pointer">Decision Process</span>

<span data-as="p">The Core Maintainer group meets every two weeks to
discuss and vote on proposals, as well as discuss any topics needed. The
shared Discord server can be used to discuss and vote on smaller
proposals if needed.</span> <span data-as="p">The Lead Maintainer, Core
Maintainer, and Maintainer group should attempt to meet in person every
three to six months.</span>
...
<span class="cursor-pointer">Processes</span>

<span data-as="p">Core Maintainers and Lead Maintainers are responsible
for all aspects of Model Context Protocol, including documentation,
issues, suggestions for content, and all other parts under the
<a href="https://github.com/modelcontextprotocol" class="link"
target="_blank" rel="noreferrer">MCP project</a>. Maintainers are
responsible for documentation, issues, and suggestions of content for
their area of the MCP project, but are encouraged to partake in general
maintenance of the MCP projects.</span> <span data-as="p">Maintainers,
Core Maintainers, and Lead Maintainers should use the same contribution
process as external contributors, rather than making direct changes to
repos. This provides insight into intent and opportunity for
discussion.</span>
...
<span class="cursor-pointer">Working Groups and Interest Groups</span>

<span data-as="p">MCP collaboration and contributions are organized
around two structures:
<a href="working-interest-groups.html" class="link">Working Groups and
Interest Groups</a>.</span>

- **Interest Groups** identify and articulate problems that MCP should
  address through open discussions
- **Working Groups** develop concrete solutions by producing
  deliverables like SEPs or implementations

<span data-as="p">For details on how to create, participate in, and
facilitate these groups, see the
<a href="working-interest-groups.html" class="link">Working and Interest
Groups</a> documentation.</span>
...
<span class="cursor-pointer">Specification Enhancement Proposals
(SEPs)</span>

<span data-as="p">Proposed changes to the specification must be
submitted as
<a href="sep-guidelines.html" class="link">Specification Enhancement
Proposals (SEPs)</a>. SEPs are the primary mechanism for proposing major
new features, collecting community input, and documenting design
decisions.</span> <span data-as="p">For the complete SEP process, format
requirements, and status workflow, see the
<a href="sep-guidelines.html" class="link">SEP Guidelines</a>.</span>
...
<span class="cursor-pointer">Maintenance Responsibilities</span>

<span data-as="p">Components without dedicated maintainers (such as
documentation) fall under Core Maintainer responsibility. These follow
standard contribution guidelines through pull requests, with maintainers
handling reviews and escalating to Core Maintainer review for any
significant changes.</span> <span data-as="p">Core Maintainers and
Maintainers are encouraged to improve any part of the MCP project,
regardless of formal maintenance assignments.</span>
...
<span class="cursor-pointer">Communication</span>
...
<span class="cursor-pointer">Core Maintainer Meetings</span>

<span data-as="p">The Core Maintainer group meets on a bi-weekly basis
to discuss proposals and the project. Notes on proposals should be made
public. The Core Maintainer group will strive to meet in person every
3-6 months.</span>
...
<span class="cursor-pointer">Public Chat</span>

<span data-as="p">The MCP project maintains a
<a href="https://discord.gg/6CSzBmMkjX" class="link" target="_blank"
rel="noreferrer">public Discord server</a> with open chats for interest
groups. The MCP project may have private channels for certain
communications.</span>
...
<span class="cursor-pointer">Nominating, Confirming, and Removing
Maintainers</span>

<span data-as="p">Membership in maintainer groups is given to
**individuals** on a merit basis after demonstrated expertise and
alignment with MCP’s direction. Membership is associated with the
person, not their employer, and has no term limit.</span>
<span data-as="p">The nomination process, sponsorship requirements,
review timeline, and inactivity criteria for each role are defined in
the <a href="contributor-ladder.html#advancement-process"
class="link">Contributor Ladder’s Advancement Process</a>.</span>
...
<span class="cursor-pointer">Current Lead Maintainers</span>
...
<span class="cursor-pointer">Current Core Maintainers</span>
...
<span class="cursor-pointer">Emeritus</span>
...
<span class="cursor-pointer">Current Maintainers and Working
Groups</span>

<span data-as="p">Refer to <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/MAINTAINERS.md"
class="link" target="_blank" rel="noreferrer">the maintainer list</a>.</span>
...
Guidelines</span></a><a href="contributor-ladder.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Contributor
Ladder</span><img
