...
<a href="charter.html#content-area"
...
- <span id="/community/server-card/charter"><a href="charter.html"
...
- <a href="charter.html#group-type"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Group
  Type</a>
- <a href="charter.html#mission-statement"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Mission
  Statement</a>
- <a href="charter.html#scope"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Scope</a>
- <a href="charter.html#in-scope"
  ...
  style="padding-left:1rem">In Scope</a>
- <a href="charter.html#out-of-scope"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Out of Scope</a>
- <a href="charter.html#related-groups"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Related Groups</a>
- <a href="charter.html#leadership"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Leadership</a>
- <a href="charter.html#authority-%26-decision-rights"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Authority
  &amp; Decision Rights</a>
- <a href="charter.html#membership"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Membership</a>
- <a href="charter.html#operations"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Operations</a>
- <a href="charter.html#deliverables-%26-success-metrics"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Deliverables
  &amp; Success Metrics</a>
- <a href="charter.html#active-work-items"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Active Work Items</a>
- <a href="charter.html#success-criteria"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Success Criteria</a>
- <a href="charter.html#active-work-items-2"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Active Work Items</a>
- <a href="charter.html#success-criteria-2"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Success Criteria</a>
- <a href="charter.html#changelog"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Changelog</a>
...
page-title="Server Card Charter"
page-href="/community/server-card/charter">
...
<span class="cursor-pointer">Group Type</span>

<span data-as="p">**Working Group**</span>
...
<span class="cursor-pointer">Mission Statement</span>

<span data-as="p">The Server Card Working Group exists to define
mechanisms that facilitate discovery and usage of MCP servers via common
discovery mechanisms, and to provide guidance on how this fits into
broader AI standardization efforts around discovery. Concretely, the WG
will define what constitutes an MCP Server Card, the standardized
document format a Server Card must follow, and how clients discover a
Server Card for a given server.</span>
...
<span class="cursor-pointer">Scope</span>
...
<span class="cursor-pointer">In Scope</span>

- **Specification Work**: SEPs or extensions defining what constitutes
  an MCP Server Card and the specific format of the Server Card
  document.
- **Discovery Mechanism**: Specification of how an MCP Server Card
  document is discovered (well-known URL, resource-based discovery,
  etc.).
- **Cross-Ecosystem Coordination**: A recommendation to the
  <a href="https://github.com/Agent-Card/ai-card" class="link"
  target="_blank" rel="noreferrer">AI Card</a> effort on how to interact
  with MCP Server Cards.
- **Documentation**: Specification sections and guidance covering Server
  Card authoring and consumption.
...
<span class="cursor-pointer">Out of Scope</span>

- Changes to the MCP initialization handshake or transport layer.
- A general-purpose MCP server registry or catalog (owned by the
  Registry WG).
- Internationalization of Server Card content until an MCP-wide i18n
  approach is defined.
...
<span class="cursor-pointer">Related Groups</span>

- **Registry WG** — Server Card format should stay as close as possible
  to a subset of `server.json`; coordination required to avoid
  divergence.
- **AI Card effort** (external) — ongoing discussion on whether and how
  an AI Catalog can link directly to an MCP Server Card.
...
<span class="cursor-pointer">Leadership</span>
...
|----|----|----|----|----|
| Lead | David Soria Parra | Anthropic | <a href="https://github.com/dsp-ant" class="link" target="_blank"
rel="noreferrer">@dsp-ant</a> | 6 months (ends Aug 14, 2026) |
| Lead | Sam Morrow Drums | GitHub | <a href="https://github.com/SamMorrowDrums" class="link" target="_blank"
rel="noreferrer">@SamMorrowDrums</a> | 6 months (ends Aug 14, 2026) |
...
<a href="charter.html#authority-&amp;-decision-rights"
class="-ml-10 flex items-center opacity-0 border-0 group-hover:opacity-100 focus:opacity-100 focus:outline-0 group/link"
aria-label="Navigate to header">​</a>
...
<span class="cursor-pointer">Authority & Decision Rights</span>
...
<span class="cursor-pointer">Membership</span>
...
|----|----|----|----|----|
| David Soria Parra | Anthropic | <a href="https://github.com/dsp-ant" class="link" target="_blank"
rel="noreferrer">@dsp-ant</a> |  | Lead |
| Sam Morrow Drums | GitHub | <a href="https://github.com/SamMorrowDrums" class="link" target="_blank"
rel="noreferrer">@SamMorrowDrums</a> |  | Lead |
| Tadas Antanavicius |  | <a href="https://github.com/tadasant" class="link" target="_blank"
rel="noreferrer">@tadasant</a> |  | WG Member |
...
<span class="cursor-pointer">Operations</span>
...
<span data-as="p">Discord: <a
href="https://discord.com/channels/1358869848138059966/1399986204405141534"
class="link" target="_blank" rel="noreferrer">#server-card-wg</a></span>

## 

<div class="absolute" tabindex="-1">

<a href="charter.html#deliverables-&amp;-success-metrics"
class="-ml-10 flex items-center opacity-0 border-0 group-hover:opacity-100 focus:opacity-100 focus:outline-0 group/link"
aria-label="Navigate to header">​</a>
...
<span class="cursor-pointer">Deliverables & Success Metrics</span>
...
<span class="cursor-pointer">Active Work Items</span>
...
class="link" target="_blank" rel="noreferrer">SEP-2127: MCP Server
Card</a> | Draft | Apr 3, 2026 | <a href="https://github.com/dsp-ant" class="link" target="_blank"
...
<span class="cursor-pointer">Success Criteria</span>
...
<span class="cursor-pointer">Changelog</span>
...
<a href="../interceptors/charter.html"
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Interceptors
Charter</span></a><a href="../skills-over-mcp/charter.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Skills
Over MCP Charter</span><img
