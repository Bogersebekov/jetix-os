...
priority: P2
quality_grade: A
slug: 1034-support-default-values-for-all-primitive-types-in
subcategory: meta
tags:
- meta
title: 1034 Support Default Values For All Primitive Types In
word_count: 4296
---
...
<a
href="1034--support-default-values-for-all-primitive-types-in.html#content-area"
...
SEP-1034: Support default values for all primitive types in elicitation
schemas
...
- <a
  ...
  style="padding-left:1rem">Real-World Example</a>
- <a
  href="1034--support-default-values-for-all-primitive-types-in.html#implementation"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Implementation</a>
- <a
  href="1034--support-default-values-for-all-primitive-types-in.html#specification"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Specification</a>
- <a
  href="1034--support-default-values-for-all-primitive-types-in.html#schema-changes"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Schema Changes</a>
- <a
  href="1034--support-default-values-for-all-primitive-types-in.html#behavior"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Behavior</a>
- <a
  href="1034--support-default-values-for-all-primitive-types-in.html#rationale"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Rationale</a>
- <a
  href="1034--support-default-values-for-all-primitive-types-in.html#alternatives-considered"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Alternatives Considered</a>
- <a
  href="1034--support-default-values-for-all-primitive-types-in.html#backwards-compatibility"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Backwards
  Compatibility</a>
- <a
  href="1034--support-default-values-for-all-primitive-types-in.html#security-implications"
...
page-title="SEP-1034: Support default values for all primitive types in elicitation schemas"
page-href="/seps/1034--support-default-values-for-all-primitive-types-in">
...
| **Created** | 2025-07-22 |
| **Author(s)** | Tapan Chugh (chugh.tapan<a href="https://github.com/gmail" class="link" target="_blank"
rel="noreferrer">@gmail</a>.com) |
| **Sponsor** | None |
| **PR** | <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1034"
class="link" target="_blank" rel="noreferrer">#1034</a> |
...
<span data-as="p">This SEP recommends adding support for default values
to all primitive types in the MCP elicitation schema (StringSchema,
NumberSchema, and EnumSchema), extending the existing support that only
covers BooleanSchema.</span>
...
<span data-as="p">Elicitations in MCP offer a way to mitigate complex
API designs: tools can request information on-demand rather than
resorting to convoluted parameter handling. The challenge however is
that users must manually enter obvious information that could be
pre-populated for more natural interactions. Currently, only
`BooleanSchema` supports default values in elicitation requests. This
limitation prevents servers from providing sensible defaults for text
inputs, numbers, and enum selections leading to more user
overhead.</span>
...
<span class="cursor-pointer">Real-World Example</span>

<span data-as="p">Consider implementing an email reply function. Without
elicitation, the tool becomes unwieldy:</span>
...
<span data-as="p">With elicitation, the tool signature itself can be
much simpler</span>
...
<span data-as="p">A working implementation demonstrating clients require
minimal changes to display defaults (~10 lines of code):</span>

- Implementation PR:
  <a href="https://github.com/chughtapan/fast-agent/pull/2" class="link"
  target="_blank"
  rel="noreferrer">https://github.com/chughtapan/fast-agent/pull/2</a>
- A demo with the above email reply workflow:
  <a href="https://asciinema.org/a/X7aQZjT2B5jVwn9dJ9sqQVkOM" class="link"
  target="_blank"
  rel="noreferrer">https://asciinema.org/a/X7aQZjT2B5jVwn9dJ9sqQVkOM</a>
...
<span data-as="p">Extend the elicitation primitive schemas to include
optional default values:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="29" language="typescript">
...
<span class="cursor-pointer">Behavior</span>

1.  The `default` field is optional, maintaining full backward
    compatibility
2.  Default values must match the schema type
3.  For EnumSchema, the default must be one of the valid enum values
4.  Clients that support defaults SHOULD pre-populate form fields.
    Clients that don’t support defaults MAY ignore the field entirely.
...
1.  The high-level rationale is to follow the precedent set by
    BooleanSchema rather than creating new mechanisms.
2.  Making defaults optional ensures backward compatibility.
3.  This maintains the high-level intuition of keeping the client
...
1.  **Server-side Templates**: Servers could maintain templates
    separately, but this adds complexity
2.  **New Request Type**: A separate request type for forms with
    defaults would fragment the API
3.  **Required Defaults**: Making defaults required would break existing
    implementations
...
<span data-as="p">This change is fully backward compatible with no
breaking changes. Clients that don’t understand defaults will ignore
them, and existing elicitation requests continue to work unchanged.
Clients can adopt default support at their own pace</span>
...
<span data-as="p">No new security concerns:</span>

1.  **No Sensitive Data**: The existing guidance against requesting
    sensitive information still applies
2.  **Client Control**: Clients retain full control over what data is
    sent to servers
3.  **User Visibility**: Default values are visible to users who can
    modify them before submission
...
<a href="1024-mcp-client-security-requirements-for-local-server-.html"
...
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-1024:
MCP Client Security Requirements for Lo…</span></a><a href="1036-url-mode-elicitation-for-secure-out-of-band-intera.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-1036:
URL Mode Elicitation for secure out-of-…</span><img
