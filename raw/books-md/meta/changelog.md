...
<a href="changelog.html#content-area"
...
- <span id="/specification/2025-11-25/changelog"><a href="changelog.html"
...
- <span id="/specification/2025-11-25/architecture"><a href="architecture.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/specification/2025-11-25/basic"><a href="basic.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/specification/2025-11-25/client/roots"><a href="client/roots.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/specification/2025-11-25/server"><a href="server.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/specification/2025-11-25/schema"><a href="schema.html"
...
- <a href="changelog.html#major-changes"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Major
  changes</a>
- <a href="changelog.html#minor-changes"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Minor
  changes</a>
- <a href="changelog.html#other-schema-changes"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Other
  schema changes</a>
- <a href="changelog.html#governance-and-process-updates"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Governance
  and process updates</a>
- <a href="changelog.html#full-changelog"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Full
  changelog</a>
...
page-title="Key Changes"
page-href="/specification/2025-11-25/changelog">

<div id="enable-section-numbers">

</div>

<span data-as="p">This document lists changes made to the Model Context
Protocol (MCP) specification since the previous revision,
<a href="https://modelcontextprotocol.io/specification/2025-06-18"
class="link">2025-06-18</a>.</span>
...
<span class="cursor-pointer">Major changes</span>

1.  Enhance authorization server discovery with support for
    <a href="https://openid.net/specs/openid-connect-discovery-1_0.html"
    class="link" target="_blank" rel="noreferrer">OpenID Connect Discovery
    1.0</a>. (PR <a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/797"
    class="link" target="_blank" rel="noreferrer">#797</a>)
2.  Allow servers to expose icons as additional metadata for tools,
    resources, resource templates, and prompts (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/973"
    class="link" target="_blank" rel="noreferrer">SEP-973</a>).
3.  Enhance authorization flows with incremental scope consent via
    ...
    class="link" target="_blank" rel="noreferrer">SEP-835</a>)
4.  Provide guidance on tool names (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1603"
    class="link" target="_blank" rel="noreferrer">SEP-986</a>)
5.  Update `ElicitResult` and `EnumSchema` to use a more standards-based
    approach and support titled, untitled, single-select, and
    multi-select enums (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1330"
    class="link" target="_blank" rel="noreferrer">SEP-1330</a>).
6.  Added support for
    <a href="../latest/client/elicitation.html#url-elicitation-requests"
    class="link">URL mode elicitation</a> (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/887"
    class="link" target="_blank" rel="noreferrer">SEP-1036</a>)
7.  Add tool calling support to sampling via `tools` and `toolChoice`
    parameters (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1577"
    class="link" target="_blank" rel="noreferrer">SEP-1577</a>)
8.  Add support for OAuth Client ID Metadata Documents as a recommended
    client registration mechanism (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/991"
    class="link" target="_blank" rel="noreferrer">SEP-991</a>, PR <a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1296"
    class="link" target="_blank" rel="noreferrer">#1296</a>)
9.  Add experimental support for <a
    href="https://modelcontextprotocol.io/specification/2025-11-25/basic/utilities/tasks"
    class="link">tasks</a> to enable tracking durable requests with
    polling and deferred result retrieval (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1686"
    class="link" target="_blank" rel="noreferrer">SEP-1686</a>).
...
<span class="cursor-pointer">Minor changes</span>

1.  Clarify that servers using stdio transport may use stderr for all
    types of logging, not just error messages (PR <a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/670"
    class="link" target="_blank" rel="noreferrer">#670</a>).
2.  Add optional `description` field to `Implementation` interface to
    align with MCP registry server.json format and provide
    human-readable context during initialization.
3.  Clarify that servers must respond with HTTP 403 Forbidden for
    invalid Origin headers in Streamable HTTP transport. (PR <a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1439"
    class="link" target="_blank" rel="noreferrer">#1439</a>)
4.  Updated the <a
    href="https://modelcontextprotocol.io/specification/draft/basic/security_best_practices"
    class="link" target="_blank" rel="noreferrer">Security Best Practices
    guidance</a>.
5.  Clarify that input validation errors should be returned as Tool
    Execution Errors rather than Protocol Errors to enable model
    self-correction (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1303"
    class="link" target="_blank" rel="noreferrer">SEP-1303</a>).
6.  Support polling SSE streams by allowing servers to disconnect at
    will (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1699"
    class="link" target="_blank" rel="noreferrer">SEP-1699</a>).
7.  Clarify SEP-1699: GET streams support polling, resumption always via
    GET regardless of stream origin, event IDs should encode stream
    identity, disconnection includes server-initiated closure (Issue <a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1847"
    class="link" target="_blank" rel="noreferrer">#1847</a>).
8.  Align OAuth 2.0 Protected Resource Metadata discovery with RFC 9728,
    ...
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/985"
    class="link" target="_blank" rel="noreferrer">SEP-985</a>).
9.  Add support for default values in all primitive types (string,
    number, enum) for elicitation schemas (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1034"
    class="link" target="_blank" rel="noreferrer">SEP-1034</a>).
10. Establish JSON Schema 2020-12 as the default dialect for MCP schema
    definitions (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1613"
    class="link" target="_blank" rel="noreferrer">SEP-1613</a>).
...
<span class="cursor-pointer">Other schema changes</span>

1.  Decouple request payloads from RPC method definitions into
    standalone parameter schemas. (<a
    href="https://github.com/modelcontextprotocol/specification/issues/1319"
    class="link" target="_blank" rel="noreferrer">SEP-1319</a>, PR <a
    href="https://github.com/modelcontextprotocol/specification/pull/1284"
    class="link" target="_blank" rel="noreferrer">#1284</a>)
...
<span class="cursor-pointer">Governance and process updates</span>

1.  Formalize Model Context Protocol governance structure (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/932"
    class="link" target="_blank" rel="noreferrer">SEP-932</a>).
2.  Establish shared communication practices and guidelines for the MCP
    community (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/994"
    class="link" target="_blank" rel="noreferrer">SEP-994</a>).
3.  Formalize Working Groups and Interest Groups in MCP governance (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1302"
    class="link" target="_blank" rel="noreferrer">SEP-1302</a>).
4.  Establish SDK tiering system with clear requirements for feature
    support and maintenance commitments (<a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1730"
    class="link" target="_blank" rel="noreferrer">SEP-1730</a>).
...
<span class="cursor-pointer">Full changelog</span>

<span data-as="p">For a complete list of all changes that have been made
since the last protocol revision, <a
href="https://github.com/modelcontextprotocol/specification/compare/2025-06-18...2025-11-25"
class="link" target="_blank" rel="noreferrer">see GitHub</a>.</span>
...
<a href="../latest.html" class="flex items-center space-x-3 group"><img
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Specification</span></a><a
href="https://modelcontextprotocol.io/specification/2025-11-25/architecture/index"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Architecture</span><img
