...
priority: P2
quality_grade: A
slug: 973-expose-additional-metadata-for-implementations-res
subcategory: meta
tags:
- meta
title: 973 Expose Additional Metadata For Implementations Res
word_count: 4150
---
...
<a
href="973-expose-additional-metadata-for-implementations-res.html#content-area"
...
SEP-973: Expose additional metadata for Implementations, Resources,
Tools and Prompts
...
- <a
  ...
  style="padding-left:1rem">Current State</a>
- <a
  href="973-expose-additional-metadata-for-implementations-res.html#proposed-state"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Proposed State</a>
- <a
  href="973-expose-additional-metadata-for-implementations-res.html#rationale"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Rationale</a>
- <a
  href="973-expose-additional-metadata-for-implementations-res.html#specification"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Specification</a>
- <a
  href="973-expose-additional-metadata-for-implementations-res.html#backwards-compatibility"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Backwards
  Compatibility</a>
- <a
  href="973-expose-additional-metadata-for-implementations-res.html#security-implications"
...
Expose additional metadata for Implementations, Resources, Tools and
Prompts
...
page-title="SEP-973: Expose additional metadata for Implementations, Resources, Tools and Prompts"
page-href="/seps/973-expose-additional-metadata-for-implementations-res">
...
| **Created** | 2025-07-15 |
| **Author(s)** | <a href="https://github.com/jesselumarie" class="link" target="_blank"
rel="noreferrer">@jesselumarie</a> |
| **Sponsor** | None |
| **PR** | <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/973"
class="link" target="_blank" rel="noreferrer">#973</a> |
...
<span data-as="p">This SEP proposes adding two optional fields—`icons`
and `websiteUrl`. The `icons` and `websiteUrl` would be added to the
`Implementation` schema so that clients can visually identify
third-party implementations and link directly to their documentation.
The `icons` parameter will also be added to the `Tool`, `Resource` and
`Prompt` schemas. While this can be used by both servers and clients for
all implementations, we expect it to be used initially for
server-provided implementations.</span>
...
<span class="cursor-pointer">Current State</span>

<span data-as="p">Current implementations only expose namespaced
metadata, forcing clients to display generic labels with no visual
cues.</span> <span aria-owns="rmiz-modal-"
rmiz=""><span rmiz-content="not-found" style="visibility:visible"><img
src="https://github.com/user-attachments/assets/0708a467-ed16-4654-8017-47fc30df9b23"
width="606" height="242" alt="Image" /></span></span>
...
<span class="cursor-pointer">Proposed State</span>

<span data-as="p">The proposed implementation would allow us to add
visual affordances and links to documentation, making it easier to
visually identify which servers/clients are providing an implementation
e.g. a tool in a slash command interface:</span>
<span aria-owns="rmiz-modal-" rmiz=""><span rmiz-content="not-found"
style="visibility:visible"><img
src="https://github.com/user-attachments/assets/2989b847-8a35-4c49-bb73-d27828df4df6"
width="1104" height="780" alt="Image" /></span></span>

- **Visual Affordance:** Icons make it immediately clear to users which
  tool or resource source is in use.
- **Discoverability:** A link to documentation (`websiteUrl`) allows
  clients to direct users to more information with a single click.
...
<span data-as="p">This design builds on prior work in web manifests
(MDN) and consolidates community feedback:</span>

- **Consolidation of PRs:** Merges the changes from PR \#417 and PR
  \#862 into a single, cohesive enhancement.
- **Flexible Icon Sizes:** Supports multiple icon sizes (e.g., `48x48`,
  `96x96`, or `any` for vector formats) to accommodate different client
  UI needs.
- **Optional Fields:** By making both fields optional, existing
  implementations remain fully compatible.
...
<span data-as="p">Extend the `Implementation` object as follows:</span>
...
numberoflines="57" language="typescript">
...
<span data-as="p">Extend the `Tool`, `Resource` and `Prompt` interfaces
with the following type:</span>
...
<span data-as="p">Both icons and websiteUrl are optional fields; clients
that ignore them will fall back to existing behavior.</span>
...
<span data-as="p">This shouldn’t introduce any new security
implications.</span>
...
<a href="932-model-context-protocol-governance.html"
...
Model Context Protocol Governance</span></a><a href="985-align-oauth-20-protected-resource-metadata-with-rf.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-985:
Align OAuth 2.0 Protected Resource Meta…</span><img
