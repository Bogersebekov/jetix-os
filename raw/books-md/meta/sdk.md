...
data-active="true">Documentation</a>
...
<a href="../seps.html"
class="link nav-tabs-item group relative h-full gap-2 flex items-center font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300">SEPs</a>
...
- <span id="/docs/getting-started/intro"><a href="../index.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">What is
  MCP?</span>
...
- <span id="/docs/learn/architecture"><a href="learn/architecture.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Architecture</span>

  </div>

  </div>
- <span id="/docs/learn/server-concepts"><a href="learn/server-concepts.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Servers</span>

  </div>

  </div>
- <span id="/docs/learn/client-concepts"><a href="learn/client-concepts.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Clients</span>

  </div>

  </div>
- <span id="/docs/learn/versioning"><a href="learn/versioning.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Versioning</span>
...
- <span id="/docs/develop/connect-local-servers"><a href="develop/connect-local-servers.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Connect to
  local MCP servers</span>

  </div>

  </div>

- <span id="/docs/develop/connect-remote-servers"><a href="develop/connect-remote-servers.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Connect to
  remote MCP Servers</span>

  </div>

  </div>

- <span id="/docs/develop/build-with-agent-skills"><a href="develop/build-with-agent-skills.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Build with
  Agent Skills</span>
...
- <span id="/docs/develop/build-server"><a href="develop/build-server.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Build an MCP
  server</span>
...
- <span id="/docs/develop/build-client"><a href="develop/build-client.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/sdk"><a href="sdk.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] bg-primary/10 text-primary [text-shadow:-0.2px_0_0_currentColor,0.2px_0_0_currentColor] dark:text-primary-light dark:bg-primary-light/10"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">

  <div class="flex min-w-0 flex-1 flex-wrap items-center gap-1.5 [word-break:break-word]">

  <span class="min-w-0 max-w-full break-words hyphens-auto">SDKs</span>
...
- <span id="/docs/tools/inspector"><a href="tools/inspector.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">MCP
  Inspector</span>

  </div>

  </div>
- <span id="/docs/tools/debugging"><a href="tools/debugging.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Debugging</span>
...
- <span id="/clients"><a href="../clients.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Example
  Clients</span>

  </div>

  </div>
- <span id="/examples"><a href="../examples.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <a href="sdk.html#available-sdks"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Available
  SDKs</a>
- <a href="sdk.html#getting-started"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Getting
  Started</a>
- <a href="sdk.html#next-steps"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Next
  Steps</a>
...
page-title="SDKs" page-href="/docs/sdk">

<span data-as="p">Build MCP servers and clients using our official SDKs.
SDKs are classified into tiers based on feature completeness, protocol
support, and maintenance commitment. Learn more about
<a href="../community/sdk-tiers.html" class="link">SDK tiers</a>.</span>
...
<span class="cursor-pointer">Available SDKs</span>
...
|:---|:---|---:|
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   <a href="https://ts.sdk.modelcontextprotocol.io" class="link"
target="_blank" rel="noreferrer">TypeScript</a> | <a href="https://github.com/modelcontextprotocol/typescript-sdk"
class="link" target="_blank"
rel="noreferrer">modelcontextprotocol/typescript-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#E3EAFD] dark:[--color-bg:#07296A] [--color-text:#133A9A] dark:[--color-text:#7196F4] [--color-bg-disabled:#F0F4FE] dark:[--color-bg-disabled:#03153A] [--color-text-disabled:rgba(51,104,240,0.50)] dark:[--color-text-disabled:rgba(51,104,240,0.30)]" badge="true" data-color="blue" data-size="md" data-shape="pill" stroke="false" data-disabled="false">Tier 1</span> |
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   <a href="https://py.sdk.modelcontextprotocol.io" class="link"
target="_blank" rel="noreferrer">Python</a> | <a href="https://github.com/modelcontextprotocol/python-sdk"
class="link" target="_blank"
rel="noreferrer">modelcontextprotocol/python-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#E3EAFD] dark:[--color-bg:#07296A] [--color-text:#133A9A] dark:[--color-text:#7196F4] [--color-bg-disabled:#F0F4FE] dark:[--color-bg-disabled:#03153A] [--color-text-disabled:rgba(51,104,240,0.50)] dark:[--color-text-disabled:rgba(51,104,240,0.30)]" badge="true" data-color="blue" data-size="md" data-shape="pill" stroke="false" data-disabled="false">Tier 1</span> |
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   <a href="https://csharp.sdk.modelcontextprotocol.io" class="link"
target="_blank" rel="noreferrer">C#</a> | <a href="https://github.com/modelcontextprotocol/csharp-sdk"
class="link" target="_blank"
rel="noreferrer">modelcontextprotocol/csharp-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#E3EAFD] dark:[--color-bg:#07296A] [--color-text:#133A9A] dark:[--color-text:#7196F4] [--color-bg-disabled:#F0F4FE] dark:[--color-bg-disabled:#03153A] [--color-text-disabled:rgba(51,104,240,0.50)] dark:[--color-text-disabled:rgba(51,104,240,0.30)]" badge="true" data-color="blue" data-size="md" data-shape="pill" stroke="false" data-disabled="false">Tier 1</span> |
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   <a href="https://go.sdk.modelcontextprotocol.io" class="link"
target="_blank" rel="noreferrer">Go</a> | <a href="https://github.com/modelcontextprotocol/go-sdk" class="link"
target="_blank" rel="noreferrer">modelcontextprotocol/go-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#E3EAFD] dark:[--color-bg:#07296A] [--color-text:#133A9A] dark:[--color-text:#7196F4] [--color-bg-disabled:#F0F4FE] dark:[--color-bg-disabled:#03153A] [--color-text-disabled:rgba(51,104,240,0.50)] dark:[--color-text-disabled:rgba(51,104,240,0.30)]" badge="true" data-color="blue" data-size="md" data-shape="pill" stroke="false" data-disabled="false">Tier 1</span> |
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   <a href="https://java.sdk.modelcontextprotocol.io" class="link"
target="_blank" rel="noreferrer">Java</a> | <a href="https://github.com/modelcontextprotocol/java-sdk" class="link"
target="_blank" rel="noreferrer">modelcontextprotocol/java-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#ECDFFB] dark:[--color-bg:#3A0F71] [--color-text:#5314A3] dark:[--color-text:#B78AF0] [--color-bg-disabled:#ECDFFB] dark:[--color-bg-disabled:#3A0F71] [--color-text-disabled:rgba(135,61,230,0.50)] dark:[--color-text-disabled:rgba(135,61,230,0.30)]" badge="true" data-color="purple" data-size="md" data-shape="pill" stroke="false" data-disabled="false">Tier 2</span> |
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   <a href="https://rust.sdk.modelcontextprotocol.io" class="link"
target="_blank" rel="noreferrer">Rust</a> | <a href="https://github.com/modelcontextprotocol/rust-sdk" class="link"
target="_blank" rel="noreferrer">modelcontextprotocol/rust-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#ECDFFB] dark:[--color-bg:#3A0F71] [--color-text:#5314A3] dark:[--color-text:#B78AF0] [--color-bg-disabled:#ECDFFB] dark:[--color-bg-disabled:#3A0F71] [--color-text-disabled:rgba(135,61,230,0.50)] dark:[--color-text-disabled:rgba(135,61,230,0.30)]" badge="true" data-color="purple" data-size="md" data-shape="pill" stroke="false" data-disabled="false">Tier 2</span> |
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   Swift | <a href="https://github.com/modelcontextprotocol/swift-sdk" class="link"
target="_blank" rel="noreferrer">modelcontextprotocol/swift-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#FDEAD8] dark:[--color-bg:#613105] [--color-text:#AE590A] dark:[--color-text:#F8B577] [--color-bg-disabled:#FEF4EC] dark:[--color-bg-disabled:#301903] [--color-text-disabled:rgba(244,142,47,0.50)] dark:[--color-text-disabled:rgba(244,142,47,0.30)]" badge="true" data-color="orange" data-size="md" data-shape="pill" stroke="false" data-disabled="false">Tier 3</span> |
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   <a href="https://ruby.sdk.modelcontextprotocol.io" class="link"
target="_blank" rel="noreferrer">Ruby</a> | <a href="https://github.com/modelcontextprotocol/ruby-sdk" class="link"
target="_blank" rel="noreferrer">modelcontextprotocol/ruby-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#FDEAD8] dark:[--color-bg:#613105] [--color-text:#AE590A] dark:[--color-text:#F8B577] [--color-bg-disabled:#FEF4EC] dark:[--color-bg-disabled:#301903] [--color-text-disabled:rgba(244,142,47,0.50)] dark:[--color-text-disabled:rgba(244,142,47,0.30)]" badge="true" data-color="orange" data-size="md" data-shape="pill" stroke="false" data-disabled="false">Tier 3</span> |
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   <a href="https://php.sdk.modelcontextprotocol.io" class="link"
target="_blank" rel="noreferrer">PHP</a> | <a href="https://github.com/modelcontextprotocol/php-sdk" class="link"
target="_blank" rel="noreferrer">modelcontextprotocol/php-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#FDEAD8] dark:[--color-bg:#613105] [--color-text:#AE590A] dark:[--color-text:#F8B577] [--color-bg-disabled:#FEF4EC] dark:[--color-bg-disabled:#301903] [--color-text-disabled:rgba(244,142,47,0.50)] dark:[--color-text-disabled:rgba(244,142,47,0.30)]" badge="true" data-color="orange" data-size="md" data-shape="pill" stroke="false" data-disabled="false">Tier 3</span> |
| <img
src="data:image/svg+xml;base64,"
class="icon inline bg-gray-800 dark:bg-gray-100" />   <a href="https://kotlin.sdk.modelcontextprotocol.io" class="link"
target="_blank" rel="noreferrer">Kotlin</a> | <a href="https://github.com/modelcontextprotocol/kotlin-sdk"
class="link" target="_blank"
rel="noreferrer">modelcontextprotocol/kotlin-sdk</a> | <span class="print:print-color-exact print:[&_img]:!m-0 inline-flex items-center w-fit font-medium relative data-[disabled="true"]:cursor-not-allowed data-[shape='pill']:rounded-full data-[stroke='true']:outline data-[stroke='true']:outline-1 data-[stroke='true']:-outline-offset-[1px] data-[stroke='true']:outline-[rgba(11,12,14,0.08)] dark:data-[stroke='true']:outline-[rgba(255,255,255,0.14)] bg-[--color-bg] text-[--color-text] [&_svg]:bg-[--color-text] data-[disabled='true']:bg-[--color-bg-disabled] data-[disabled='true']:text-[--color-text-disabled] [&_svg]:data-[disabled='true']:bg-[--color-text-disabled] gap-1 py-0.5 pl-2 pr-2 [&_svg]:size-3.5 text-sm tracking-[-0.1px] data-[shape="rounded"]:rounded-[8px] [--color-bg:#F5F5F5] dark:[--color-bg:#262727] [--color-text:#78787A] dark:[--color-text:#D7D7D7] [--color-bg-disabled:#F5F5F5] dark:[--color-bg-disabled:#262727] [--color-text-disabled:#E9E9EA] dark:[--color-text-disabled:#3C3C3D]" badge="true" data-color="gray" data-size="md" data-shape="pill" stroke="false" data-disabled="false">TBD</span> |
...
<span data-as="p">See
<a href="../community/sdk-tiers.html" class="link">SDK Tiering
System</a> for details on what each tier means.</span>
...
<span class="cursor-pointer">Getting Started</span>

<span data-as="p">Each SDK provides the same functionality but follows
the idioms and best practices of its language. All SDKs support:</span>
...
<span data-as="p">Visit the SDK page for your chosen language to find
installation instructions, documentation, and examples.</span>
...
<span class="cursor-pointer">Next Steps</span>

<span data-as="p">Ready to start building with MCP? Choose your
path:</span>

<div class="columns prose dark:prose-invert grid max-w-none gap-4 sm:grid-cols-[repeat(var(--cols),minmax(0,1fr))] @2xl/columns-container:grid-cols-[repeat(var(--cols),minmax(0,1fr))] @[0px]/columns-container:grid-cols-1 columns card-group dark:prose-dark gap-y-0"
style="--cols:2">
...
<img
src="data:image/svg+xml;base64,"
...
<span data-as="p">Learn how to create your first MCP server</span>
...
<img
src="data:image/svg+xml;base64,"
class="size-6 bg-primary dark:bg-primary-light !m-0 shrink-0" />
...
<span data-as="p">Create applications that connect to MCP servers</span>
...
<a href="develop/build-client.html"
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Build an
MCP client</span></a><a href="tutorials/security/authorization.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Understanding
Authorization in MCP</span><img
