...
priority: P2
quality_grade: A
slug: 994-shared-communication-practicesguidelines
subcategory: meta
tags:
- meta
title: 994 Shared Communication Practicesguidelines
word_count: 3802
---
...
<a href="994-shared-communication-practicesguidelines.html#content-area"
...
- <a
  href="994-shared-communication-practicesguidelines.html#discord-guidelines"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Discord Guidelines</a>
- <a
  href="994-shared-communication-practicesguidelines.html#public-channels-default"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Public Channels (Default)</a>
- <a
  href="994-shared-communication-practicesguidelines.html#private-channels-exceptions"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Private Channels (Exceptions)</a>
- <a
  href="994-shared-communication-practicesguidelines.html#github-discussions"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">GitHub Discussions</a>
- <a
  href="994-shared-communication-practicesguidelines.html#github-issues"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">GitHub Issues</a>
- <a
  href="994-shared-communication-practicesguidelines.html#decision-records"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Decision Records</a>
- <a href="994-shared-communication-practicesguidelines.html#rationale"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Rationale</a>
- <a
  href="994-shared-communication-practicesguidelines.html#backward-compatibility"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Backward
  Compatibility</a>
- <a
  href="994-shared-communication-practicesguidelines.html#reference-implementation"
...
page-title="SEP-994: Shared Communication Practices/Guidelines"
page-href="/seps/994-shared-communication-practicesguidelines">
...
| **Type** | Process |
| **Created** | 2025-07-17 |
| **Author(s)** | <a href="https://github.com/localden" class="link" target="_blank"
rel="noreferrer">@localden</a> |
| **Sponsor** | None |
| **PR** | <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1002"
class="link" target="_blank" rel="noreferrer">#1002</a> |
...
<span data-as="p">This SEP establishes the communication strategy and
framework for the Model Context Protocol community. It defines the
official channels for contributor communication, guidelines for their
use, and processes for decision documentation.</span>
...
<span data-as="p">As the MCP community grows, clear communication
guidelines are essential for:</span>

- **Consistency**: Ensuring all contributors know where and how to
  communicate
...
- **Security**: Establishing proper processes for handling sensitive
  issues
...
<span data-as="p">The MCP project uses three primary communication
channels:</span>
...
3.  **GitHub Issues**: For actionable tasks, bug reports, and feature
    requests

<span data-as="p">Security-sensitive issues follow a separate process
defined in SECURITY.md.</span>
...
<span class="cursor-pointer">Discord Guidelines</span>

<span data-as="p">The Discord server is designed for **MCP
contributors** and is not intended for general MCP support.</span>
...
<span class="cursor-pointer">Public Channels (Default)</span>
...
<span class="cursor-pointer">Private Channels (Exceptions)</span>

<span data-as="p">Private channels are reserved for:</span>
...
<span data-as="p">All technical and governance decisions must be
documented publicly in GitHub.</span>
...
<span class="cursor-pointer">GitHub Discussions</span>

<span data-as="p">Used for structured, long-form discussion:</span>
...
<span class="cursor-pointer">GitHub Issues</span>

<span data-as="p">Used for actionable items:</span>
...
<span class="cursor-pointer">Decision Records</span>

<span data-as="p">All MCP decisions are documented publicly:</span>
...
<span data-as="p">Decision documentation includes:</span>
...
<span data-as="p">This framework balances openness with
practicality:</span>

- **Public by default**: Maximizes transparency and community
  participation
...
- **Documentation requirements**: Ensures decisions are preserved and
  discoverable
...
<span data-as="p">This SEP establishes new processes and does not affect
existing protocol functionality.</span>
...
<span data-as="p">The communication guidelines are published at:
<a href="../community/communication.html" class="link" target="_blank"
rel="noreferrer">https://modelcontextprotocol.io/community/communication</a></span>
...
<a href="991-enable-url-based-client-registration-using-oauth-c.html"
...
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-991:
Enable URL-based Client Registration us…</span></a><a href="1024-mcp-client-security-requirements-for-local-server-.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-1024:
MCP Client Security Requirements for Lo…</span><img
