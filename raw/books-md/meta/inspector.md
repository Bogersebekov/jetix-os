...
<a href="inspector.html#content-area"
...
- <span id="/docs/tools/inspector"><a href="inspector.html"
...
- <span id="/docs/tools/debugging"><a href="debugging.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <a href="inspector.html#getting-started"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Getting
  started</a>
- <a href="inspector.html#installation-and-basic-usage"
  ...
  style="padding-left:1rem">Installation and basic usage</a>
- <a href="inspector.html#inspecting-servers-from-npm-or-pypi"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Inspecting servers from npm or PyPI</a>
- <a href="inspector.html#inspecting-locally-developed-servers"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Inspecting locally developed servers</a>
- <a href="inspector.html#feature-overview"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Feature
  overview</a>
- <a href="inspector.html#server-connection-pane"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Server connection pane</a>
- <a href="inspector.html#resources-tab"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Resources tab</a>
- <a href="inspector.html#prompts-tab"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Prompts tab</a>
- <a href="inspector.html#tools-tab"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Tools tab</a>
- <a href="inspector.html#notifications-pane"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Notifications pane</a>
- <a href="inspector.html#best-practices"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Best
  practices</a>
- <a href="inspector.html#development-workflow"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Development workflow</a>
- <a href="inspector.html#next-steps"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Next
  steps</a>
...
In-depth guide to using the MCP Inspector for testing and debugging
...
page-title="MCP Inspector" page-href="/docs/tools/inspector">

<span data-as="p">The
<a href="https://github.com/modelcontextprotocol/inspector" class="link"
target="_blank" rel="noreferrer">MCP Inspector</a> is an interactive
developer tool for testing and debugging MCP servers. While the
<a href="debugging.html" class="link">Debugging Guide</a> covers the
Inspector as part of the overall debugging toolkit, this document
provides a detailed exploration of the Inspector’s features and
capabilities.</span>
...
<span class="cursor-pointer">Installation and basic usage</span>

<span data-as="p">The Inspector runs directly through `npx` without
requiring installation:</span>
...
<span class="cursor-pointer">Inspecting servers from npm or PyPI</span>

<span data-as="p">A common way to start server packages from
<a href="https://npmjs.com" class="link" target="_blank"
rel="noreferrer">npm</a> or
<a href="https://pypi.org" class="link" target="_blank"
rel="noreferrer">PyPI</a>.</span>

<div id="npm-package" class="tabs tabs tab-container">
...
- <div id="npm-package">
  ...
  component-part="tab-button" active="true" testid="tab-npm package">
...
- <div id="pypi-package">
  ...
  component-part="tab-button" active="false" testid="tab-PyPI package">
...
role="tabpanel" aria-labelledby="npm-package"
component-part="tab-content">

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="3" language="shellscript">
...
role="tabpanel" aria-labelledby="pypi-package"
component-part="tab-content">
...
<span class="cursor-pointer">Inspecting locally developed servers</span>

<span data-as="p">To inspect servers locally developed or downloaded as
a repository, the most common way is:</span>
...
<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="6" language="shellscript">
...
<span data-as="p">Please carefully read any attached README for the most
accurate instructions.</span>
...
<span class="cursor-pointer">Feature overview</span>

<div>

<div class="frame p-2 not-prose relative bg-gray-50/50 rounded-2xl overflow-hidden dark:bg-gray-800/25 print:print-color-exact"
data-name="frame">

<div class="absolute inset-0 bg-grid-neutral-200/20 [mask-image:linear-gradient(0deg,#fff,rgba(255,255,255,0.6))] dark:bg-grid-white/5 dark:[mask-image:linear-gradient(0deg,rgba(255,255,255,0.1),rgba(255,255,255,0.5))] print:print-color-exact"
...
src="https://mintcdn.com/mcp/4ZXF1PrDkEaJvXpn/images/mcp-inspector.png?fit=max&amp;auto=format&amp;n=4ZXF1PrDkEaJvXpn&amp;q=85&amp;s=83b12e2a457c96ef4ad17c7357236290"
class="object-contain" style="aspect-ratio:2888 / 1761"
data-path="images/mcp-inspector.png" decoding="async"
...
data-optimize="true" width="2888" height="1761" /></span></span>

</div>

<div class="relative rounded-2xl text-center mt-3 pt-0 px-8 pb-2 text-sm text-gray-700 dark:text-gray-400 [&_p]:m-0 [&_a]:font-semibold [&_a]:no-underline [&_a]:border-b [&_a]:border-primary [&_a:hover]:border-b-2 dark:[&_a]:text-white dark:[&_a]:border-primary-light"
contenteditable="false" component-part="frame-caption">
...
<span data-as="p">The Inspector provides several features for
interacting with your MCP server:</span>
...
<span class="cursor-pointer">Server connection pane</span>

- Allows selecting the
  <a href="../../specification/latest/basic/transports.html"
  class="link">transport</a> for connecting to the server
...
<span class="cursor-pointer">Resources tab</span>
...
<span class="cursor-pointer">Prompts tab</span>
...
<span class="cursor-pointer">Tools tab</span>
...
<span class="cursor-pointer">Notifications pane</span>
...
<span class="cursor-pointer">Development workflow</span>

1.  <span data-as="p">Start Development</span>
    - Launch Inspector with your server
    - Verify basic connectivity
    - Check capability negotiation
2.  <span data-as="p">Iterative testing</span>
    - Make server changes
    - Rebuild the server
    - Reconnect the Inspector
    - Test affected features
    - Monitor messages
3.  <span data-as="p">Test edge cases</span>
    - Invalid inputs
...
<span data-as="p">Check out the MCP Inspector source code</span>
...
<img
src="data:image/svg+xml;base64,"
class="size-6 bg-primary dark:bg-primary-light !m-0 shrink-0" />
...
<span data-as="p">Learn about broader debugging strategies</span>
...
<a href="../tutorials/security/security_best_practices.html"
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Security
Best Practices</span></a><a href="debugging.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Debugging</span><img
