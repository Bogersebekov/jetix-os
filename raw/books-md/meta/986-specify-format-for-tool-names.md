...
priority: P2
quality_grade: A
slug: 986-specify-format-for-tool-names
subcategory: meta
tags:
- meta
title: 986 Specify Format For Tool Names
word_count: 3494
---
...
<a href="986-specify-format-for-tool-names.html#content-area"
...
- <a href="986-specify-format-for-tool-names.html#abstract"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Abstract</a>
- <a href="986-specify-format-for-tool-names.html#motivation"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Motivation</a>
- <a href="986-specify-format-for-tool-names.html#rationale"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Rationale</a>
- <a href="986-specify-format-for-tool-names.html#specification"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Specification</a>
- <a href="986-specify-format-for-tool-names.html#backwards-compatibility"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Backwards
  Compatibility</a>
- <a
  href="986-specify-format-for-tool-names.html#reference-implementation"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Reference
  Implementation</a>
- <a href="986-specify-format-for-tool-names.html#security-implications"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Security
  Implications</a>
...
page-title="SEP-986: Specify Format for Tool Names"
page-href="/seps/986-specify-format-for-tool-names">
...
| **Sponsor** | None |
| **PR** | <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/986"
class="link" target="_blank" rel="noreferrer">#986</a> |
...
<span data-as="p">The Model Context Protocol (MCP) currently lacks a
standardized format for tool names, resulting in inconsistencies and
confusion for both implementers and users. This SEP proposes a clear,
flexible standard for tool names: tool names should be 1–64 characters,
case-sensitive, and may include alphanumeric characters, underscores
(\_), dashes (-), dots (.), and forward slashes (/). This aims to
maximize compatibility, clarity, and interoperability across MCP
implementations while accommodating a wide range of naming
conventions.</span>
...
<span data-as="p">Without a prescribed format for tool names, MCP
implementations have adopted a variety of naming conventions, including
different separators, casing, and character sets. This inconsistency can
lead to confusion, errors in tool invocation, and difficulties in
documentation and automation. Standardizing the allowed characters and
length will:</span>
...
<span data-as="p">Community discussion highlighted the need for
flexibility in tool naming. While some conventions (like
lower-kebab-case) are common, many tools and clients use uppercase,
underscores, dots, and slashes for namespacing or clarity. The proposed
pattern—allowing a-z, A-Z, 0-9, \_, -, ., and /—is based on patterns
used in major clients (e.g., VS Code, Claude) and aligns with common
conventions in programming and APIs. Restricting spaces and commas
avoids parsing issues and ambiguity. The length limit (1–64) is generous
enough for most use cases but prevents abuse.</span>
...
- Tool names SHOULD be between 1 and 64 characters in length
  (inclusive).
- Tool names are case-sensitive.
- Allowed characters: uppercase and lowercase ASCII letters (A-Z, a-z),
  digits (0-9), underscore (\_), dash (-), dot (.), and forward slash
  (/).
...
<span data-as="p">This change is not backwards compatible for existing
tools that use disallowed characters or exceed the new length limits. To
minimize disruption:</span>

- Existing non-conforming tool names SHOULD be supported as aliases for
  at least one major version, with a deprecation warning.
- Tool authors SHOULD update their documentation and code to use the new
  format.
- A migration guide SHOULD be provided to assist implementers in
  updating their tool names.
...
<span data-as="p">A reference implementation can be provided by updating
the MCP core library to enforce the new tool name validation rules at
registration time. Existing tools can be updated to provide aliases for
their new conforming names, with warnings for deprecated formats.
Example code and migration scripts can be included in the MCP
repository.</span>
...
<span data-as="p">None. Standardizing tool name format does not
introduce new security risks.</span>
...
<a href="985-align-oauth-20-protected-resource-metadata-with-rf.html"
...
Align OAuth 2.0 Protected Resource Meta…</span></a><a href="990-enable-enterprise-idp-policy-controls-during-mcp-o.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-990:
Enable enterprise IdP policy controls d…</span><img
