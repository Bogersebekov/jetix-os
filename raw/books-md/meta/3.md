...
- <a href="linktree.html" class="o-blog-preview"></a>
  ...
  Engineering at Linktree</span> </span></span>
  ...
  How Linktree ships new prototypes and support for new social media
  platforms with Devin, while skipping the lengthy prioritization
  process.
...
- <a href="devin-101-automatic-pr-reviews-with-the-devin-api.html"
  ...
  How to set up a Github Actions workflow that uses the Devin API to
  review PRs
...
- <a href="crossmint-devin.html" class="o-blog-preview"></a>
  <div class="o-blog-preview__inner">

  <div class="o-blog-preview__content">

  <span class="o-blog-preview__meta">
  <span class="o-blog-preview__meta-date">January 14, 2025
  <span class="o-blog-preview__meta">
  <span class="o-blog-preview__meta-author">The Crossmint Team</span>
  </span></span> <span class="o-blog-preview__caption">Community</span>
  </span> <span class="o-blog-preview__description"> </span>
  ### Scaling Open Source Development of GOAT with Devin: A Crossmint Case Study

  How Crossmint is scaling Open Source Development of GOAT with Devin as
  part of the Devin Open Source Initiative
...
- <a href="cognition-open-source-initiative.html"
  ...
  OSS contributions Devin has already helped to make, and more about our
...
- <a href="devin-generally-available.html" class="o-blog-preview"></a>
  ...
  The work Devin has been doing and how your team can start using Devin
  today.
...
- <a href="evaluating-coding-agents.html" class="o-blog-preview"></a>
  ...
  Testing OpenAI’s newest o1 series of models with Devin for autonomous
  coding tasks
...
- <a href="devin-crowdstrike-outage.html" class="o-blog-preview"></a>
  ...
  A lot of businesses and critical systems were affected by the
  CrowdStrike outage yesterday, and we wanted to explore how Devin can
  help.
...
- <a href="swe-bench-technical-report.html" class="o-blog-preview"></a>
  ...
  One of our goals at Cognition is to enable Devin, an AI agent
  specializing in software development, to contribute code successfully
...
- <a href="introducing-devin.html" class="o-blog-preview"></a>
  ...
  Setting a new state of the art on the SWE-bench coding benchmark. Meet
