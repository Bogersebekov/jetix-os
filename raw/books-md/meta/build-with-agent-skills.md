...
<a href="build-with-agent-skills.html#content-area"
...
- <span id="/docs/develop/connect-local-servers"><a href="connect-local-servers.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/develop/connect-remote-servers"><a href="connect-remote-servers.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/develop/build-with-agent-skills"><a href="build-with-agent-skills.html"
...
- <span id="/docs/develop/build-server"><a href="build-server.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/develop/build-client"><a href="build-client.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <a href="build-with-agent-skills.html#available-skills"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Available
  skills</a>
- <a href="build-with-agent-skills.html#start-a-build"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Start
  a build</a>
- <a href="build-with-agent-skills.html#deployment-paths"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Deployment
  paths</a>
- <a href="build-with-agent-skills.html#next-steps"
...
Use agent skills to guide AI coding assistants through MCP server design
and implementation
...
page-title="Build with Agent Skills"
page-href="/docs/develop/build-with-agent-skills">

<span data-as="p"><a href="https://agentskills.io/home" class="link" target="_blank"
rel="noreferrer">Agent skills</a> are portable instruction sets that
give AI coding assistants domain knowledge for a task. For MCP
development, they encode the design decisions (deployment model, tool
patterns, auth) so your agent can interrogate your use case and scaffold
a server that fits.</span>
...
<span class="cursor-pointer">Available skills</span>

<span data-as="p">A reference set of MCP development skills is available
as the <a
href="https://github.com/anthropics/claude-plugins-official/tree/main/plugins/mcp-server-dev"
class="link" target="_blank"
rel="noreferrer"><code>mcp-server-dev</code> plugin</a>. It provides
three composing skills:</span>
...
<span data-as="p">Each skill ships a `SKILL.md` file plus a
`references/` folder of supporting material (auth flows, tool-design
patterns, widget templates, manifest schemas) that the agent reads on
demand. The files follow the open format and work with any agent that
implements the standard. For example, to install them in Claude
Code:</span>
...
<span data-as="p">For other agents, check your skills or extensions
catalog, or clone the <a
href="https://github.com/anthropics/claude-plugins-official/tree/main/plugins/mcp-server-dev/skills"
class="link" target="_blank" rel="noreferrer">skill directories</a>
(`SKILL.md` plus `references/`) into your agent’s skills
location.</span>
...
<span class="cursor-pointer">Start a build</span>

<span data-as="p">With the skills installed, ask your agent to help you
build an MCP server. The entry skill triggers on natural-language
requests, or you can invoke it directly using your agent’s
skill-invocation syntax.</span> <span data-as="p">The skill runs a short
discovery phase before writing any code. Expect questions about:</span>

- **What it connects to** — a cloud API, a local process, the
  filesystem, hardware
- **Who will use it** — just you, your team, or anyone who installs it
- **Action surface size** — a handful of operations versus wrapping a
  large API
- **User interaction needs** — plain text results, structured input via
  <a href="../../specification/draft/client/elicitation.html"
  class="link">elicitation</a>, or rich UI widgets
- **Upstream auth** — API keys, OAuth 2.0, or none

<span data-as="p">If your opening message already covers these, the
agent skips ahead to the recommendation.</span>
...
<span class="cursor-pointer">Deployment paths</span>

<span data-as="p">Based on discovery, the skill recommends one of four
paths and scaffolds accordingly:</span> <span data-as="p">**Remote <a
href="../../specification/draft/basic/transports.html#streamable-http"
class="link">Streamable HTTP</a>** is the default for anything wrapping
a cloud API. Zero install friction, one deployment serves all users, and
OAuth flows work properly because the server can handle redirects and
token storage. The reference skill includes scaffolds for Cloudflare
Workers and portable Express/FastMCP setups.</span>
<span data-as="p">**<a href="../../extensions/apps/overview.html" class="link">MCP apps</a>**
extend a server with interactive widgets rendered in chat, such as
searchable pickers, charts, and live dashboards. The skill hands off to
`build-mcp-app` when
<a href="../../specification/draft/client/elicitation.html"
class="link">elicitation’s</a> flat-form constraints don’t fit.</span>
<span data-as="p">**<a href="https://github.com/modelcontextprotocol/mcpb" class="link"
target="_blank" rel="noreferrer">MCP Bundles (MCPB)</a>** package a
local server together with its runtime as a single `.mcpb` archive, so
users can install it without setting up Node or Python. Use this path
when the server must touch the user’s machine: reading local files,
driving desktop apps, or talking to localhost services. The skill hands
off to `build-mcpb`.</span> <span data-as="p">**Local
<a href="../../specification/draft/basic/transports.html#stdio"
class="link">stdio</a>** remains available for prototyping, with a noted
upgrade path to MCPB when you’re ready to distribute.</span>
...
<span data-as="p">Once your agent scaffolds the server, iterate on tool
descriptions and error handling, then test and ship:</span>
...
<img
src="data:image/svg+xml;base64,"
...
<span data-as="p">Test your server’s tools, resources, and prompts
interactively</span>
...
<img
src="data:image/svg+xml;base64,"
class="size-6 bg-primary dark:bg-primary-light !m-0 shrink-0" />
...
<span data-as="p">Wire your server into an MCP client via local or
...
<img
src="data:image/svg+xml;base64,"
class="size-6 bg-primary dark:bg-primary-light !m-0 shrink-0" />
...
<span data-as="p">Make your server discoverable in the MCP
Registry</span>
...
<a href="connect-remote-servers.html"
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Connect to
remote MCP Servers</span></a><a href="build-server.html"
