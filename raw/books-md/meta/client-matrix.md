...
<a href="client-matrix.html#content-area"
...
- <a href="client-matrix.html#extension-overview"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Extension
  overview</a>
- <a href="client-matrix.html#support-matrix"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Support
  matrix</a>
- <a href="client-matrix.html#adding-extension-support-to-your-client"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Adding
  extension support to your client</a>
...
page-title="Extension Support Matrix"
page-href="/extensions/client-matrix">

<span data-as="p">This matrix shows which MCP clients support each
<a href="overview.html" class="link">official extension</a>. Extensions
are always opt-in — a client only uses an extension if both client and
server declare support during the
<a href="overview.html#negotiation" class="link">initialization
handshake</a>.</span>
...
<span data-as="p">This list is maintained by the community. If you
notice any inaccuracies or would like to add or update information,
please <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pulls"
class="link" target="_blank" rel="noreferrer">submit a pull request</a>.</span>
...
<span class="cursor-pointer">Extension overview</span>
...
|----|----|----|
| <a href="apps/overview.html" class="link">MCP Apps</a> | `io.modelcontextprotocol/ui` | Interactive HTML interfaces rendered inline in the conversation |
| <a href="auth/oauth-client-credentials.html" class="link">OAuth Client
Credentials</a> | `io.modelcontextprotocol/oauth-client-credentials` | Machine-to-machine auth without interactive user login |
| <a href="auth/enterprise-managed-authorization.html"
class="link">Enterprise-Managed Authorization</a> | `io.modelcontextprotocol/enterprise-managed-authorization` | Centralized access control via enterprise IdP |
...
<span class="cursor-pointer">Support matrix</span>
...
| Client | <a href="apps/overview.html" class="link">MCP Apps</a> | <a href="auth/oauth-client-credentials.html" class="link">OAuth Client
Credentials</a> | <a href="auth/enterprise-managed-authorization.html"
class="link">Enterprise Auth</a> |
|----|:--:|:--:|:--:|
| <a href="https://claude.ai" class="link" target="_blank"
rel="noreferrer">Claude (web)</a> |  |  |  |
| <a href="https://claude.ai/download" class="link" target="_blank"
rel="noreferrer">Claude Desktop</a> |  |  |  |
| <a href="https://code.visualstudio.com/" class="link" target="_blank"
rel="noreferrer">VS Code GitHub Copilot</a> |  |  |  |
| <a href="https://block.github.io/goose/" class="link" target="_blank"
rel="noreferrer">Goose</a> |  |  |  |
| <a href="https://postman.com" class="link" target="_blank"
rel="noreferrer">Postman</a> |  |  |  |
| <a href="https://www.mcpjam.com/" class="link" target="_blank"
rel="noreferrer">MCPJam</a> |  |  |  |
| <a href="https://chatgpt.com/" class="link" target="_blank"
rel="noreferrer">ChatGPT</a> |  |  |  |
| <a href="https://cursor.com/" class="link" target="_blank"
rel="noreferrer">Cursor</a> |  |  |  |
...
<span data-as="p">Auth extension support (OAuth Client Credentials and
Enterprise-Managed Authorization) is tracked separately from the core
MCP authorization features (DCR, CIMD) shown on the
<a href="../clients.html" class="link">clients page</a>. Check each
extension’s specification and the
<a href="https://github.com/modelcontextprotocol/ext-auth" class="link"
target="_blank" rel="noreferrer">ext-auth repository</a> for the latest
...
<span class="cursor-pointer">Adding extension support to your
client</span>

<span data-as="p">If you’re building an MCP client and want to implement
extension support:</span>

1.  Review the extension specification (e.g., in the
    <a href="https://github.com/modelcontextprotocol/ext-auth" class="link"
    target="_blank" rel="noreferrer">ext-auth</a> or
    <a href="https://github.com/modelcontextprotocol/ext-apps" class="link"
    target="_blank" rel="noreferrer">ext-apps</a> repository)
2.  Declare support in the `extensions` field of your `initialize`
    capabilities
3.  Implement the extension’s protocol requirements
4.  Submit a pull request to update this matrix

<span data-as="p">See
<a href="overview.html#negotiation" class="link">Extensions Overview</a>
for details on the capability negotiation mechanism.</span>
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Extensions
Overview</span></a><a href="apps/overview.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">MCP
Apps</span><img
