...
<a href="tools.html#content-area"
...
<span class="truncate max-w-[12.5rem]">Version 2025-11-25
(latest)</span><img
...
data-active="true">Specification</a>
...
- <span id="/specification/2025-11-25"><a href="../../latest.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Specification</span>
...
- <span id="/specification/2025-11-25/changelog"><a href="../../2025-11-25/changelog.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Key
  Changes</span>
...
- <span id="/specification/2025-11-25/architecture"><a href="../../2025-11-25/architecture.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/specification/2025-11-25/basic"><a href="../../2025-11-25/basic.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/specification/2025-11-25/basic/lifecycle"><a href="../basic/lifecycle.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Lifecycle</span>

  </div>

  </div>

- <span id="/specification/2025-11-25/basic/transports"><a href="../basic/transports.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Transports</span>

  </div>

  </div>

- <span id="/specification/2025-11-25/basic/authorization"><a href="../basic/authorization.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Authorization</span>
...
- <span id="/specification/2025-11-25/client/roots"><a href="../../2025-11-25/client/roots.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Roots</span>

  </div>

  </div>
- <span id="/specification/2025-11-25/client/sampling"><a href="../client/sampling.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Sampling</span>

  </div>

  </div>
- <span id="/specification/2025-11-25/client/elicitation"><a href="../client/elicitation.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Elicitation</span>
...
- <span id="/specification/2025-11-25/server"><a href="../../2025-11-25/server.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/specification/2025-11-25/server/prompts"><a href="prompts.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Prompts</span>

  </div>

  </div>

- <span id="/specification/2025-11-25/server/resources"><a href="resources.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Resources</span>

  </div>

  </div>

- <span id="/specification/2025-11-25/server/tools"><a href="tools.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Tools</span>
...
- <span id="/specification/2025-11-25/schema"><a href="../../2025-11-25/schema.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Schema
  Reference</span>
...
- <a href="tools.html#user-interaction-model"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">User
  Interaction Model</a>
- <a href="tools.html#capabilities"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Capabilities</a>
- <a href="tools.html#protocol-messages"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Protocol
  Messages</a>
- <a href="tools.html#listing-tools"
  ...
  style="padding-left:1rem">Listing Tools</a>
- <a href="tools.html#calling-tools"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Calling Tools</a>
- <a href="tools.html#list-changed-notification"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">List Changed Notification</a>
- <a href="tools.html#message-flow"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Message
  Flow</a>
- <a href="tools.html#data-types"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Data
  Types</a>
- <a href="tools.html#tool"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Tool</a>
- <a href="tools.html#tool-names"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Tool Names</a>
- <a href="tools.html#tool-result"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Tool Result</a>
- <a href="tools.html#text-content"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Text Content</a>
- <a href="tools.html#image-content"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Image Content</a>
- <a href="tools.html#audio-content"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Audio Content</a>
- <a href="tools.html#resource-links"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Resource Links</a>
- <a href="tools.html#embedded-resources"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Embedded Resources</a>
- <a href="tools.html#structured-content"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Structured Content</a>
- <a href="tools.html#output-schema"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Output Schema</a>
- <a href="tools.html#schema-examples"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Schema Examples</a>
- <a href="tools.html#tool-with-default-2020-12-schema"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Tool with default 2020-12 schema:</a>
- <a href="tools.html#tool-with-explicit-draft-07-schema"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Tool with explicit draft-07 schema:</a>
- <a href="tools.html#tool-with-no-parameters"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Tool with no parameters:</a>
- <a href="tools.html#error-handling"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Error
  Handling</a>
- <a href="tools.html#security-considerations"
...
page-title="Tools" page-href="/specification/2025-11-25/server/tools">

<div id="enable-section-numbers">

</div>

<span data-as="p">The Model Context Protocol (MCP) allows servers to
expose tools that can be invoked by language models. Tools enable models
to interact with external systems, such as querying databases, calling
APIs, or performing computations. Each tool is uniquely identified by a
name and includes metadata describing its schema.</span>
...
<span class="cursor-pointer">User Interaction Model</span>

<span data-as="p">Tools in MCP are designed to be **model-controlled**,
meaning that the language model can discover and invoke tools
automatically based on its contextual understanding and the user’s
prompts.</span> <span data-as="p">However, implementations are free to
expose tools through any interface pattern that suits their needs—the
...
<span data-as="p">For trust & safety and security, there **SHOULD**
always be a human in the loop with the ability to deny tool
invocations.</span><span data-as="p">Applications **SHOULD**:</span>

- Provide UI that makes clear which tools are being exposed to the AI
  model
...
<span class="cursor-pointer">Capabilities</span>

<span data-as="p">Servers that support tools **MUST** declare the
`tools` capability:</span>
...
<span data-as="p">`listChanged` indicates whether the server will emit
notifications when the list of available tools changes.</span>
...
<span class="cursor-pointer">Protocol Messages</span>
...
<span class="cursor-pointer">Listing Tools</span>

<span data-as="p">To discover available tools, clients send a
`tools/list` request. This operation supports <a
href="https://modelcontextprotocol.io/specification/2025-11-25/server/utilities/pagination"
class="link">pagination</a>.</span>
<span data-as="p">**Request:**</span>
...
<span data-as="p">**Response:**</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="34" language="json">
...
<span class="cursor-pointer">Calling Tools</span>

<span data-as="p">To invoke a tool, clients send a `tools/call`
request:</span> <span data-as="p">**Request:**</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="11" language="json">
...
<span class="cursor-pointer">List Changed Notification</span>

<span data-as="p">When the list of available tools changes, servers that
declared the `listChanged` capability **SHOULD** send a
notification:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="4" language="json">
...
<span class="cursor-pointer">Message Flow</span>
...
<span class="cursor-pointer">Data Types</span>
...
<span class="cursor-pointer">Tool</span>

<span data-as="p">A tool definition includes:</span>

- `name`: Unique identifier for the tool
- `title`: Optional human-readable name of the tool for display
  purposes.
- `description`: Human-readable description of functionality
- `icons`: Optional array of icons for display in user interfaces
- `inputSchema`: JSON Schema defining expected parameters
  - Follows the <a href="../../2025-11-25/basic.html#json-schema-usage"
    class="link">JSON Schema usage guidelines</a>
  ...
  - For tools with no parameters, use one of these valid approaches:
    - `{ "type": "object", "additionalProperties": false }` -
      **Recommended**: explicitly accepts only empty objects
    - `{ "type": "object" }` - accepts any object (including with
      properties)
...
- `execution`: Optional object describing execution-related properties
  - `taskSupport`: Indicates whether this tool supports <a
    href="https://modelcontextprotocol.io/specification/2025-11-25/basic/utilities/tasks#tool-level-negotiation"
    class="link">task-augmented execution</a>. Values: `"forbidden"`
...
<span data-as="p">For trust & safety and security, clients **MUST**
...
<span class="cursor-pointer">Tool Names</span>
...
- The following **SHOULD** be the only allowed characters: uppercase and
  lowercase ASCII letters (A-Z, a-z), digits (0-9), underscore (\_),
  hyphen (-), and dot (.)
...
<span class="cursor-pointer">Tool Result</span>

<span data-as="p">Tool results may contain
<a href="tools.html#structured-content"
class="link"><strong>structured</strong></a> or **unstructured**
content.</span> <span data-as="p">**Unstructured** content is returned
in the `content` field of a result, and can contain multiple content
items of different types:</span>

<div class="callout my-4 px-5 py-4 overflow-hidden rounded-2xl flex gap-3 border border-blue-200 bg-blue-50 dark:border-blue-900 dark:bg-blue-600/20"
callout-type="note">

<div class="mt-0.5 w-4" component-part="callout-icon">

<img
src="data:image/svg+xml;base64,"
class="size-4 text-blue-800 dark:text-blue-300" />

</div>

<div class="text-sm prose dark:prose-invert min-w-0 w-full [&_kbd]:bg-background-light dark:[&_kbd]:bg-background-dark [&_code]:!text-current [&_kbd]:!text-current [&_a]:!text-current [&_a]:border-current [&_strong]:!text-current text-blue-800 dark:text-blue-300"
component-part="callout-content">

<span data-as="p">All content types (text, image, audio, resource links,
and embedded resources) support optional
<a href="resources.html#annotations" class="link">annotations</a> that
provide metadata about audience, priority, and modification times. This
is the same annotation format used by resources and prompts.</span>
...
<span class="cursor-pointer">Text Content</span>
...
<span class="cursor-pointer">Image Content</span>
...
<span class="cursor-pointer">Audio Content</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="5" language="json">
...
<span class="cursor-pointer">Resource Links</span>

<span data-as="p">A tool **MAY** return links to
<a href="resources.html" class="link">Resources</a>, to provide
additional context or data. In this case, the tool will return a URI
that can be subscribed to or fetched by the client:</span>
...
<span data-as="p">Resource links support the same
<a href="resources.html#annotations" class="link">Resource
annotations</a> as regular resources to help clients understand how to
use them.</span>

<div class="callout my-4 px-5 py-4 overflow-hidden rounded-2xl flex gap-3 border border-neutral-200 bg-neutral-50 dark:border-neutral-700 dark:bg-white/10"
callout-type="info">

<div class="mt-0.5 w-4" component-part="callout-icon">

<img
src="data:image/svg+xml;base64,"
class="flex-none size-5 text-neutral-800 dark:text-neutral-300" />

</div>

<div class="text-sm prose dark:prose-invert min-w-0 w-full [&_kbd]:bg-background-light dark:[&_kbd]:bg-background-dark [&_code]:!text-current [&_kbd]:!text-current [&_a]:!text-current [&_a]:border-current [&_strong]:!text-current text-neutral-800 dark:text-neutral-300"
component-part="callout-content">

<span data-as="p">Resource links returned by tools are not guaranteed to
appear in the results of a `resources/list` request.</span>
...
<span class="cursor-pointer">Embedded Resources</span>

<span data-as="p"><a href="resources.html" class="link">Resources</a>
**MAY** be embedded to provide additional context or data using a
suitable
<a href="resources.html#common-uri-schemes" class="link">URI scheme</a>.
Servers that use embedded resources **SHOULD** implement the `resources`
capability:</span>
...
<span data-as="p">Embedded resources support the same
<a href="resources.html#annotations" class="link">Resource
annotations</a> as regular resources to help clients understand how to
use them.</span>
...
<span class="cursor-pointer">Structured Content</span>

<span data-as="p">**Structured** content is returned as a JSON object in
the `structuredContent` field of a result.</span> <span data-as="p">For
backwards compatibility, a tool that returns structured content SHOULD
also return the serialized JSON in a TextContent block.</span>
...
<span class="cursor-pointer">Output Schema</span>

<span data-as="p">Tools may also provide an output schema for validation
of structured results. If an output schema is provided:</span>

- Servers **MUST** provide structured results that conform to this
  schema.
- Clients **SHOULD** validate structured results against this schema.

<span data-as="p">Example tool with output schema:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="33" language="json">
...
<span data-as="p">Example valid response for this tool:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="17" language="json">
...
<span data-as="p">Providing an output schema helps clients and LLMs
understand and properly handle structured tool outputs by:</span>

- Enabling strict schema validation of responses
- Providing type information for better integration with programming
  languages
- Guiding clients and LLMs to properly parse and utilize the returned
  data
...
<span class="cursor-pointer">Schema Examples</span>
...
<span class="cursor-pointer">Tool with default 2020-12 schema:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="12" language="json">
...
<span class="cursor-pointer">Tool with explicit draft-07 schema:</span>
...
<span class="cursor-pointer">Tool with no parameters:</span>
...
<span class="cursor-pointer">Error Handling</span>

<span data-as="p">Tools use two error reporting mechanisms:</span>

1.  <span data-as="p">**Protocol Errors**: Standard JSON-RPC errors for
    issues like:</span>
    - Unknown tools
    - Malformed requests (requests that fail to satisfy
      <a href="../../2025-11-25/schema.html#calltoolrequest"
      class="link">CallToolRequest schema</a>)
    - Server errors
2.  <span data-as="p">**Tool Execution Errors**: Reported in tool
    results with `isError: true`:</span>
    - API failures
    - Input validation errors (e.g., date in wrong format, value out of
      range)
    - Business logic errors

<span data-as="p">**Tool Execution Errors** contain actionable feedback
that language models can use to self-correct and retry with adjusted
parameters. **Protocol Errors** indicate issues with the request
structure itself that models are less likely to be able to fix. Clients
**SHOULD** provide tool execution errors to language models to enable
self-correction. Clients **MAY** provide protocol errors to language
models, though these are less likely to result in successful
recovery.</span> <span data-as="p">Example protocol error:</span>
...
<span data-as="p">Example tool execution error (input
validation):</span>
...
<span class="cursor-pointer">Security Considerations</span>

1.  <span data-as="p">Servers **MUST**:</span>
    - Validate all tool inputs
    - Implement proper access controls
    - Rate limit tool invocations
    - Sanitize tool outputs
2.  <span data-as="p">Clients **SHOULD**:</span>
    - Prompt for user confirmation on sensitive operations
    - Show tool inputs to the user before calling the server, to avoid
      malicious or accidental data exfiltration
...
<a href="resources.html" class="flex items-center space-x-3 group"><img
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Resources</span></a><a
href="https://modelcontextprotocol.io/specification/2025-11-25/server/utilities/completion"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Completion</span><img
