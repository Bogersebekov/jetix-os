...
<a href="quickstart.html#content-area"
...
- <span id="/registry/about"><a href="about.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">About</span>
...
- <span id="/registry/quickstart"><a href="quickstart.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Quickstart:
  Publish a Server</span>
...
- <span id="/registry/faq"><a href="faq.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">FAQ</span>
...
- <span id="/registry/package-types"><a href="package-types.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Package
  Types</span>

  </div>

  </div>
- <span id="/registry/remote-servers"><a href="remote-servers.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/registry/authentication"><a href="authentication.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Authentication</span>

  </div>

  </div>
- <span id="/registry/versioning"><a href="versioning.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/registry/github-actions"><a href="github-actions.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">GitHub
  Actions</span>

  </div>

  </div>
- <span id="/registry/moderation-policy"><a href="moderation-policy.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Moderation
  Policy</span>
...
- <span id="/registry/registry-aggregators"><a href="registry-aggregators.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Registry
  Aggregators</span>
...
- <span id="/registry/terms-of-service"><a href="terms-of-service.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Terms of
  Service</span>
...
- <a href="quickstart.html#prerequisites"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Prerequisites</a>
- <a
  href="quickstart.html#step-1-add-verification-information-to-the-package"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Step
  1: Add verification information to the package</a>
- <a href="quickstart.html#step-2-publish-the-package"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Step
  2: Publish the package</a>
- <a href="quickstart.html#step-3-install-mcp-publisher"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Step
  3: Install mcp-publisher</a>
- <a href="quickstart.html#step-4-create-server-json"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Step
  4: Create server.json</a>
- <a href="quickstart.html#step-5-authenticate-with-the-mcp-registry"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Step
  5: Authenticate with the MCP Registry</a>
- <a href="quickstart.html#step-6-publish-to-the-mcp-registry"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Step
  6: Publish to the MCP Registry</a>
- <a href="quickstart.html#troubleshooting"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Troubleshooting</a>
- <a href="quickstart.html#next-steps"
...
page-title="Quickstart: Publish an MCP Server to the MCP Registry"
page-href="/registry/quickstart">
...
<span data-as="p">The MCP Registry is currently in preview. Breaking
changes or data resets may occur before general availability. If you
encounter any issues, please report them on
<a href="https://github.com/modelcontextprotocol/registry/issues"
class="link" target="_blank" rel="noreferrer">GitHub</a>.</span>

</div>

</div>

<span data-as="p">This tutorial will show you how to publish an MCP
server written in TypeScript to the MCP Registry using the official
`mcp-publisher` CLI tool.</span>
...
<span class="cursor-pointer">Prerequisites</span>

- **Node.js** — This tutorial assumes the MCP server is written in
  TypeScript.
- **npm account** — The MCP Registry only hosts metadata, not artifacts.
  Before publishing to the MCP Registry, we will publish the MCP
  server’s package to npm, so you will need an
  <a href="https://www.npmjs.com" class="link" target="_blank"
  rel="noreferrer">npm</a> account.
- **GitHub account** — The MCP Registry supports
  <a href="authentication.html" class="link">multiple authentication
  methods</a>. For simplicity, this tutorial will use GitHub-based
  authentication, so you will need a
  <a href="https://github.com/" class="link" target="_blank"
  rel="noreferrer">GitHub</a> account.

<span data-as="p">If you do not have an MCP server written in
TypeScript, you can copy the `weather-server-typescript` server from the
<a href="https://github.com/modelcontextprotocol/quickstart-resources"
class="link" target="_blank"
rel="noreferrer"><code>modelcontextprotocol/quickstart-resources</code>
repository</a> to follow along with this tutorial:</span>
...
<span data-as="p">And edit `package.json` to reflect your
information:</span>
...
<span class="truncate min-w-0" title="package.json">package.json</span>
...
<span class="cursor-pointer">Step 1: Add verification information to the
package</span>

<span data-as="p">The MCP Registry verifies that a server’s underlying
package matches its metadata. For npm packages, this requires adding an
`mcpName` property to `package.json`:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 bg-gray-50 dark:bg-white/5 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark p-0.5"
numberoflines="5" language="diff">
...
<span data-as="p">The value of `mcpName` will be your server’s name in
the MCP Registry.</span> <span data-as="p">Because we will be using
GitHub-based authentication, `mcpName` **must** start with
`io.github.my-username/`.</span>
...
<span class="cursor-pointer">Step 2: Publish the package</span>

<span data-as="p">The MCP Registry only hosts metadata, not artifacts,
so we must publish the package to npm before publishing the server to
the MCP Registry.</span> <span data-as="p">Ensure the distribution files
are built:</span>
...
<span data-as="p">Then follow npm’s <a
href="https://docs.npmjs.com/creating-and-publishing-scoped-public-packages"
class="link" target="_blank" rel="noreferrer">publishing guide</a>. In
particular, you will probably need to run the following commands:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="5" language="shellscript">
...
<span data-as="p">You can verify your package is published by visiting
its npm URL, such as
<a href="https://www.npmjs.com/package/@my-username/mcp-weather-server"
class="link" target="_blank"
rel="noreferrer">https://www.npmjs.com/package/@my-username/mcp-weather-server</a>.</span>
...
<span class="cursor-pointer">Step 3: Install `mcp-publisher`</span>

<span data-as="p">Install the `mcp-publisher` CLI tool using a pre-built
binary or <a href="https://brew.sh" class="link" target="_blank"
rel="noreferrer">Homebrew</a>:</span>

<div class="code-group p-0.5 mt-5 mb-8 flex flex-col not-prose relative rounded-2xl border border-gray-950/10 dark:border-white/10 min-w-0 bg-gray-50 dark:bg-white/5 dark:codeblock-dark text-gray-950 dark:text-gray-50 codeblock-light"
dir="ltr" orientation="horizontal">

<div class="flex items-center justify-between gap-2 relative pr-2.5 *:first:*:ml-2.5"
component-part="code-group-tab-bar">

<div class="flex-1 w-0 text-xs leading-6 rounded-tl-xl gap-1 flex overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-black/15 hover:scrollbar-thumb-black/20 active:scrollbar-thumb-black/20 dark:scrollbar-thumb-white/20 dark:hover:scrollbar-thumb-white/25 dark:active:scrollbar-thumb-white/25"
...
<div id="radix-_R_nldinpfcqcf9babsnpfdb_-content-0"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="active" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_nldinpfcqcf9babsnpfdb_-trigger-0"
tabindex="-1" style="animation-duration:0s">

<div class="w-0 min-w-full max-w-full py-3.5 px-4 h-full dark:bg-codeblock relative text-sm leading-6 children:!my-0 children:!shadow-none children:!bg-transparent transition-[height] duration-300 ease-in-out code-block-background [&_*]:ring-0 [&_*]:outline-0 [&_*]:focus:ring-0 [&_*]:focus:outline-0 rounded-xt bg-white overflow-auto overflow-x-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-black/15 hover:scrollbar-thumb-black/20 active:scrollbar-thumb-black/20 dark:scrollbar-thumb-white/20 dark:hover:scrollbar-thumb-white/25 dark:active:scrollbar-thumb-white/25"
component-part="code-block-root" tabindex="0"
style="font-variant-ligatures:none;height:100%;background-color:#ffffff;--shiki-dark-bg:#0B0C0E">

<div class="font-mono whitespace-pre flex-none text-sm h-full leading-6"
component-part="code-group-tab-content">
...
<div id="radix-_R_nldinpfcqcf9babsnpfdb_-content-1"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_nldinpfcqcf9babsnpfdb_-trigger-1" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_nldinpfcqcf9babsnpfdb_-content-2"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_nldinpfcqcf9babsnpfdb_-trigger-2" hidden=""
tabindex="-1">
...
<span data-as="p">Verify that `mcp-publisher` is correctly installed by
running:</span>
...
<span data-as="p">You should see output like:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 bg-gray-50 dark:bg-white/5 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark p-0.5"
numberoflines="11" language="text">
...
<span class="truncate min-w-0" title="Output">Output</span>
...
<span class="cursor-pointer">Step 4: Create `server.json`</span>

<span data-as="p">The `mcp-publisher init` command can generate a
`server.json` template file with some information derived from your
project.</span> <span data-as="p">In your server project directory, run
`mcp-publisher init`:</span>
...
<span data-as="p">Open the generated `server.json` file, and you should
see contents like:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 bg-gray-50 dark:bg-white/5 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark p-0.5"
numberoflines="29" language="json">
...
<span class="truncate min-w-0" title="server.json">server.json</span>
...
<span data-as="p">Edit the contents as necessary:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 bg-gray-50 dark:bg-white/5 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark p-0.5"
numberoflines="32" language="diff">
...
<span data-as="p">The `name` property in `server.json` **must** match
the `mcpName` property in `package.json`.</span>
...
<span class="cursor-pointer">Step 5: Authenticate with the MCP
Registry</span>

<span data-as="p">For this tutorial, we will authenticate with the MCP
Registry using GitHub-based authentication.</span> <span data-as="p">Run
the `mcp-publisher login` command to initiate authentication:</span>
...
<span data-as="p">Visit the link, follow the prompts, and enter the
authorization code that was printed in the terminal (e.g., `ABCD-1234`
in the above output). Once complete, go back to the terminal, and you
should see output like:</span>
...
<span class="cursor-pointer">Step 6: Publish to the MCP Registry</span>

<span data-as="p">Finally, publish your server to the MCP Registry using
the `mcp-publisher publish` command:</span>
...
<span data-as="p">You can verify that your server is published by
searching for it using the MCP Registry API:</span>
...
<span data-as="p">You should see your server’s metadata in the search
results JSON:</span>
...
<span class="cursor-pointer">Troubleshooting</span>
...
- Learn about
  <a href="package-types.html" class="link">support for other package
  types</a>.
- Learn about
  <a href="remote-servers.html" class="link">support for remote
  servers</a>.
- Learn how to
  <a href="authentication.html" class="link">use other authentication
  methods</a>, such as
  <a href="authentication.html#dns-authentication" class="link">DNS
  authentication</a> which enables custom domains for server name
  prefixes.
- Learn how to
  <a href="github-actions.html" class="link">automate publishing with
  GitHub Actions</a>.
...
<a href="about.html" class="flex items-center space-x-3 group"><img
...
class="group-hover:text-gray-900 dark:group-hover:text-white">About</span></a><a href="faq.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">FAQ</span><img
