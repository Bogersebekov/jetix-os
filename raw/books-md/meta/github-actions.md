...
<a href="github-actions.html#content-area"
...
- <a href="github-actions.html#step-1-create-a-workflow-file"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Step
  1: Create a Workflow File</a>
- <a href="github-actions.html#step-2-add-secrets"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Step
  2: Add Secrets</a>
- <a href="github-actions.html#step-3-tag-and-release"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Step
  3: Tag and Release</a>
- <a href="github-actions.html#troubleshooting"
...
page-title="How to Automate Publishing with GitHub Actions"
page-href="/registry/github-actions">
...
<span class="cursor-pointer">Step 1: Create a Workflow File</span>

<span data-as="p">In your server project directory, create a
`.github/workflows/publish-mcp.yml` file. Here is an example for
npm-based local server, but the MCP Registry publishing steps are the
same for all package types:</span>
...
<div id="radix-_R_3ldinpfcqcf9babsnpfdb_-content-0"
...
aria-labelledby="radix-_R_3ldinpfcqcf9babsnpfdb_-trigger-0"
...
<div id="radix-_R_3ldinpfcqcf9babsnpfdb_-content-1"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_3ldinpfcqcf9babsnpfdb_-trigger-1" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_3ldinpfcqcf9babsnpfdb_-content-2"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_3ldinpfcqcf9babsnpfdb_-trigger-2" hidden=""
tabindex="-1">
...
<span class="cursor-pointer">Step 2: Add Secrets</span>

<span data-as="p">You may need to add a secret to the repository
depending on which authentication method you choose:</span>

- **GitHub OIDC Authentication**: No dedicated secret necessary.
- **GitHub PAT Authentication**: Add a `MCP_GITHUB_TOKEN` secret with a
  GitHub Personal Access Token (PAT) that has `read:org` and `read:user`
  scopes.
- **DNS Authentication**: Add a `MCP_PRIVATE_KEY` secret with your
  Ed25519 private key.

<span data-as="p">You may also need to add secrets for your package
registry. For example, the workflow above needs an `NPM_TOKEN` secret
with your npm token.</span> <span data-as="p">For information about how
to add secrets to a repository, see <a
href="https://docs.github.com/en/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets"
class="link" target="_blank" rel="noreferrer">Using secrets in GitHub
Actions</a>.</span>
...
<span class="cursor-pointer">Step 3: Tag and Release</span>

<span data-as="p">Create and push a version tag to trigger the
workflow:</span>
...
<span data-as="p">The workflow will run tests, build the package,
publish the package to npm, and publish the server to the MCP
Registry.</span>
...
| ”Package validation failed” | Verify your package successfully published to the package registry (e.g., npm, PyPI), and that your package has the <a href="package-types.html" class="link">necessary verification
information</a>. |
...
<a href="versioning.html" class="flex items-center space-x-3 group"><img
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Versioning</span></a><a href="moderation-policy.html"
