...
priority: P2
quality_grade: A
slug: 1613-establish-json-schema-2020-12-as-default-dialect-f
subcategory: meta
tags:
- meta
title: 1613 Establish Json Schema 2020 12 As Default Dialect F
word_count: 4901
---
...
<a
href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#content-area"
...
- <a
  ...
  style="padding-left:1rem">1. Default Dialect</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#2-explicit-dialect-declaration"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">2. Explicit Dialect Declaration</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#3-schema-validation-requirements"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">3. Schema Validation Requirements</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#4-scope-of-application"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">4. Scope of Application</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#5-implementation-requirements"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">5. Implementation Requirements</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#rationale"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Rationale</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#why-2020-12"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Why 2020-12?</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#why-allow-explicit-declaration"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Why allow explicit declaration?</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#alternatives-considered"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Alternatives considered</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#backward-compatibility"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Backward
  Compatibility</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#reference-implementation"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Reference
  Implementation</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#sdk-implementations"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">SDK Implementations</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#security-implications"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Security
  Implications</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#related-work"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Related
  Work</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#sep-1330-elicitation-enum-schema-improvements"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">SEP-1330: Elicitation Enum Schema
  Improvements</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#sep-834-full-json-schema-2020-12-support"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">SEP-834: Full JSON Schema 2020-12 Support</a>
- <a
  href="1613-establish-json-schema-2020-12-as-default-dialect-f.html#open-questions"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Open
  Questions</a>
...
page-title="SEP-1613: Establish JSON Schema 2020-12 as Default Dialect for MCP"
page-href="/seps/1613-establish-json-schema-2020-12-as-default-dialect-f">
...
| **Sponsor** | None |
| **PR** | <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/1613"
class="link" target="_blank" rel="noreferrer">#1613</a> |
...
<span data-as="p">This SEP establishes JSON Schema 2020-12 as the
default dialect for embedded schemas within MCP messages (tool
`inputSchema`/`outputSchema` and elicitation `requestedSchema` fields).
Schemas may explicitly declare alternative dialects via the `$schema`
field. This resolves ambiguity that has caused compatibility issues
between implementations.</span>
...
<span data-as="p">The MCP specification does not explicitly state which
JSON Schema version to use for embedded schemas. This has caused:</span>

- Validation failures between clients and servers assuming different
  versions
- Implementation divergence across SDK ecosystems
- Developer uncertainty requiring arbitrary version choices

<span data-as="p">Community discussion (GitHub Discussion \#366, PR
\#655) revealed that implementations were split between draft-07 and
2020-12, with multiple maintainers and community members expressing
strong preference for 2020-12 as the default.</span>
...
<span class="cursor-pointer">1. Default Dialect</span>

<span data-as="p">Embedded JSON schemas within MCP messages **MUST**
conform to
<a href="https://json-schema.org/draft/2020-12/schema" class="link"
target="_blank" rel="noreferrer">JSON Schema 2020-12</a> when no
`$schema` field is present.</span>
...
<span class="cursor-pointer">2. Explicit Dialect Declaration</span>

<span data-as="p">Schemas **MAY** include an explicit `$schema` field to
declare a different dialect:</span>
...
<span class="cursor-pointer">3. Schema Validation Requirements</span>

- Schemas **MUST** be valid according to their declared or default
  dialect
- The `inputSchema` field **MUST NOT** be `null`

<span data-as="p">**For tools with no parameters**, use one of these
valid approaches:</span>
...
- `{ "type": "object", "additionalProperties": false }` - accepts only
  empty objects `{}`

<span data-as="p">**Example** for a tool with no parameters:</span>

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="8" language="json">
...
<span class="cursor-pointer">4. Scope of Application</span>

<span data-as="p">This specification applies to:</span>
...
<span class="cursor-pointer">5. Implementation Requirements</span>

<span data-as="p">**Servers MUST:**</span>

- Generate schemas conforming to 2020-12 by default
- Include explicit `$schema` when using non-default dialects

<span data-as="p">**Clients MUST:**</span>
...
<span class="cursor-pointer">Why 2020-12?</span>

1.  **Ecosystem alignment**: Python SDK (via Pydantic) and Go SDK
    implementations prefer/use 2020-12
2.  **Modern features**: Better validation capabilities and composition
    support
3.  **Community preference**: Multiple maintainers and community members
    in PR \#655 discussion advocated for 2020-12 over draft-07
...
<span class="cursor-pointer">Why allow explicit declaration?</span>
...
- **Draft-07 as default**: Rejected after community feedback; older
  version with less capability
- **No default**: Rejected as unnecessarily verbose; adds boilerplate
- **Multiple equal versions**: Rejected; creates unpredictability and
  fragmentation
...
<span data-as="p">This is technically a **clarification**, and not a
...
<span data-as="p">**Migration may be needed for schemas assuming
draft-07 by default:**</span>

- Schemas using `dependencies` (→ `dependentSchemas` +
  `dependentRequired`)
- Positional array validation (→ `prefixItems`)

<span data-as="p">**Migration strategy:** Add explicit
`$schema: "http://json-schema.org/draft-07/schema#"` during transition,
then update to 2020-12 features.</span>
...
<span class="cursor-pointer">SDK Implementations</span>

<span data-as="p">**Python SDK** - Already compatible:</span>

- Uses Pydantic for schema generation
- Pydantic defaults to 2020-12 via `.model_json_schema()`

<span data-as="p">**Go SDK** - Implemented 2020-12:</span>

- Explicit 2020-12 implementation completed
- Confirmed by @samthanawalla in PR \#655 discussion

<span data-as="p">**Other SDKs:**</span>

- May require updates but based on other examples, there should be
  straightforward or out-of-the-box options to support this. I can add
  more examples here or we can create issues to follow up on these after
  acceptance.
...
<span data-as="p">No specific security implications have been identified
from establishing 2020-12 as the default dialect. The clarification
reduces ambiguity that could lead to validation mismatches between
implementations, which is a minor security improvement through increased
predictability.</span> <span data-as="p">Implementations should use
well-maintained JSON Schema validator libraries and keep them updated,
as with any dependency.</span>
...
<span class="cursor-pointer">Related Work</span>
...
href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1330"
class="link" target="_blank" rel="noreferrer">SEP-1330: Elicitation Enum
Schema Improvements</a></span>

<span data-as="p">**SEP-1330** proposes deprecating the non-standard
`enumNames` property in favor of JSON Schema 2020-12 compliant patterns.
This work is directly enabled by establishing 2020-12 as the default
dialect.</span> <span data-as="p">**Implementation Consideration:**  
As noted in SEP-1330 discussion, there is some concern about parsing
complexity with advanced JSON Schema features like `oneOf` and `anyOf`.
However, these features are part of the JSON Schema standard and
well-supported by mature validator libraries. Implementations can
balance standards compliance with their parsing needs by using
well-tested JSON Schema validation libraries.</span>
...
<span class="cursor-pointer"><a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/834"
class="link" target="_blank" rel="noreferrer">SEP-834: Full JSON Schema
2020-12 Support</a></span>

<span data-as="p">This SEP establishes the foundation (default dialect)
while SEP-834 addresses comprehensive support for 2020-12
features.</span>
...
<span class="cursor-pointer">Open Questions</span>

<span data-as="p">The schema for the spec itself references `draft-07`
and the `typescript-json-schema` package we use to generate it only
supports draft-07.</span> <span data-as="p">Options:</span>

1.  Update schema generation script to patch to 2020-12 after generation
    (this is what I did in the current PR)
...
<span data-as="p">Personally I’d prefer (1) in the short term and then
(2) as a follow-up.</span>
...
<a href="1577--sampling-with-tools.html"
...
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-1577:
Sampling With Tools</span></a><a href="1686-tasks.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-1686:
Tasks</span><img
