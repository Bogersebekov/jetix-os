...
<a href="moderation-policy.html#content-area"
...
- <a href="moderation-policy.html#scope"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Scope</a>
- <a href="moderation-policy.html#disclaimer"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Disclaimer</a>
- <a href="moderation-policy.html#what-we-remove"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">What
  We Remove</a>
- <a href="moderation-policy.html#what-we-don%E2%80%99t-remove"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">What
  We Don’t Remove</a>
- <a href="moderation-policy.html#how-removal-works"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">How
  Removal Works</a>
- <a href="moderation-policy.html#appeals"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Appeals</a>
- <a href="moderation-policy.html#changes-to-this-policy"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Changes
  to This Policy</a>
...
page-title="The MCP Registry Moderation Policy"
page-href="/registry/moderation-policy">
...
<span data-as="p">**TL;DR**: The MCP Registry is quite permissive! We
only remove illegal content, malware, spam, and completely broken
servers.</span>
...
<span data-as="p">This policy applies to the official MCP Registry at
`registry.modelcontextprotocol.io`.</span>
<span data-as="p">Subregistries may have their own moderation policies.
If you have questions about content on a specific subregistry, please
...
<span data-as="p">The MCP Registry **does not** make guarantees about
moderation, and consumers should assume minimal-to-no moderation.</span>
<span data-as="p">The MCP Registry is a community supported project, and
we have limited active moderation capabilities. We largely rely on
upstream package registries (like NPM, PyPI, and Docker) or downstream
subregistries (like the GitHub MCP Registry) to do more in-depth
moderation.</span> <span data-as="p">This means there may be content in
the MCP Registry that should be removed under this policy, but which we
haven’t yet removed. Consumers should treat scraped data
accordingly.</span>
...
<span class="cursor-pointer">What We Remove</span>

<span data-as="p">We will remove servers that contain:</span>

- Illegal content, which includes obscene content, copyright violations,
  and hacking tools
- Malware, regardless of intentions
- Spam, especially mass-created servers that disrupt the registry.
  Examples:
  - The same server being submitted multiple times under different names
  - A server that doesn’t do anything but provide a fixed response with
    some marketing copy
  - A server with a description stuffed with marketing copy and an
...
<a href="moderation-policy.html#what-we-don’t-remove"
class="-ml-10 flex items-center opacity-0 border-0 group-hover:opacity-100 focus:opacity-100 focus:outline-0 group/link"
aria-label="Navigate to header">​</a>
...
<span class="cursor-pointer">What We Don’t Remove</span>

<span data-as="p">Generally, we believe in keeping the registry open and
pushing moderation to subregistries. We therefore **won’t**
remove:</span>
...
<span class="cursor-pointer">How Removal Works</span>

<span data-as="p">When we remove a server, we set the server’s `status`
to `"deleted"`, but the server’s metadata remains accessible via the MCP
Registry API. Aggregators may then remove the server from their
indexes.</span> <span data-as="p">In extreme cases, we may overwrite or
erase the server’s metadata. For example, if the metadata itself is
unlawful.</span>
...
<span class="cursor-pointer">Appeals</span>

<span data-as="p">Think we made a mistake? Open an issue on our
<a href="https://github.com/modelcontextprotocol/registry" class="link"
target="_blank" rel="noreferrer">GitHub repository</a> with:</span>
...
<span class="cursor-pointer">Changes to This Policy</span>

<span data-as="p">We’re still learning how best to run the MCP Registry!
As such, we might end up changing this policy in the future.</span>
