...
- too_short (775 words)
quality_grade: C
slug: cognition-london
subcategory: meta
tags:
- meta
title: Cognition London
word_count: 775
---
...
# Devin crosses the pond: Cognition opens its London office
...
<a
href="https://cdn.sanity.io/images/2mc9cv2v/production/a2251ba803ebe30029f27c660c9fa29cda041144-5804x3874.jpg"
class="image" target="_blank"
style="--width: 5804; --height: 3874;"><img
src="https://cdn.sanity.io/images/2mc9cv2v/production/a2251ba803ebe30029f27c660c9fa29cda041144-5804x3874.jpg"
loading="lazy" /></a>

Cognition is opening a London office, where we’ll double down on rolling
out autonomous software engineering to the world’s leading European
businesses.

London is one of the world’s finance capitals, and over the past year,
finance has emerged as one of the clearest use cases for autonomous
coding agents. These teams operate within large, complex codebases, and
face high stakes, constant change, and stringent security requirements.

Over the past year, some of the world's largest financial institutions
have adopted Devin for work across the SDLC, from large-scale
modernization and migration projects, to security vulnerability
remediation, to documenting complex codebases. Cognition partners with
Goldman Sachs, Santander, Citi, BNY, HG Capital, The Access Group, and
others.

From the London office, we'll be able to work more closely with
customers across EMEA on their home turf. We'll be able to go to their
offices, more deeply understand their problems, and build closer
relationships with their teams.

We're building our London customer engineering team, which works with
customers on the ground to deploy AI. If you're interested in learning
more, our open roles are [here](https://jobs.ashbyhq.com/cognition).

Companies interested in deploying Cognition’s AI software engineering
platform, can [contact](contact.html) our enterprise team to learn more.
