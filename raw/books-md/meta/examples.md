...
<a href="examples.html#content-area"
...
- <span id="/docs/learn/architecture"><a href="docs/learn/architecture.html"
...
- <span id="/docs/learn/server-concepts"><a href="docs/learn/server-concepts.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/learn/client-concepts"><a href="docs/learn/client-concepts.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/learn/versioning"><a href="docs/learn/versioning.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/develop/connect-local-servers"><a href="docs/develop/connect-local-servers.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/develop/connect-remote-servers"><a href="docs/develop/connect-remote-servers.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/develop/build-with-agent-skills"><a href="docs/develop/build-with-agent-skills.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/develop/build-server"><a href="docs/develop/build-server.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/develop/build-client"><a href="docs/develop/build-client.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/sdk"><a href="docs/sdk.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/tools/inspector"><a href="docs/tools/inspector.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/docs/tools/debugging"><a href="docs/tools/debugging.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left break-words hyphens-auto rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <a href="examples.html#current-reference-servers"
  ...
  style="padding-left:1rem">Current reference servers</a>
- <a href="examples.html#additional-example-servers-archived"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Additional example servers (archived)</a>
- <a href="examples.html#official-integrations"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Official
  integrations</a>
- <a href="examples.html#community-implementations"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Community
  implementations</a>
- <a href="examples.html#getting-started"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Getting
  started</a>
- <a href="examples.html#using-reference-servers"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Using reference servers</a>
- <a href="examples.html#configuring-with-claude"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Configuring with Claude</a>
- <a href="examples.html#additional-resources"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Additional
  resources</a>
...
page-title="Example Servers" page-href="/examples">

<span data-as="p">This page showcases various Model Context Protocol
(MCP) servers that demonstrate the protocol’s capabilities and
versatility. These servers enable Large Language Models (LLMs) to
securely access tools and data sources.</span>
...
<span class="cursor-pointer">Reference implementations</span>

<span data-as="p">These official reference servers demonstrate core MCP
features and SDK usage:</span>
...
<span class="cursor-pointer">Current reference servers</span>

- **<a
  href="https://github.com/modelcontextprotocol/servers/tree/main/src/everything"
  class="link" target="_blank" rel="noreferrer">Everything</a>** -
  Reference / test server with prompts, resources, and tools
- **<a
  href="https://github.com/modelcontextprotocol/servers/tree/main/src/fetch"
  class="link" target="_blank" rel="noreferrer">Fetch</a>** - Web
...
- **<a
  ...
  class="link" target="_blank" rel="noreferrer">Filesystem</a>** -
  Secure file operations with configurable access controls
- **<a
  href="https://github.com/modelcontextprotocol/servers/tree/main/src/git"
  class="link" target="_blank" rel="noreferrer">Git</a>** - Tools to
  read, search, and manipulate Git repositories
- **<a
  href="https://github.com/modelcontextprotocol/servers/tree/main/src/memory"
  class="link" target="_blank" rel="noreferrer">Memory</a>** - Knowledge
  graph-based persistent memory system
- **<a
  href="https://github.com/modelcontextprotocol/servers/tree/main/src/sequentialthinking"
  class="link" target="_blank" rel="noreferrer">Sequential Thinking</a>** -
  Dynamic and reflective problem-solving through thought sequences
- **<a
  href="https://github.com/modelcontextprotocol/servers/tree/main/src/time"
  class="link" target="_blank" rel="noreferrer">Time</a>** - Time and
...
<span class="cursor-pointer">Additional example servers
(archived)</span>

<span data-as="p">Visit the
<a href="https://github.com/modelcontextprotocol/servers-archived"
class="link" target="_blank" rel="noreferrer">servers-archived
repository</a> to get access to archived example servers that are no
longer actively maintained.</span> <span data-as="p">They are provided
for historical reference only.</span>
...
<span class="cursor-pointer">Official integrations</span>

<span data-as="p">Visit the <a
href="https://github.com/modelcontextprotocol/servers?tab=readme-ov-file#%EF%B8%8F-official-integrations"
class="link" target="_blank" rel="noreferrer">MCP Servers Repository
(Official Integrations section)</a> for a list of MCP servers maintained
by companies for their platforms.</span>
...
<span class="cursor-pointer">Community implementations</span>

<span data-as="p">Visit the <a
href="https://github.com/modelcontextprotocol/servers?tab=readme-ov-file#-community-servers"
class="link" target="_blank" rel="noreferrer">MCP Servers Repository
(Community section)</a> for a list of MCP servers maintained by
...
<span class="cursor-pointer">Using reference servers</span>

<span data-as="p">TypeScript-based servers can be used directly with
`npx`:</span>
...
<span data-as="p">Python-based servers can be used with `uvx`
(recommended) or `pip`:</span>
...
<span class="cursor-pointer">Configuring with Claude</span>

<span data-as="p">To use an MCP server with Claude, add it to your
configuration:</span>
...
<span class="cursor-pointer">Additional resources</span>

<span data-as="p">Visit the <a
href="https://github.com/modelcontextprotocol/servers?tab=readme-ov-file#-resources"
class="link" target="_blank" rel="noreferrer">MCP Servers Repository
(Resources section)</a> for a collection of other resources and projects
related to MCP.</span> <span data-as="p">Visit our
<a href="https://github.com/orgs/modelcontextprotocol/discussions"
class="link" target="_blank" rel="noreferrer">GitHub Discussions</a> to
engage with the MCP community.</span>
...
<a href="clients.html" class="flex items-center space-x-3 group"><img
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Example
Clients</span></a>
