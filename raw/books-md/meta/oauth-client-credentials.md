...
<a href="oauth-client-credentials.html#content-area"
...
- <span id="/extensions/overview"><a href="../overview.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Extensions
  Overview</span>
...
- <span id="/extensions/client-matrix"><a href="../client-matrix.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Extension
  Support Matrix</span>
...
- <span id="/extensions/apps/overview"><a href="../apps/overview.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/extensions/apps/build"><a href="../apps/build.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
...
- <span id="/extensions/auth/overview"><a href="overview.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Authorization
  Extensions</span>

  </div>

  </div>
- <span id="/extensions/auth/oauth-client-credentials"><a href="oauth-client-credentials.html"
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">OAuth Client
  Credentials</span>

  </div>

  </div>
- <span id="/extensions/auth/enterprise-managed-authorization"><a href="enterprise-managed-authorization.html"
  class="group flex items-start pr-3 py-1.5 cursor-pointer gap-x-3 text-left rounded-xl w-full outline-offset-[-1px] hover:bg-gray-600/5 dark:hover:bg-gray-200/5 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem"></a></span>
  <div class="flex-1 flex min-w-0 items-start gap-x-2.5">
  ...
  <span class="min-w-0 max-w-full break-words hyphens-auto">Enterprise-Managed
  Authorization</span>
...
- <a href="oauth-client-credentials.html#what-it-is"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">What
  it is</a>
- <a href="oauth-client-credentials.html#when-to-use-it"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">When
  to use it</a>
- <a href="oauth-client-credentials.html#how-it-works"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">How
  it works</a>
- <a
  href="oauth-client-credentials.html#jwt-bearer-assertions-recommended"
  ...
  style="padding-left:1rem">JWT Bearer Assertions (recommended)</a>
- <a href="oauth-client-credentials.html#client-secrets"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Client Secrets</a>
- <a href="oauth-client-credentials.html#implementation-guide"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Implementation
  guide</a>
- <a href="oauth-client-credentials.html#for-mcp-clients"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">For MCP clients</a>
- <a href="oauth-client-credentials.html#for-mcp-servers"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">For MCP servers</a>
- <a href="oauth-client-credentials.html#sdk-examples"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">SDK
  examples</a>
- <a href="oauth-client-credentials.html#using-a-client-secret"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Using a client secret</a>
- <a href="oauth-client-credentials.html#using-a-jwt-private-key"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Using a JWT private key</a>
- <a href="oauth-client-credentials.html#client-support"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Client
  support</a>
- <a href="oauth-client-credentials.html#related-resources"
...
Machine-to-machine authentication for MCP using the OAuth 2.0 client
credentials flow
...
page-title="OAuth Client Credentials"
page-href="/extensions/auth/oauth-client-credentials">

<span data-as="p">The OAuth Client Credentials extension
(`io.modelcontextprotocol/oauth-client-credentials`) adds support for
the <a href="https://datatracker.ietf.org/doc/html/rfc6749#section-4.4"
class="link" target="_blank" rel="noreferrer">OAuth 2.0 client
credentials flow</a> to MCP. This enables automated systems to connect
to MCP servers without interactive user authorization.</span>
...
<img
src="data:image/svg+xml;base64,"
...
<span data-as="p">Full technical specification for the OAuth Client
Credentials extension.</span>
...
<span class="cursor-pointer">What it is</span>

<span data-as="p">The standard MCP authorization flow requires a user to
interactively approve access — a browser opens, the user logs in, and
grants permission. That works well for humans, but breaks down when
there’s no user present.</span> <span data-as="p">The OAuth Client
Credentials extension solves this by letting a client authenticate using
application-level credentials (a client ID and secret, or a signed JWT
assertion) rather than delegated user credentials. The client proves its
identity directly to the authorization server, which issues an access
token without requiring a browser redirect or user interaction.</span>
...
<span class="cursor-pointer">When to use it</span>

<span data-as="p">Use OAuth Client Credentials when:</span>

- **Background services** need to call MCP tools on a schedule or in
  response to events, without a user present
- **CI/CD pipelines** invoke MCP servers as part of automated build,
  test, or deployment workflows
- **Server-to-server integrations** connect two backend systems where
  there’s no end user involved
- **Daemon processes** or long-running workers need persistent access to
  MCP resources

<span data-as="p">If your integration has a human user who should
explicitly authorize access, use the standard MCP authorization flow
instead.</span>
...
<span class="cursor-pointer">How it works</span>

<span data-as="p">The extension supports two credential formats:</span>
...
<span class="cursor-pointer">JWT Bearer Assertions (recommended)</span>

<span data-as="p">Defined in
<a href="https://datatracker.ietf.org/doc/html/rfc7523" class="link"
target="_blank" rel="noreferrer">RFC 7523</a>, JWT Bearer Assertions let
the client sign a token with its private key and present it as proof of
identity. The authorization server validates the signature using the
client’s registered public key.</span> <span data-as="p">The JWT
assertion typically includes:</span>
...
<span class="cursor-pointer">Client Secrets</span>

<span data-as="p">For simpler deployments, the extension also supports
the standard client credentials flow using a `client_id` and
`client_secret`. The client sends its credentials directly to the
authorization server’s token endpoint and receives an access token in
return.</span>
...
<span data-as="p">Client secrets are **long-lived credentials** that
grant access without user interaction. If a secret is leaked, an
attacker can silently authenticate as your application until the secret
is rotated. To reduce risk:</span>

- Store secrets in a secrets manager, never in source code or
  environment files checked into version control.
- Rotate secrets on a regular schedule and immediately after any
  suspected compromise.
- Scope credentials to the minimum permissions required.
- Prefer JWT assertions when possible — they are short-lived and do not
  require transmitting the signing key.
...
<span class="cursor-pointer">Implementation guide</span>
...
<span class="cursor-pointer">For MCP clients</span>

<span data-as="p">To use the OAuth Client Credentials extension, your
client must:</span>
...
<a href="oauth-client-credentials.html#"
...
<span data-as="p">Include the extension in the `initialize` request
capabilities:</span>
...
<span data-as="p">Request a token from the authorization server using
the client credentials grant before connecting to the MCP server.</span>
...
<span data-as="p">Pass the token in the `Authorization` header of HTTP
requests to the MCP server:</span>
...
<span data-as="p">Client credentials tokens typically have shorter
lifetimes than user-delegated tokens. Implement token refresh logic to
obtain a new token before expiry.</span>
...
<span class="cursor-pointer">For MCP servers</span>

<span data-as="p">To accept client credentials tokens, your server
must:</span>
...
<span data-as="p">On each request, verify the JWT signature and claims
against your authorization server’s public keys (usually via a JWKS
endpoint).</span>
...
<span data-as="p">Ensure the token includes the required scopes for the
requested operation.</span>
...
<span data-as="p">Optionally (but recommended for discoverability),
include the extension in the `initialize` response:</span>
...
<span class="cursor-pointer">SDK examples</span>

<span data-as="p">The official MCP SDKs provide built-in support for
client credentials authentication. Both handle token acquisition and
refresh automatically.</span>
...
<div id="typescript" class="tabs tabs tab-container">

- <div id="typescript">

  <div class="flex text-sm items-center gap-1.5 leading-6 font-semibold whitespace-nowrap pt-3 pb-2.5 -mb-px max-w-max border-b text-primary dark:text-primary-light border-current"
  component-part="tab-button" active="true" testid="tab-TypeScript">
...
- <div id="python">
  ...
  <div class="flex text-sm items-center gap-1.5 leading-6 font-semibold whitespace-nowrap pt-3 pb-2.5 -mb-px max-w-max border-b text-gray-900 border-transparent hover:border-gray-300 dark:text-gray-200 dark:hover:border-gray-700"
  component-part="tab-button" active="false" testid="tab-Python">
...
<div id="panel-typescript-0"
class="prose dark:prose-dark overflow-x-auto [&_[data-table-wrapper]]:![--page-padding:0px] [&_[role="listitem"]]:pl-4 [&>:first-child:not(p)]:mt-0 [&>:first-child:not(p)_img]:mt-0 [&>:first-child[data-table-wrapper]]:!pt-0"
role="tabpanel" aria-labelledby="typescript"
component-part="tab-content">
...
<div id="panel-python-1"
class="prose dark:prose-dark overflow-x-auto [&_[data-table-wrapper]]:![--page-padding:0px] [&_[role="listitem"]]:pl-4 [&>:first-child:not(p)]:mt-0 [&>:first-child:not(p)_img]:mt-0 [&>:first-child[data-table-wrapper]]:!pt-0 hidden"
role="tabpanel" aria-labelledby="python" component-part="tab-content">
...
<span data-as="p">Choose the credential format that matches your
setup:</span>
...
<span class="cursor-pointer">Using a client secret</span>

<div id="typescript-2" class="tabs tabs tab-container">
...
<div id="panel-typescript-2-0"
class="prose dark:prose-dark overflow-x-auto [&_[data-table-wrapper]]:![--page-padding:0px] [&_[role="listitem"]]:pl-4 [&>:first-child:not(p)]:mt-0 [&>:first-child:not(p)_img]:mt-0 [&>:first-child[data-table-wrapper]]:!pt-0"
role="tabpanel" aria-labelledby="typescript-2"
component-part="tab-content">

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="31" language="typescript">
...
<div id="panel-python-2-1"
class="prose dark:prose-dark overflow-x-auto [&_[data-table-wrapper]]:![--page-padding:0px] [&_[role="listitem"]]:pl-4 [&>:first-child:not(p)]:mt-0 [&>:first-child:not(p)_img]:mt-0 [&>:first-child[data-table-wrapper]]:!pt-0 hidden"
role="tabpanel" aria-labelledby="python-2" component-part="tab-content">

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="23" language="python">
...
<span class="cursor-pointer">Using a JWT private key</span>

<div id="typescript-3" class="tabs tabs tab-container">
...
<div id="panel-typescript-3-0"
class="prose dark:prose-dark overflow-x-auto [&_[data-table-wrapper]]:![--page-padding:0px] [&_[role="listitem"]]:pl-4 [&>:first-child:not(p)]:mt-0 [&>:first-child:not(p)_img]:mt-0 [&>:first-child[data-table-wrapper]]:!pt-0"
role="tabpanel" aria-labelledby="typescript-3"
component-part="tab-content">

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="32" language="typescript">
...
<div id="panel-python-3-1"
class="prose dark:prose-dark overflow-x-auto [&_[data-table-wrapper]]:![--page-padding:0px] [&_[role="listitem"]]:pl-4 [&>:first-child:not(p)]:mt-0 [&>:first-child:not(p)_img]:mt-0 [&>:first-child[data-table-wrapper]]:!pt-0 hidden"
role="tabpanel" aria-labelledby="python-3" component-part="tab-content">

<div class="code-block mt-5 mb-8 not-prose rounded-2xl relative group min-w-0 print:print-color-exact text-gray-950 dark:text-gray-50 codeblock-light border border-gray-950/10 dark:border-white/10 dark:twoslash-dark bg-transparent dark:bg-transparent"
numberoflines="33" language="python">
...
<span class="cursor-pointer">Client support</span>
...
<span data-as="p">Support for this extension varies by client.
Extensions are opt-in and never active by default.</span>

</div>

</div>

<span data-as="p">Check the
<a href="../client-matrix.html" class="link">client matrix</a> for
current implementation status across MCP clients.</span>
...
<img
src="data:image/svg+xml;base64,"
class="size-6 bg-primary dark:bg-primary-light !m-0 shrink-0" />
...
<span data-as="p">Source code and reference implementations</span>
...
<span data-as="p">Technical specification with normative
requirements</span>
...
<img
src="data:image/svg+xml;base64,"
class="size-6 bg-primary dark:bg-primary-light !m-0 shrink-0" />
...
<span data-as="p">The underlying OAuth 2.0 specification</span>
...
<span data-as="p">JWT assertion format specification</span>
...
<a href="overview.html" class="flex items-center space-x-3 group"><img
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Authorization
Extensions</span></a><a href="enterprise-managed-authorization.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Enterprise-Managed
Authorization</span><img
