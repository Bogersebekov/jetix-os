...
<a href="communication.html#content-area"
...
- <a href="communication.html#communication-channels"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Communication
  Channels</a>
- <a href="communication.html#discord"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Discord</a>
- <a href="communication.html#public-channels-default"
  ...
  style="padding-left:1rem">Public Channels (Default)</a>
- <a href="communication.html#private-channels-exceptions"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Private Channels (Exceptions)</a>
- <a href="communication.html#github-discussions"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">GitHub
  Discussions</a>
- <a href="communication.html#github-issues"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">GitHub
  Issues</a>
- <a href="communication.html#security-issues"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Security
  Issues</a>
- <a href="communication.html#decision-records"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Decision
  Records</a>
...
Communication strategy and framework for the Model Context Protocol
community
...
page-title="Contributor Communication"
page-href="/community/communication">

<span data-as="p">This document explains how to communicate and
collaborate within the Model Context Protocol (MCP) project.</span>
...
rel="noreferrer">Discord</a> | Real-time discussion | Quick questions, coordination, WG/IG discussions |
| <a href="https://meet.modelcontextprotocol.io/" class="link"
target="_blank" rel="noreferrer">Live calls</a> | Sync up | WG/IG presentations, progress reports |
| <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/discussions"
class="link" target="_blank" rel="noreferrer">GitHub Discussions</a> | Structured discussion | Proposals, roadmap planning, longer-form debate |
| <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues"
class="link" target="_blank" rel="noreferrer">GitHub Issues</a> | Actionable tasks | Bug reports, documentation fixes |
| <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/SECURITY.md"
class="link" target="_blank" rel="noreferrer">Vulnerability reports</a> | Security issues | Vulnerabilities - **never post publicly** |

</div>

</div>

<span data-as="p">All communication is governed by our <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/CODE_OF_CONDUCT.md"
class="link" target="_blank" rel="noreferrer">Code of Conduct</a>. We
expect respectful, professional, and inclusive interactions across all
channels.</span>
...
<span class="cursor-pointer">Discord</span>

<span data-as="p">The
<a href="https://discord.gg/6CSzBmMkjX" class="link" target="_blank"
rel="noreferrer">MCP Contributor Discord</a> is for real-time
contributor discussion and collaboration. The server is designed for
**MCP contributors** and is not intended for general MCP support.</span>
...
<span data-as="p">**Purpose:** Open community engagement, collaborative
development, and transparent project coordination.</span>
<span data-as="p">**Primary use cases:**</span>

- SDK and tooling development (e.g., `#typescript-sdk-dev`,
  `#inspector-dev`)
- <a href="working-interest-groups.html" class="link">Working Group and
  Interest Group</a> discussions (e.g., `#auth-wg`, `#security-ig`)
...
<span data-as="p">**Avoid:**</span>

- MCP user support - Read official documentation and use GitHub
  Discussions for questions
- Service or product marketing - Keep discussions vendor-neutral;
  mentions of brands are discouraged except as examples relevant to the
  specification
...
<span data-as="p">**Purpose:** Confidential coordination and sensitive
matters. Access is restricted to designated maintainers.</span>
<span data-as="p">**Criteria for private use:**</span>

- Security incidents (CVEs, protocol vulnerabilities)
- People matters (maintainer discussions, code of conduct issues)
- Coordination requiring immediate or focused response with a limited
  audience
- Some channels are read-only for maintainer decision-making

<span data-as="p">**Transparency requirements:**</span>

- All technical and governance decisions affecting the community must be
  documented in GitHub Discussions and/or Issues, labeled with `notes`
- Private channels are temporary “incident rooms,” not for routine
  development
- Some matters related to individual contributors may remain private
  when appropriate

<span data-as="p">Any significant discussion on Discord that leads to a
potential decision or proposal must be moved to GitHub Discussion or
Issue for a persistent, searchable record.</span>
...
<span data-as="p">Use for structured, long-form discussion and debate on
project direction.</span> <span data-as="p">**When to use:**</span>
...
- If a repository doesn’t have Discussions enabled, use GitHub Issues
  instead
...
<span data-as="p">Use for bug reports and actionable development tasks.
Feature requests should go to <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/discussions"
class="link" target="_blank" rel="noreferrer">GitHub Discussions</a>.</span>
<span data-as="p">**When to use:**</span>
...
<span data-as="p">**Note:** SEP proposals are submitted as pull requests
to the <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/tree/main/seps"
class="link" target="_blank" rel="noreferrer"><code>seps/</code>
directory</a>, not as GitHub Issues. See the
...
<span class="cursor-pointer">Security Issues</span>

<span data-as="p">**Do not post security issues publicly.**</span>

1.  Use the private security reporting process in <a
    href="https://github.com/modelcontextprotocol/modelcontextprotocol/blob/main/SECURITY.md"
    class="link" target="_blank" rel="noreferrer">SECURITY.md</a>
2.  Contact Lead or
    <a href="governance.html#current-core-maintainers" class="link">Core
    Maintainers</a> directly
...
<span data-as="p">All MCP decisions are documented in public
channels:</span>
...
| Type | Location |
|----|----|
| Technical decisions | <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues"
class="link" target="_blank" rel="noreferrer">GitHub Issues</a> and SEPs |
| Specification changes | <a href="https://modelcontextprotocol.io/specification/draft/changelog"
class="link" target="_blank" rel="noreferrer">Changelog</a> |
| Process changes | <a href="governance.html" class="link" target="_blank"
rel="noreferrer">Community documentation</a> |
...
<span data-as="p">When documenting decisions, we retain as much context
as possible:</span>
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Contributing
to MCP</span></a><a href="working-interest-groups.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Working
and Interest Groups</span><img
