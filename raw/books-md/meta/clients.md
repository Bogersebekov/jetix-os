...
<a href="clients.html#content-area"
...
- <a href="clients.html#client-details"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Client
  details</a>
- <a href="clients.html#adding-mcp-support-to-your-application"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Adding
  MCP support to your application</a>
...
page-title="Example Clients" page-href="/clients">

<span data-as="p">This page showcases applications that support the
Model Context Protocol (MCP). Each client may support different MCP
features:</span>
...
|  | <a
href="specification/latest/basic/authorization.html#client-id-metadata-documents"
class="link" target="_blank" rel="noreferrer">Client ID Metadata
Document</a> support |
|  | <a
href="specification/latest/basic/authorization.html#dynamic-client-registration"
class="link" target="_blank" rel="noreferrer">Dynamic Client
Registration</a> support |
|  | <a href="extensions/auth/oauth-client-credentials.html"
class="link">OAuth Client Credentials</a> extension support |
|  | <a href="extensions/auth/enterprise-managed-authorization.html"
class="link">Enterprise-Managed Authorization</a> extension support |
...
notice any inaccuracies or would like to add or update information about
MCP support in your application, please <a
...
<span class="cursor-pointer">Client details</span>
...
<span class="cursor-pointer">Adding MCP support to your
application</span>

<span data-as="p">If you’ve added MCP support to your application, we
encourage you to submit a pull request to add it to this list. MCP
integration can provide your users with powerful contextual AI
capabilities and make your application part of the growing MCP
ecosystem.</span> <span data-as="p">Benefits of adding MCP
support:</span>
...
<span data-as="p">To get started with implementing MCP in your
application, check out our
<a href="https://github.com/modelcontextprotocol/python-sdk"
class="link" target="_blank" rel="noreferrer">Python</a> or
<a href="https://github.com/modelcontextprotocol/typescript-sdk"
class="link" target="_blank" rel="noreferrer">TypeScript SDK
...
<a href="docs/tools/debugging.html"
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Debugging</span></a><a href="examples.html"
