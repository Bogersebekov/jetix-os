...
priority: P2
quality_grade: A
slug: 990-enable-enterprise-idp-policy-controls-during-mcp-o
subcategory: meta
tags:
- meta
title: 990 Enable Enterprise Idp Policy Controls During Mcp O
word_count: 3070
---
...
<a
href="990-enable-enterprise-idp-policy-controls-during-mcp-o.html#content-area"
...
- <a
  href="990-enable-enterprise-idp-policy-controls-during-mcp-o.html#abstract"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Abstract</a>
- <a
  href="990-enable-enterprise-idp-policy-controls-during-mcp-o.html#how-has-this-been-tested"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">How
  Has This Been Tested?</a>
- <a
  href="990-enable-enterprise-idp-policy-controls-during-mcp-o.html#breaking-changes"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Breaking
  Changes</a>
- <a
  href="990-enable-enterprise-idp-policy-controls-during-mcp-o.html#additional-context"
...
page-title="SEP-990: Enable enterprise IdP policy controls during MCP OAuth flows"
page-href="/seps/990-enable-enterprise-idp-policy-controls-during-mcp-o">
...
| **Created** | 2025-06-04 |
| **Author(s)** | Aaron Parecki (<a href="https://github.com/aaronpk" class="link" target="_blank"
rel="noreferrer">@aaronpk</a>) |
| **Sponsor** | None |
| **PR** | <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/646"
class="link" target="_blank" rel="noreferrer">#646</a> |
...
<span data-as="p">This extension is designed to facilitate secure and
interoperable authorization of MCP clients within corporate
environments, leveraging existing enterprise identity
infrastructure.</span>

- For end users, this removes the need to manually connect and authorize
  the MCP Client to individual services within the organization.
- For enterprise admins, this enables visibility and control over which
  MCP Servers are able to be used within the organization.
...
<span class="cursor-pointer">How Has This Been Tested?</span>

<span data-as="p">We have an end to end implementation of this
<a href="https://github.com/oktadev/okta-cross-app-access-mcp"
class="link" target="_blank" rel="noreferrer">here</a>, and in-progress
MCP implementations with some partners.</span>
...
<span class="cursor-pointer">Breaking Changes</span>

<span data-as="p">This is designed to augment the existing OAuth profile
by providing an alternative when used under an enterprise IdP. MCP
clients can opt in to this profile when necessary.</span>
...
<span class="cursor-pointer">Additional Context</span>

<span data-as="p">For more background on this problem, you can refer to
my blog post about this here:</span>
<span data-as="p"><a href="https://aaronparecki.com/2025/05/12/27/enterprise-ready-mcp"
class="link" target="_blank" rel="noreferrer">Enterprise-Ready MCP</a></span>
<span data-as="p">I also presented this at the MCP Dev Summit in
May.</span> <span data-as="p">A high level overview of the flow is
below:</span>

> <span data-as="p">\[!IMPORTANT\] **State:** Ready to Review</span>
...
<a href="986-specify-format-for-tool-names.html"
...
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-986:
Specify Format for Tool Names</span></a><a href="991-enable-url-based-client-registration-using-oauth-c.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-991:
Enable URL-based Client Registration us…</span><img
