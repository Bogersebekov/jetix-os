...
<a href="authentication.html#content-area"
...
- <a href="authentication.html#github-authentication"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">GitHub
  Authentication</a>
- <a href="authentication.html#dns-authentication"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">DNS
  Authentication</a>
- <a href="authentication.html#http-authentication"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">HTTP
  Authentication</a>
...
page-title="How to Authenticate When Publishing to the Official MCP Registry"
page-href="/registry/authentication">
...
<span data-as="p">You must authenticate before publishing to the
official MCP Registry. The MCP Registry supports different
authentication methods. Which authentication method you choose
determines the namespace of your server’s name.</span>
<span data-as="p">If you choose GitHub-based authentication, your
server’s name in `server.json` **MUST** be of the form
`io.github.username/*` (or `io.github.orgname/*`). For example,
`io.github.alice/weather-server`.</span> <span data-as="p">If you choose
domain-based authentication, your server’s name in `server.json`
**MUST** be of the form `com.example.*/*`, where `com.example` is the
reverse-DNS form of your domain name. For example,
`io.modelcontextprotocol/everything`.</span>
...
<span class="cursor-pointer">GitHub Authentication</span>

<span data-as="p">GitHub authentication uses an OAuth flow initiated by
the `mcp-publisher` CLI tool.</span> <span data-as="p">To perform GitHub
authentication, navigate to your server project directory and
run:</span>
...
<span class="cursor-pointer">DNS Authentication</span>

<span data-as="p">DNS authentication is a domain-based authentication
method that relies on a DNS TXT record.</span> <span data-as="p">To
perform DNS authentication using the `mcp-publisher` CLI tool, run the
following commands in your server project directory to generate a TXT
record based on a public/private key pair:</span>
...
<div id="radix-_R_gldinpfcqcf9babsnpfdb_-content-0"
...
aria-labelledby="radix-_R_gldinpfcqcf9babsnpfdb_-trigger-0"
...
<div id="radix-_R_gldinpfcqcf9babsnpfdb_-content-1"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_gldinpfcqcf9babsnpfdb_-trigger-1" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_gldinpfcqcf9babsnpfdb_-content-2"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_gldinpfcqcf9babsnpfdb_-trigger-2" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_gldinpfcqcf9babsnpfdb_-content-3"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_gldinpfcqcf9babsnpfdb_-trigger-3" hidden=""
tabindex="-1">
...
<span data-as="p">Then add the TXT record using your DNS provider’s
control panel. It may take several minutes for the TXT record to
propagate. After the TXT record has propagated, log in using the
`mcp-publisher login` command:</span>
...
<div id="radix-_R_ildinpfcqcf9babsnpfdb_-content-0"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="active" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_ildinpfcqcf9babsnpfdb_-trigger-0"
tabindex="-1" style="animation-duration:0s">
...
<div id="radix-_R_ildinpfcqcf9babsnpfdb_-content-1"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_ildinpfcqcf9babsnpfdb_-trigger-1" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_ildinpfcqcf9babsnpfdb_-content-2"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_ildinpfcqcf9babsnpfdb_-trigger-2" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_ildinpfcqcf9babsnpfdb_-content-3"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_ildinpfcqcf9babsnpfdb_-trigger-3" hidden=""
tabindex="-1">
...
<span class="cursor-pointer">HTTP Authentication</span>

<span data-as="p">HTTP authentication is a domain-based authentication
method that relies on a `/.well-known/mcp-registry-auth` file hosted on
your domain. For example,
`https://example.com/.well-known/mcp-registry-auth`.</span>
<span data-as="p">To perform HTTP authentication using the
`mcp-publisher` CLI tool, run the following commands in your server
project directory to generate an `mcp-registry-auth` file based on a
public/private key pair:</span>
...
<div id="radix-_R_mldinpfcqcf9babsnpfdb_-content-0"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="active" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_mldinpfcqcf9babsnpfdb_-trigger-0"
tabindex="-1" style="animation-duration:0s">
...
<div id="radix-_R_mldinpfcqcf9babsnpfdb_-content-1"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_mldinpfcqcf9babsnpfdb_-trigger-1" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_mldinpfcqcf9babsnpfdb_-content-2"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_mldinpfcqcf9babsnpfdb_-trigger-2" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_mldinpfcqcf9babsnpfdb_-content-3"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_mldinpfcqcf9babsnpfdb_-trigger-3" hidden=""
tabindex="-1">
...
<span data-as="p">Then host the `mcp-registry-auth` file at
`/.well-known/mcp-registry-auth` on your domain. After the file is
hosted, log in using the `mcp-publisher login` command:</span>
...
<div id="radix-_R_oldinpfcqcf9babsnpfdb_-content-0"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="active" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_oldinpfcqcf9babsnpfdb_-trigger-0"
tabindex="-1" style="animation-duration:0s">
...
<div id="radix-_R_oldinpfcqcf9babsnpfdb_-content-1"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_oldinpfcqcf9babsnpfdb_-trigger-1" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_oldinpfcqcf9babsnpfdb_-content-2"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_oldinpfcqcf9babsnpfdb_-trigger-2" hidden=""
tabindex="-1">

</div>

<div id="radix-_R_oldinpfcqcf9babsnpfdb_-content-3"
class="w-full min-w-full max-w-full h-full max-h-full relative [&_[data-component-part=code-block-root]]:!rounded-xt"
state="inactive" orientation="horizontal" role="tabpanel"
aria-labelledby="radix-_R_oldinpfcqcf9babsnpfdb_-trigger-3" hidden=""
tabindex="-1">
...
class="group-hover:text-gray-900 dark:group-hover:text-white">Remote
Servers</span></a><a href="versioning.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Versioning</span><img
