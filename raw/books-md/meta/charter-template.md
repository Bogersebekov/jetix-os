...
<a href="charter-template.html#content-area"
...
- <a href="charter-template.html#example-mission-statements"
  class="break-words py-1 block hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Example
  Mission Statements</a>
...
page-title="Group Charter Template"
page-href="/community/charter-template">

<span data-as="p">Every MCP Working Group and Interest Group must
maintain a charter document following this structure. Charters are
stored at `docs/community/<group-name>/charter.mdx` in the
<a href="https://github.com/modelcontextprotocol/modelcontextprotocol"
class="link" target="_blank" rel="noreferrer">modelcontextprotocol
repository</a> and added to `docs/docs.json`.</span>
<span data-as="p">The charter captures information specific to your
group. Governance rules — leadership requirements, decision-making
process, meeting requirements, escalation paths — are defined in the
<a href="working-interest-groups.html" class="link">Working and Interest
Groups</a> documentation and apply automatically. Do not repeat them
here.</span> <span data-as="p">Sections marked **(WG only)** are
required for Working Groups and optional for Interest Groups.</span>
...
<span data-as="p">Copy the markdown below into
`docs/community/<group-name>/charter.mdx` and replace the placeholder
text.</span>
...
numberoflines="124" language="markdown">
...
<span class="cursor-pointer">Example Mission Statements</span>

<span data-as="p">**Working Group:**</span>

> <span data-as="p">The Transport Working Group exists to evolve MCP’s
> transport mechanisms to support diverse deployment scenarios—from
> local subprocess communication to horizontally-scaled cloud
> deployments—while maintaining protocol coherence and backward
> compatibility.</span>

<span data-as="p">**Interest Group:**</span>

> <span data-as="p">The Enterprise IG explores the challenges of
> deploying MCP in enterprise environments, gathering use cases and
> requirements to inform future specification work.</span>
...
<a href="working-interest-groups.html"
...
and Interest Groups</span></a><a href="design-principles.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">Design
Principles</span><img
