...
priority: P2
quality_grade: A
slug: 932-model-context-protocol-governance
subcategory: meta
tags:
- meta
title: 932 Model Context Protocol Governance
word_count: 3941
---
...
<a href="932-model-context-protocol-governance.html#content-area"
...
- <a
  ...
  style="padding-left:1rem">Hierarchical Structure</a>
- <a
  href="932-model-context-protocol-governance.html#individual-vs-corporate-membership"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Individual vs Corporate Membership</a>
- <a href="932-model-context-protocol-governance.html#sep-process"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">SEP Process</a>
- <a href="932-model-context-protocol-governance.html#specification"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Specification</a>
- <a
  href="932-model-context-protocol-governance.html#governance-structure"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Governance Structure</a>
- <a href="932-model-context-protocol-governance.html#contributors"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Contributors</a>
- <a href="932-model-context-protocol-governance.html#maintainers"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Maintainers</a>
- <a href="932-model-context-protocol-governance.html#core-maintainers"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Core Maintainers</a>
- <a href="932-model-context-protocol-governance.html#lead-maintainers"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:2rem">Lead Maintainers</a>
- <a
  href="932-model-context-protocol-governance.html#backwards-compatibility"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Backwards
  Compatibility</a>
- <a
  href="932-model-context-protocol-governance.html#reference-implementation"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Reference
  Implementation</a>
- <a
  href="932-model-context-protocol-governance.html#security-implications"
...
page-title="SEP-932: Model Context Protocol Governance"
page-href="/seps/932-model-context-protocol-governance">
...
| **Sponsor** | None |
| **PR** | <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/931"
class="link" target="_blank" rel="noreferrer">#931</a> |
...
<span data-as="p">This SEP establishes the formal governance model for
the Model Context Protocol (MCP) project. It defines the organizational
structure, decision-making processes, and contribution guidelines
necessary for transparent and effective project stewardship. The
proposal introduces a hierarchical governance structure with clear roles
and responsibilities, along with the Specification Enhancement Proposal
(SEP) process for managing protocol changes.</span>
...
<span data-as="p">As the Model Context Protocol grows in adoption and
complexity, the need for formal governance becomes critical. The current
informal decision-making process lacks:</span>

1.  **Transparency**: Community members have no clear visibility into
    how decisions are made
2.  **Participation Pathways**: Contributors lack defined ways to
    influence project direction
3.  **Accountability**: No formal structure exists for resolving
    disputes or contentious issues
4.  **Scalability**: Ad-hoc processes cannot scale with growing
    community and technical complexity

<span data-as="p">Without formal governance, the project risks:</span>
...
<span data-as="p">The proposed governance model draws inspiration from
successful open source projects like Python, PyTorch, and Rust. Key
design decisions include:</span>
...
<span class="cursor-pointer">Hierarchical Structure</span>

<span data-as="p">We chose a hierarchical model (Contributors →
Maintainers → Core Maintainers → Lead Maintainers) that is effectively
how the project decisions are made today. From there we will continue to
evolve governance in the best interest of the project.</span>
...
<span class="cursor-pointer">Individual vs Corporate Membership</span>

<span data-as="p">Membership is explicitly tied to individuals rather
than companies to:</span>

- Ensure decisions prioritize protocol integrity over corporate
  interests
...
<span class="cursor-pointer">SEP Process</span>

<span data-as="p">The Specification Enhancement Proposal process
ensures:</span>
...
<span class="cursor-pointer">Governance Structure</span>
...
<span class="cursor-pointer">Contributors</span>

- Any individual who files issues, submits pull requests, or
...
<span class="cursor-pointer">Maintainers</span>
...
<span class="cursor-pointer">Core Maintainers</span>
...
<span class="cursor-pointer">Lead Maintainers</span>
...
Document OpenTelemetry Trace Context Pr…</span></a><a href="973-expose-additional-metadata-for-implementations-res.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-973:
Expose additional metadata for Implemen…</span><img
