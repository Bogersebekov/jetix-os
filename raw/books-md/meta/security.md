...
If you have identified a potential security vulnerability in our
products, services, or infrastructure, we encourage you to report it
responsibly to help us address the issue promptly.

## How to Report a Vulnerability

To report a security vulnerability, please visit
<https://bugcrowd.com/engagements/cognition-ai-vdp-pro>

## What to Expect

- We will acknowledge receipt of your report within **48 hours**.
- Our security team will investigate the issue and may contact you for
  further details.
- If your report is validated, we will work to resolve the vulnerability
...
- Avoid accessing, modifying, or deleting data that does not belong to
  you.
- Refrain from any actions that could harm our systems or users.
