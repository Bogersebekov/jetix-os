...
priority: P2
quality_grade: A
slug: 414-request-meta
subcategory: meta
tags:
- meta
title: 414 Request Meta
word_count: 3687
---
...
<a href="414-request-meta.html#content-area"
...
- <a href="414-request-meta.html#non-normative-example"
  ...
  style="padding-left:1rem">Non-normative example</a>
- <a href="414-request-meta.html#rationale"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Rationale</a>
- <a href="414-request-meta.html#why-document-this"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Why document this?</a>
- <a href="414-request-meta.html#related-seps"
  class="group flex items-start break-words py-1 whitespace-pre-wrap text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300"
  style="padding-left:1rem">Related SEPs</a>
- <a href="414-request-meta.html#backward-compatibility"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Backward
  Compatibility</a>
- <a href="414-request-meta.html#security-implications"
  class="break-words py-1 block font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300">Security
  Implications</a>
- <a href="414-request-meta.html#reference-implementation"
...
page-title="SEP-414: Document OpenTelemetry Trace Context Propagation Conventions"
page-href="/seps/414-request-meta">
...
| **Created** | 2025-04-25 |
| **Author(s)** | Adrian Cole (<a href="https://github.com/codefromthecrypt" class="link"
target="_blank" rel="noreferrer">@codefromthecrypt</a>) |
| **Sponsor** | Marcelo Trylesinski (<a href="https://github.com/Kludex" class="link" target="_blank"
rel="noreferrer">@Kludex</a>) |
| **PR** | <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/414"
class="link" target="_blank" rel="noreferrer">#414</a> |
...
<span data-as="p">This SEP documents conventions for OpenTelemetry
(OTel) trace context propagation in MCP.</span> <span data-as="p"><a
href="https://github.com/open-telemetry/semantic-conventions/blob/e126ea9105b15912ccd80deab98929025189b696/docs/gen-ai/mcp.md#context-propagation"
class="link" target="_blank" rel="noreferrer">OTel semantic conventions
for MCP</a> specify using `_meta` as the carrier for W3C Trace Context
keys. This is already in practice in the C# SDK and other
implementations.</span> <span data-as="p">This specification documents
an exception to the DNS prefixing convention for keys in `_meta`. This
enables interoperability across existing and new implementations and
serves as a foundation for related SEPs (such as <a
href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2028"
class="link" target="_blank" rel="noreferrer">SEP-2028</a>).</span>
...
<span data-as="p">This SEP adds documentation to the MCP specification,
noting:</span>

1.  <span data-as="p">When OTel trace context is propagated via `_meta`,
    the keys `traceparent`, `tracestate`, and `baggage` follow
    <a href="https://www.w3.org/TR/trace-context/" class="link"
    target="_blank" rel="noreferrer">W3C Trace Context</a> and
    <a href="https://www.w3.org/TR/baggage/" class="link" target="_blank"
    rel="noreferrer">W3C Baggage</a> value formats.</span>
2.  <span data-as="p">A non-normative example showing trace context in
    `_meta`.</span>
3.  <span data-as="p">A note clarifying why this an exception to DNS
    prefixing keys in `_meta`: to remain compatible with existing
    implementations and the OpenTelemetry semantic conventions.</span>

<span data-as="p">See <a
href="https://github.com/agentclientprotocol/agent-client-protocol/pull/297"
class="link" target="_blank"
rel="noreferrer">agentclientprotocol/agent-client-protocol#297</a> for
equivalent documentation changes in ACP.</span>
...
<span class="cursor-pointer">Non-normative example</span>
...
numberoflines="14" language="json">
...
<span class="cursor-pointer">Why document this?</span>

<span data-as="p">This is currently documented elsewhere, but not as an
MCP specification. Doing so ensures that SEPs depending on this pattern
can complete, as well as other SDKs in and outside the MCP org can as
well, such as <a
href="https://github.com/pydantic/logfire/blob/09232402fd7e268c667db59d1e9f890ed30f7850/logfire/_internal/integrations/mcp.py#L149-L162"
class="link" target="_blank" rel="noreferrer">Logfire</a> and
<a href="https://github.com/stacklok/toolhive/issues/3399" class="link"
target="_blank" rel="noreferrer">ToolHive</a>.</span>
<span data-as="p">If we don’t document this shared concern, differing
interpretations could materialize, such as namespacing traceparent like
`io.modelcontextprotocol.traceparent`, which will break traces and log
correlation.</span>
...
<span class="cursor-pointer">Related SEPs</span>

- <a
  href="https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1788"
  class="link" target="_blank" rel="noreferrer">SEP-1788</a> - reserved
  keys in `_meta`; should be updated with `traceparent`, `tracestate`,
  and `baggage` when this SEP is implemented
- <a
  href="https://github.com/modelcontextprotocol/modelcontextprotocol/pull/2028"
  class="link" target="_blank" rel="noreferrer">SEP-2028</a> - builds on
...
<span data-as="p">This SEP documents existing conventions and is
backward compatible.</span>
...
<span data-as="p">Trace context in `_meta` may include correlation IDs.
Implementations should follow existing data-handling guidance
appropriate to their environment.</span>
...
<span data-as="p">Existing implementations using this pattern:</span>

- <a
  href="https://github.com/modelcontextprotocol/csharp-sdk/blob/main/src/ModelContextProtocol.Core/Diagnostics.cs"
  class="link" target="_blank" rel="noreferrer">C# SDK instrumentation</a>
- <a href="https://github.com/modelcontextprotocol/python-sdk/pull/1693"
  class="link" target="_blank" rel="noreferrer">Python SDK
  instrumentation</a>
- <a
  href="https://github.com/Arize-ai/openinference/tree/main/python/instrumentation/openinference-instrumentation-mcp"
  class="link" target="_blank" rel="noreferrer">OpenInference MCP
  instrumentation (Python)</a>
- <a
  href="https://github.com/Arize-ai/openinference/tree/main/js/packages/openinference-instrumentation-mcp"
  class="link" target="_blank" rel="noreferrer">OpenInference MCP
  instrumentation (TypeScript)</a>
- <a
  href="https://github.com/envoyproxy/ai-gateway/blob/6331b54aef81dd6c8d3d184acc4e2cb8167cea2a/internal/tracing/tracingapi/mcp.go"
  class="link" target="_blank" rel="noreferrer">Envoy AI Gateway</a>
- <a
  href="https://github.com/pydantic/logfire/blob/09232402fd7e268c667db59d1e9f890ed30f7850/logfire/_internal/integrations/mcp.py#L149-L162"
  class="link" target="_blank" rel="noreferrer">Logfire</a>
- <a href="https://github.com/stacklok/toolhive/issues/3399" class="link"
  target="_blank" rel="noreferrer">ToolHive</a>
...
<a href="../seps.html" class="flex items-center space-x-3 group"><img
...
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP
Index</span></a><a href="932-model-context-protocol-governance.html"
class="flex items-center ml-auto space-x-3 group"><span
class="group-hover:text-gray-900 dark:group-hover:text-white">SEP-932:
Model Context Protocol Governance</span><img
