...
This Acceptable Use Policy (or “AUP”), sets out certain guidelines and
restrictions relating to your use and access to Cognition AI, Inc.’s
(“Cognition”, “we”, or “us”) Services (as that term is defined in our
Terms of Service (the “Terms”)
available [here](https://www.cognition.ai/pages/terms-of-service)),
including Devin and Windsurf, and is intended to help our users use our
products and Services safely and responsibly. This AUP is incorporated
into and made a part of the Terms. By using our products and Services,
you agree to adhere to this AUP. If you do not understand or agree to
this AUP, please do not use the Services. We will continue to update
this AUP, including to reflect changes in our technology and our users.

Cognition may monitor your usage to enforce our AUP so please review
these policies carefully before using our products and Services. If you
believe that any actions of another user on the Services breaches this
AUP, please notify us at <security@cognition.ai> and include a
description of such breach. We will determine in our reasonable
discretion whether any action on the Services constitutes a breach of
this AUP. If we learn that you have violated our AUP, we may take any
action in response which we deem reasonable in our sole discretion,
including, without limitation, suspending your access to our products
and Services without notice or reporting such breach to the appropriate
regulatory authority. We will have no responsibility or liability to you
for another user’s breach of this Policy. If you discover that our model
outputs are inaccurate, biased or harmful, please notify us
at <security@cognition.ai>.

## [Universal Policies](pages/acceptable-use-policy.html#universal-policies)

We believe our products and Services can be powerful tools to help
builders bring their ideas to life, but when using our products and
Services, these rules apply:

**You must comply with applicable laws** – any use of our products and
Services must comply with the law; it cannot infringe on anyone’s
intellectual property, promote or engage in illegal activity, compromise
the privacy or publicity rights of others, or engage in regulated
activity without complying with applicable regulations.

**Don’t repurpose or distribute output from our Services to harm
others** – don’t use our products and Services or share output from our
Services to defraud, scam, spam, mislead, bully, harass, exploit,
defame, discriminate based on protected attributes, promote violence,
hatred or the suffering of others or to sexualize children.

**Don’t override our security protocols** – you must comply with
security measures established in our Services to protect sensitive data
and prevent unauthorized access. You may not provide any other user
access to your account or account credentials, attempt to circumvent our
security measures or otherwise interfere with our products or Services.

## [Building with our Services](pages/acceptable-use-policy.html#building-with-our-services)

**User Safety**

- We do not allow content or activity on our Services that:
- Is unlawful or promotes illegal activities
- Is sexually explicit, exploitative or inappropriate, especially in
  relation to minors
- Is defamatory, fraudulent, or libelous, or promotes such content or
  activity
- Is discriminatory or abusive towards individuals or groups, including
  based on attributes such as race, religion, gender, age, nationality
...
- Users must not use our Services to collect, store, share or otherwise
  process personal data without consent.
- Users are prohibited from generating content that violates the privacy
  of any person or third party, such as by posting another person’s
  personal information without consent.
- Users must not use our Services to facilitate spyware, communications
  surveillance, or unauthorized monitoring of individuals.
- Users should respect confidentiality agreements and not disclose any
  sensitive information.

**Intellectual Property**

- Users must not use our Services to infringe upon the intellectual
  property rights of any party, including copyrights, trademarks,
  patents and rights of publicity.
- Users must respect the intellectual property rights of our company and
  refrain from reverse-engineering or reproducing our product or
  crawling, scraping or harvesting data from our services, unless
  otherwise permitted by applicable law.
- Users may not use the Services as a part of any effort to compete with
  us or build a competitive product.

**Spam or Inauthentic Activity**

We do not allow users to:

- Use our Services to send unsolicited or unauthorized messages,
  advertisements, or spam to third parties.
- Use our Services to propagate abuse on other platforms or participate
  in disinformation campaigns.
- Use our Services for phishing or attempted phishing activity.
- Create content that users know is inaccurate or misleading.
- Impersonate others or misrepresent themselves, including to represent
  that the output from our Services is human-generated.

**Site Access & Safety**

- Users are prohibited from using our product in a manner that could
  cause technical harm, such as creating malicious code, distributing
  malware or viruses, launching denial-of-service attacks or doing
  anything else that could disable or impair a website or computer
  system.
- Access to our Services is restricted to authorized users who have
  registered and agreed to our Terms (or the terms agreed by your
  organization), and users must not provide other users with access to
  their account or their account credentials.
- Users must not attempt to gain unauthorized access to our systems or
  data or attempt to circumvent our security measures.
- Use of third-party models may be subject to the Acceptable Use
  Policies of the respective third parties (including supported
  countries of such providers).

**User Protection**

- Users must not engage in activities that could adversely affect or
  harm other users, such as harassment or exploitation.
- Users should not use the Services to make decisions that would
  materially affect an individual (e.g., decisions that would have a
  legal or similarly significant effect).
- Users should report any abuse or misuse of the product to ensure a
  safe environment for all users.
- Users must not use the Services to generate harmful or dangerous
  content that could impact others negatively.

**Services Usage Limits**

- Users must not reproduce, duplicate, copy, sell, or resell any portion
  of our Services.
- Users must adhere to any usage limits specified in their subscription
  or licensing agreement.

**Recommended Practices**

- When using the Services, especially for any use such as the
  development of a new product or commercial services, we encourage
  users to implement appropriate human review measures such as code
  reviews to ensure the accuracy and reliability of outputs generated by
  the product.
- Users should regularly review and follow best practices for data
  protection and ethical use of AI-generated content.
- Users are encouraged to provide feedback and report any issues to help
  improve the product’s safety and effectiveness
  at <support@cognition.ai> for product feedback,
  or <security@cognition.ai> to report potential security issues.

**Changes**

- We may change this AUP at any time. When we do, we will post an
  updated version at cognition.ai/pages/acceptable-use-policy, unless
  another type of notice is required by applicable laws.

## [Changelog](pages/acceptable-use-policy.html#changelog)

- 2026-01-15: Added coverage for multiple Cognition products and
  services
- 2025-11-21: Added information regarding third party acceptable use
  policies
- 2024-09-04: Published our first version of Cognition’s Acceptable Use
  Policy
