...
priority: P1
quality_grade: A
slug: singer-shape-up-basecamp-2019
subcategory: pm
tags:
- pm
title: Singer Shape Up Basecamp 2019
word_count: 34651
---
...
|Acknowledgements|10|
|Introduction|11|
|_Growing pains_|_11_|
|_Six-week cycles_|_14_|
|_Shaping the work_|_14_|
|_Making teams responsible_|_15_|
|_Targeting risk_|_15_|
|_How this book is organized_|_16_|
|Part 1: Shaping||
|Principles of Shaping|20|
|_Wireframes are too concrete_|_20_|
|_Words are too abstract_|_21_|
|_Case study: The Dot Grid Calendar_|_21_|
|_Property 1: It’s rough_|_24_|
|_Property 2: It’s solved_|_25_|
|_Property 3: It’s bounded_|_25_|
|_Who shapes_|_25_|
|_Two tracks_|_26_|
|_Steps to shaping_|_27_|
|Set Boundaries|28|
|_Setting the appetite_|_28_|
|_Fixed time, variable scope_|_29_|
|_“Good” is relative_|_30_|



|_Responding to raw ideas_|_31_|
|---|---|
|_Narrow down the problem_|_31_|
|_Case study: Defning “calendar”_|_32_|
|_Watch out for grab-bags_|_33_|
|_Boundaries in place_|_34_|
|Find the Elements|35|
|_Move at the right speed_|_35_|
|_Breadboarding_|_36_|
|_Fat marker sketches_|_41_|
|_Elements are the output_|_44_|
|_Room for designers_|_46_|
|_Not deliverable yet_|_46_|
|_No conveyor belt_|_47_|
|Risks and Rabbit Holes|48|
|_Diferent categories of risk_|_49_|
|_Look for rabbit holes_|_50_|
|_Case study: Patching a hole_|_51_|
|_Declare out of bounds_|_53_|
|_Cut back_|_54_|
|_Present to technical experts_|_54_|
|_De-risked and ready to write up_|_56_|
|Write the Pitch|57|
|_Ingredient 1. Problem_|_58_|
|_Ingredient 2. Appetite_|_59_|
|_Ingredient 3. Solution_|_60_|
|_Help them see it_|_60_|
|_Embedded Sketches_|_61_|
|_Annotated fat marker sketches_|_62_|
|_Ingredient 4. Rabbit holes_|_64_|



|_Ingredient 5. No Gos_|_64_|
|---|---|
|_Examples_|_64_|
|_Ready to present_|_67_|
|_How we do it in Basecamp_|_67_|
...
|_No backlogs_|_72_|
|_A few potential bets_|_73_|
|_Decentralized lists_|_73_|
|_Important ideas come back_|_74_|
|The Betting Table|75|
|_Six-week cycles_|_75_|
|_Cool-down_|_76_|
|_Team and project sizes_|_77_|
|_The betting table_|_77_|
|_The meaning of a bet_|_78_|
|_Uninterrupted time_|_79_|
|_The circuit breaker_|_80_|
|_What about bugs?_|_81_|
|_Keep the slate clean_|_83_|
|Place Your Bets|84|
|_Look where you are_|_84_|
|_Existing products_|_84_|
|_New products_|_84_|
|_R&D mode_|_85_|
|_Production mode_|_86_|
|_Cleanup mode_|_87_|
|_Examples_|_88_|



|_Questions to ask_|_90_|
|---|---|
|_Does the problem matter?_|_90_|
|_Is the appetite right?_|_90_|
|_Is the solution attractive?_|_91_|
|_Is this the right time?_|_92_|
|_Are the right people available?_|_92_|
|_Post the kick-of message_|_93_|
|Part 3: Building||
...
|_Assign projects, not tasks_|_96_|
|_Done means deployed_|_97_|
|_Kick-of_|_98_|
|_Getting oriented_|_100_|
|_Imagined vs discovered tasks_|_101_|
|Get One Piece Done|103|
|_Integrate one slice_|_103_|
|_Case study: Clients in projects_|_105_|
|_Programmers don’t need to wait_|_107_|
|_Afordances before pixel-perfect screens_|_107_|
|_Program just enough for the next step_|_110_|
|_Start in the middle_|_111_|
|Map The Scopes|113|
|_Organize by structure, not by person_|_113_|
|_The scope map_|_114_|
|_The language of the project_|_117_|
|_Case study: Message drafs_|_117_|
|_Discovering scopes_|_122_|



|_How to know if the scopes are right_|_123_|
|---|---|
|_Layer cakes_|_124_|
|_Icebergs_|_125_|
|_Chowder_|_126_|
|_Mark nice-to-haves with ~_|_126_|
|Show Progress|127|
|_The tasks that aren’t there_|_127_|
|_Estimates don’t show uncertainty_|_129_|
|_Work is like a hill_|_129_|
|_Scopes on the hill_|_133_|
|_Status without asking_|_134_|
|_Nobody says “I don’t know”_|_136_|
|_Prompts to refactor the scopes_|_137_|
|_Build your way uphill_|_139_|
|_Solve in the right sequence_|_139_|
|Decide When to Stop|142|
|_Compare to baseline_|_143_|
|_Limits motivate trade-ofs_|_144_|
|_Scope grows like grass_|_144_|
|_Cutting scope isn’t lowering quality_|_145_|
|_Scope hammering_|_145_|
|_QA is for the edges_|_147_|
|_When to extend a project_|_148_|
|Move On|150|
|_Let the storm pass_|_150_|
|_Stay debt-free_|_150_|
|_Feedback needs to be shaped_|_151_|



|Conclusion|152|
|---|---|
|_Key concepts_|_152_|
|_Get in touch_|_153_|
|Appendices||
|How to Implement Shape Up in Basecamp|156|
|_A Basecamp Team for shaping_|_156_|
|_Basecamp Projects for the cycle projects_|_158_|
|_To-Do Lists for scopes_|_160_|
|_Track scopes on the Hill Chart_|_161_|
|Adjust to Your Size|165|
|_Basic truths vs. specifc practices_|_165_|
|_Small enough to wing it_|_166_|
|_Big enough to specialize_|_167_|
|How to Begin to Shape Up|169|
|_Option A: One six-week experiment_|_169_|
|_Option B: Start with shaping_|_170_|
|_Option C: Start with cycles_|_170_|
|_Fix shipping frst_|_170_|
|_Focus on the end result_|_171_|
|Glossary|172|
...
veloper, you’re probably here because of some common challenges that all software companies have to face. 
...
**appetite** . Instead of asking how much time it will _take_ to do some work, we ask: How much time do we want to _spend_ ? How much is this idea worth? This is the task of shaping: narrowing down the problem and designing the outline of a solution that fits within the constraints of our appetite. 
...
# **P A R T O N E** Shaping 

**==> picture [306 x 196] intentionally omitted <==**
...
_I’ll give a wireframe to my designer, and then I’m saying to her: “I know you’re looking at this, but that’s not what I want you to design. I want you to re-think it!” It’s hard to do that when you’re giving them this concrete thing._ 

Over-specifying the design also leads to estimation errors. Counterintuitive as it may seem, the more specific the work is, the harder it can be to estimate. That’s because making the interface _just so_ can 
...
_You’re solving a problem with no context. You have to be a mind reader. It’s like: “we’ll know it when we see it.”_ 
...
C H A P T E R  2  -  P R I N C I P L E S  O F  S H A P I N G **2 1** 
...
_Rough sketch of the Dot Grid concept_ 
...
C H A P T E R  2  -  P R I N C I P L E S  O F  S H A P I N G 
...
**==> picture [306 x 267] intentionally omitted <==**

_Screenshot of the Dot Grid when it launched_ 
...
C H A P T E R  2  -  P R I N C I P L E S  O F  S H A P I N G **2 5** 
...
**==> picture [309 x 180] intentionally omitted <==**
...
C H A P T E R  3  -  S E T  B O U N D A R I E S **2 9** 
...
C H A P T E R  3  -  S E T  B O U N D A R I E S **3 1** 
...
C H A P T E R  3  -  S E T  B O U N D A R I E S **3 3** 
...
**==> picture [306 x 188] intentionally omitted <==**
...
C H A P T E R  4  -  F I N D  T H E  E L E M E N T S 
...
**==> picture [309 x 73] intentionally omitted <==**
...
**==> picture [40 x 61] intentionally omitted <==**
...
**==> picture [37 x 71] intentionally omitted <==**

**==> picture [54 x 76] intentionally omitted <==**

**==> picture [77 x 90] intentionally omitted <==**
...
**==> picture [220 x 102] intentionally omitted <==**
...
C H A P T E R  5  -  R I S K S  A N D  R A B B I T  H O L E S 
...
- Are we assuming a design solution exists that 
...
**==> picture [126 x 113] intentionally omitted <==**
...
C H A P T E R  5  -  R I S K S  A N D  R A B B I T  H O L E S **5 3** 
...
C H A P T E R  5  -  R I S K S  A N D  R A B B I T  H O L E S **5 5** 
...
C H A P T E R  6  -  W R I T E  T H E  P I T C H 
...
C H A P T E R  6  -  W R I T E  T H E  P I T C H **5 9** 
...
**==> picture [306 x 141] intentionally omitted <==**
...
## _**Annotated fat marker sketches**_ 
...
**==> picture [306 x 341] intentionally omitted <==**

_Two screenshots demonstrate the problem. Fat marker sketches describe_ 

_the solution. Rabbit holes motivated some of the sketches. See full size at basecamp.com/shapeup-todo-pitch._ 
...
**==> picture [306 x 309] intentionally omitted <==**

_Two videos show the problem. A fat marker sketch and a breadboard describe the solution. The black boxes contain data visualizations that support trade-offs in the solution. See full size at basecamp.com/shapeup-groups-pitch._ 
...
_Pitches on the Message Board of the Product Strategy team in Basecamp_ 
...
- _A pitch as a Message. Note the one-week appetite._ 

_This was a Small Batch project._ 
...
_A sketch drawn on an iPad in the middle of a pitch_ 
...
_Our CTO responds with technical thoughts on the pitch._ 
...
# **P A R T T W O** Betting 

**==> picture [324 x 188] intentionally omitted <==**
...
C H A P T E R  7  -  B E T S ,  N O T  B A C K L O G S **7 3** 
...
C H A P T E R  8  -  T H E  B E T T I N G  T A B L E 
...
C H A P T E R  8  -  T H E  B E T T I N G  T A B L E **7 7** 
...
C H A P T E R  8  -  T H E  B E T T I N G  T A B L E **7 9** 
...
There is nothing special about bugs that makes them automatically more important than everything else. The mere fact that something is a bug does not give us an excuse to interrupt ourselves or other people. All software has bugs. The question is: how severe are they? If we’re in a real crisis—data is being lost, the app is grinding to a halt, or a huge swath of customers are seeing the wrong thing—then we’ll drop everything to fix it. But _crises are rare_ . The 

C H A P T E R  8  -  T H E  B E T T I N G  T A B L E **8 1** 
...
C H A P T E R  8  -  T H E  B E T T I N G  T A B L E **8 3** 
...
C H A P T E R  9  -  P L A C E  Y O U R  B E T S 
...
C H A P T E R  9  -  P L A C E  Y O U R  B E T S **8 7** 
...
## _**An experimental feature: Hill Charts**_ 
...
C H A P T E R  9  -  P L A C E  Y O U R  B E T S **8 9** 
...
## _**Is the solution attractive?**_ 
...
C H A P T E R  9  -  P L A C E  Y O U R  B E T S **9 1** 
...
## _**Are the right people available?**_ 
...
**==> picture [307 x 129] intentionally omitted <==**

_Jason announces the bets for the next cycle with a Basecamp message_ 

C H A P T E R  9  -  P L A C E  Y O U R  B E T S **9 3** 

# **P A R T T H R E E** Building 
...
C H A P T E R  1 0  -  H A N D  O V E R  R E S P O N S I B I L I T Y 
...
**==> picture [306 x 208] intentionally omitted <==**
...
C H A P T E R  1 1  -  G E T  O N E  P I E C E  D O N E 
...
**==> picture [183 x 57] intentionally omitted <==**
...
C H A P T E R  1 1  -  G E T  O N E  P I E C E  D O N E **1 0 5** 
...
C H A P T E R  1 1  -  G E T  O N E  P I E C E  D O N E **1 0 7** 

**==> picture [306 x 157] intentionally omitted <==**

This screenshot is from a registration app for multi-day courses. The designer made it in HTML by hand. There’s barely any style 
...
**==> picture [306 x 122] intentionally omitted <==**
...
C H A P T E R  1 1  -  G E T  O N E  P I E C E  D O N E **1 1 1** 
...
**==> picture [306 x 338] intentionally omitted <==**
...
**==> picture [306 x 158] intentionally omitted <==**

After finishing the one design task, the scope was complete. 

**==> picture [306 x 153] intentionally omitted <==**
...
**==> picture [306 x 201] intentionally omitted <==**
...
**==> picture [308 x 102] intentionally omitted <==**
...
C H A P T E R  1 2  -  M A P  T H E  S C O P E S **1 2 3** 
...
**==> picture [308 x 153] intentionally omitted <==**
...
C H A P T E R  1 3  -  S H O W  P R O G R E S S 
...
**==> picture [306 x 125] intentionally omitted <==**
...
**==> picture [306 x 177] intentionally omitted <==**

Next comes the work of prepping and cooking the meal. 

**==> picture [306 x 171] intentionally omitted <==**
...
**==> picture [306 x 205] intentionally omitted <==**
...
**==> picture [306 x 350] intentionally omitted <==**
...
out, they can move independently over time. Now the team can show more progress more frequently than before. 
...
**==> picture [306 x 238] intentionally omitted <==**
...
C H A P T E R  1 4  -  D E C I D E  W H E N  T O  S T O P **1 4 3** 

**==> picture [126 x 80] intentionally omitted <==**

_Make scope cuts by comparing down to baseline instead of up to some perfect ideal_ 
...
C H A P T E R  1 4  -  D E C I D E  W H E N  T O  S T O P **1 4 5** 
...
_A finished scope with one nice-to-have (marked with a “~”)_ 

_that was never completed_ 
...
C H A P T E R  1 4  -  D E C I D E  W H E N  T O  S T O P **1 4 7** 
...
C H A P T E R  1 4  -  D E C I D E  W H E N  T O  S T O P 
...
C H A P T E R  1 5  -  M O V E  O N **1 5 1** 
...
**==> picture [306 x 225] intentionally omitted <==**

_A sketch drawn on an iPad in the middle of a pitch_ 

C H A P T E R  1 7  -  H O W  T O  I M P L E M E N T  S H A P E  U P  I N  B A S E C A M P 

**1 5 7** 

**==> picture [306 x 221] intentionally omitted <==**

_Jason announces the bets for the next cycle in the HQ_ 

- _—a Team in Basecamp that includes the whole company_ 

## Basecamp Projects for the cycle projects 

1. Create a Basecamp Project for each project in the sixweek cycle. We usually prepend a name or number for the cycle like this: “Cycle 4: Autopay.” 
...
_Adding the designer and programmer_ 

**==> picture [306 x 238] intentionally omitted <==**

_The first thing on the project is a kick-off message with the shaped concept_ 

C H A P T E R  1 7  -  H O W  T O  I M P L E M E N T  S H A P E  U P  I N  B A S E C A M P 

**1 5 9** 

**==> picture [306 x 213] intentionally omitted <==**

_The team uses the chat room in the Basecamp project_ 

_to communicate as they get started_ 
...
3. Add design _and_ programming tasks to each scope as To-Do Items. For example, “Start Autopay” has one task for design the UI and another task for wiring it to the existing recurring billing API. They can use the discussion thread on each To-Do Item to post updates or ask each other questions. 

4. Repeat as the team discovers new scopes and tasks. 

**1 6 0** 

**==> picture [306 x 254] intentionally omitted <==**

_To-Do Lists for each scope with designer and programmer tasks under each._ 

_Note: these are just the tasks discovered so far._ 
...
4. To see the history of updates to the Hill Chart, click the time- 

stamp above the Hill Chart where it says “last update.” 

**==> picture [306 x 119] intentionally omitted <==**

_Tracking a scope (To-Do List) on the Hill Chart via the options menu_ 

_on the To-Do List’s page_ 

**==> picture [306 x 250] intentionally omitted <==**

_After enabling the Hill Chart on each To-Do List, a dot appears for each scope_ 

**1 6 2** 

**==> picture [306 x 148] intentionally omitted <==**

_Drag the dots to update the Hill Chart_ 

**==> picture [306 x 249] intentionally omitted <==**

_The updated Hill Chart appears at the top of the To-Dos page_ 
...
_Clicking the timestamp at the top of the Hill Chart shows a history of updates. The most recent update is at the top._ 
...
C H A P T E R  1 8  -  A D J U S T  T O  Y O U R  S I z E **1 6 5** 
...
_The phases of the work still hold true even if you don’t work in cycles or have dedicated people to do the shaping and building_ 
...
C H A P T E R  1 8  -  A D J U S T  T O  Y O U R  S I z E **1 6 7** 
...
_With more people, shaping and building happen on separate tracks and bets are made to fill six-week cycles_ 
...
C H A P T E R  1 9  -  H O W  T O  B E G I N  T O  S H A P E  U P 
...
C H A P T E R  2 0  -  G L O S S A R Y **1 7 5** 
