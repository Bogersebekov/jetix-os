---
title: laudan-progress-and-its-problems-1977
source_pdf: laudan-progress-and-its-problems-1977.pdf
source_folder: sota
...
A-PDF Page Cut DEMO: Purchase from www.A-PDF.com to removs
...
Library of Congress Catalog Card Number: 76-245%6
...
tation of Research Traditions—Adhocness and the Evolution of
Research Traditions—Anomalies Revisted—Summary: A General
Characterization of Sciemtiie Change
...
‘5S. HISTORY AND PHILOSOPHY OF SCIENCE 155,
...
no longer possible for me to acknowledge specifically how much
my approach to science owes to each of these thinkers; but the
...
‘@ congenial atmosphere for putting to paper ideas which had
...
‘our surest exemple of sound knowledge
progresses as it does. ond we first must find out how.
In fact it does progress. 5. 40UN (1970) 9.20
Epistemology is an old subject; until about 1920, it was also a
‘great one, What produced the change was a confluence of three
...
beyond the bounds of specialized disciplinary monopolies. They
...
conclusion, and some readers will probably still think it bizarre
...
2. Attempts to show that the methods of science guarantee it
...
not probable, nor progressive, nor highly confirmed.
...
effect that science is just one set of beliefs among many possible
ones, and that we in the West venerate science, not because it is
more rational than its alternatives, but simply because we are a
...
and justify our intuitions about the cognitive well-foundedness
...
model of falsifiability as the archetype). Having observed, quite
...
pursuing the third strategy. Let us drop some of the traditional
...
In what follows, 1 shall attempt to trace out the consequences
...
detail it demands. To anticipate some of my conclusions, 1
...
view, is to adhere to a series of increasingly rational beliefs. 1
...
something by inverting the presumed dependency of progress on
rationality. 1 shall try to show that we have a clearer model for
...
clude us if we preserve the traditional relation between progress
and rationality.

Another of the chief obstacles to the development of a theory
...
merely to illustrate my philosophical claims, but also to test
them. If the model under discussion here fails to illustrate the
manner in which scientific decision making has actually worked
...
in the past were designed to solve.
...
2 ROLE OF EMPIRICAL PROBLEMS
It is the purpose of this short book to sketch what seem to be
the implications, for both the history of science and its
philosophy, of a view of scientific inquiry which perceives
science as being—above all else—a problem-solving activity.
...
philosophers of science have taken for granted.

There is nothing modest about the claims this study makes.
In brief, 1 shall be suggesting that a sophisticated theory of
...
science. I shail argue that if we take seriously the doctrine that
...
certain better known philosophies and histories of science, 1
must indicate specifically what I mean by a “problem-oriented
theory of science.” Itis this preliminary goal which this chapter
...
ail intellectual disciplines. But, if we wish to study problem
solving, we ought to begin with its most successful instances; so
J shail limit my remarks in these preliminary sections largely to
science itself.
...
@ taxonomy of the types of scientific problems, nor any
...
which, as we shall see, they sometimes generate).
...
problems are easier to illustrate than to define. We observe that
heavy bodies fall toward the earth with amazing regularity. To
ask how and why they so fall is to pose such a problem. We
...
ROLE OF EMPIRICAL PROBLEMS 1s
an empirical problem. More generally, anything about the
natural world which strikes us as odd, or otherwise in need of
explanation, constitutes an empirical problem.

In calling such inquiry situations “empirical” problems, I do
...
Why, then, call them “empirical” problems at all? | do so
...
near the earth?”, we are assuming there are objects akin to our
...
16 ROLE OF FMPIRICAL PRONLEMS
Given that similarity, one might be inclined to translate the
claims I shall make about the nature and logic of problem
...
show how meat left in the sun could transmute into maggots or
...
but which one or more of its competitors have,”
...
every theory, we must ask how many problems it has solved and
...
bby some theory in a domain they are generally only “potential”
...
genuine, Because many experimental results are difficult to
