...
origin:
  ...
  context: Упомянут как потенциальная фигура для роли офиса и бренда в рамках видения построения AI-корпорации.
icp:
  startupper: unknown
...
> федорев добрый вечер давайте идите прочую бренд делайте офис и давайте офис
