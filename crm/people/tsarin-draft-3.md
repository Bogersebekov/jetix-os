...
origin:
  ...
  context: Автор поста с аналогией 'системный подход как привычка мыть руки' — Руслан цитирует эту идею как ключевой фрейм для позиционирования Jetix.
icp:
  startupper: unknown
...
> вот привычкой культурой как в постах царина было о том что вот это вот системный подход это как привычка мыть руки реально крутое сравнение
