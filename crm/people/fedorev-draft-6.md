...
origin:
  ...
  context: Ведёт влог. Упомянут как один из ~10 ключевых людей для закрытой проработки фундамента Jetix перед запуском.
icp:
  startupper: unknown
...
> федорев влог оскар олег который troubleshooter и мастерская инженеров менеджеров
