...
origin:
  ...
  context: 'Ключевой потенциальный партнёр. Нужно проанализировать его профиль, сделать персонализированное предложение и видео. Планируется обсуждение условий: менторство, наблюдение за системой Jetix,
    вклад в стратегическое видение.'
icp:
  startupper: unknown
...
> проанализировать этого Церина, сделать ему персонализированное предложение и видео в целом посмотреть
