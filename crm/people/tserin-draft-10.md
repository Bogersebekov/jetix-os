...
origin:
  ...
  context: Упомянут как человек, с которым нужно совместно проработать майнсет на глобальный масштаб Jetix. Имя, возможно, неполное.
icp:
  startupper: unknown
...
> И с Майнсетом еще тоже надо будет очень сильно поработать. И с моим, и вот с Церина, и Анатолия Левенчука.
