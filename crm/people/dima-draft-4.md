...
origin:
  ...
  context: Первый потенциальный партнёр Jetix. Экспертиза в области настроения, самочувствия и веры в себя. Руслан планирует упаковать его как коллаборацию под брендом Jetix и совместно аутричить аудиторию.
icp:
  startupper: unknown
...
<!-- auto-suggested by /crm-add via strategy_hooks.py — edit me -->

- (none auto-suggested yet — re-run /crm-update <slug> --resync-hooks)

## §8. Что мы можем получить от него / cooperation
<!-- auto-suggested by /crm-add via strategy_hooks.py — edit me -->

- (none auto-suggested yet)
...
> одни из первых партнеров клиентов, это уже вот Диму, как мега охуенного помощника по наркоте сделать и упаковать, плюс еще этот, по поднятию вот охуенного настроения, самочувствия и так далее, вере в себя... это его вместе да это же как часть jetix это оформить
