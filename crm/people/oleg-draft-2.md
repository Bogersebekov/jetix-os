...
origin:
  ...
  context: Troubleshooter, связан с мастерской инженеров-менеджеров. Один из ~10 ключевых людей для закрытой проработки фундамента Jetix.
icp:
  startupper: unknown
...
> олег который troubleshooter и мастерская инженеров менеджеров
