...
origin:
  ...
  context: Упомянут как важный контакт — результаты предстоящего разговора с ним определяют следующие шаги Руслана.
icp:
  startupper: unknown
...
> уже будем отталкиваться от результатов разговора с Церином
