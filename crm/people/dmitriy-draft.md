...
origin:
  ...
  context: Упомянут как один из ~10 ключевых людей для закрытой проработки фундамента Jetix перед публичным запуском.
icp:
  startupper: unknown
...
> гуманитарщина дмитрий потом федорев влог оскар олег который troubleshooter и мастерская инженеров менеджеров
