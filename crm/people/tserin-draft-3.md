...
origin:
  ...
  context: Планируется серия глубоких созвонов для совместной проработки позиционирования Jetix, создания фундаментальных документов и системного описания 'кто я'. Записывать каждый созвон.
icp:
  startupper: unknown
...
> Особенно это все уже надо с Церином и с Анатолием как-то обсуждать. очень глубоко короче качественно
