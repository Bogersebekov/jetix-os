...
origin:
  ...
  context: Упомянут рядом с Анатолием Левенчуком как ключевой человек для настройки стратегии монетизации. Скорее всего ментор или партнёр (никнейм).
icp:
  startupper: unknown
...
> настроить стратегию по заработку денег и в целом вот по монетизации вот уже с царем и анатолием левенчуком
