...
slug: anatoliy-levenchuk-draft-2
type: person
aliases: []
roles:
- advisor
...
origin:
  ...
  context: Связан с мастерской менеджеров, системный подход к управлению. Планируется обсуждение позиционирования, входов/выходов системы Jetix, воронки и рекламы для мастерской. Нужно узнать про их текущую
    систему.
icp:
  startupper: unknown
...
> царину и этому анатолию левенчуку ну и получается это мастерской тоже для начала надо будет еще про ну узнать как у них там с этой блять с системой
