...
slug: anatoliy-levenchuk-draft-5
type: person
aliases: []
roles:
- advisor
...
origin:
  ...
  context: Планируется стратегическая сессия (~2 часа) по монетизации Jetix. Руслан хочет представить наработки и идеи, получить обратную связь и совместно выстроить стратегию заработка.
icp:
  startupper: unknown
...
> настроить стратегию по заработку денег и в целом вот по монетизации вот уже с царем и анатолием левенчуком вот это в первую очередь
