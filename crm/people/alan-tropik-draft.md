...
origin:
  ...
  context: Упомянут в контексте видения AI-корпорации как фигура, которую Руслан хотел бы видеть в роли ответственного за брендинг.
icp:
  startupper: unknown
...
> алан тропик надо это это потом дальше брендинг
