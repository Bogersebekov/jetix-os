...
Срез wiki по Jetix как бизнесу: клиенты, оффер, pricing, позиционирование.

## Что сюда относится
- Оффер, ценообразование, юнит-экономика
- Клиенты / потенциальные клиенты (entity)
- Процессы доставки услуги
- Конкуренты, рынок
...
### Ideas
- [[ideas/github-for-business-projects]] — платформа коллаборации с курацией + AI
- [[ideas/jetix-open-source-philosophy]] — Revenue Share + прозрачность + платформа
- [[ideas/global-vision-system-of-future]] — миссия крупнее бизнеса
- [[ideas/ai-agents-market-analysis]] — research $10.9B→$250B рынка
...
- [[concepts/collaborative-project-versioning]] — бизнес-проекты как git-репозиторий
- [[concepts/jetix-open-source-principles]] — Revenue Share + прозрачность + платформа
- [[concepts/digital-sovereignty]] — не зависеть от закрытых платформ

### Claims
- [[claims/business-projects-like-code]] — принципы git применимы к бизнес-проектам
