---
title: Звонок с Дмитрием (Гуманитарщина) — call prep + narrative 1.5 года + Toggl stats + 2 mermaid
date: 2026-05-16
type: call-prep
status: ready-to-use
target: Дмитрий (Гуманитарщина)
duration_target: 30-60 мин
language: russian
companion_files:
  - reports/anton-call-report-2026-05-11.md (deeper 2-month narrative)
  - reports/timeline-narrative-2025-07_to_2026-05.md (full 10-month phases)
  - reports/toggl_last6months_2025-11_to_2026-05.md (6-month Toggl objective stats)
  - reports/toggl_historical_baseline_2024-04_to_2026-05.md (2-year baseline)
  - decisions/JETIX-DOCUMENT-MAP-2026-05-15.md (карта местности)
F: F2
G: dmitry-call-applied-now
R: refuted_if_call_diverges_significantly_OR_no_response
---
...
gantt
    ...
    section Фаза 1 — Ответственность / инфобизнес
    Новый год / ответственность       :milestone, 2025-01-01, 1d
    Инфобизнес + сборка команды        :2025-01-15, 2025-05-01
    20h Miro стратегия (изобретатель)  :crit, 2025-04-01, 2025-05-15
    Lead gen $5-8K/мес                 :2025-05-01, 2025-08-17

    section Фаза 2 — Кризис + Антон + values
    Потеря смысла + Камю Сизиф         :crit, 2025-08-18, 2025-09-22
    Нашёл Антона                       :milestone, 2025-10-01, 1d
    200h работы с Антоном              :2025-10-01, 2026-03-11
    Values discovery + Sapiens         :2025-12-01, 2026-01-01
    Crash через каннабис (5 недель)    :crit, 2026-01-01, 2026-02-01
    Recovery + AI discovery            :milestone, 2026-02-15, 1d

    section Фаза 3 — Хорошее состояние + Build
    Claude Code открытие               :milestone, 2026-02-15, 1d
    Active build Jetix OS              :2026-03-11, 2026-05-16
    Foundation v1.0 LOCKED             :milestone, 2026-04-28, 1d
    Doc 1A + 1B LOCKED                 :milestone, 2026-05-05, 1d
    Heptagon (7 insights) LOCKED       :milestone, 2026-05-12, 1d
    Charter v0 LOCKED                  :milestone, 2026-05-12, 1d
    Monetization bank 166 H            :2026-05-14, 2026-05-15
    Первые видео L1 outreach           :milestone, 2026-05-15, 1d
    Звонок Дмитрию                     :milestone, 2026-05-16, 1d
```
...
flowchart TB
    ...
    Foundation[Foundation v1.0<br/>11 Parts + Pillar A/B/C<br/>12 hard rules<br/>LOCKED 28.04]

    subgraph Heptagon[Heptagon — 7 Strategic Insights LOCKED 10-12.05]
        H1[Foundation Model]
        H2[Partnership Model]
        H3[R&D Flywheel]
        H4[Network State Balaji]
        H5[Tyson Mentorship]
        H6[Gamified Platform]
        H7[People-Network-State ⭐]
    end

    Charter[Charter v0 LOCKED 12.05<br/>14 секций + R12 Anti-Extraction]

    subgraph Operations[Операционная инфраструктура]
        Wiki[Wiki v2 — 722+ entries / 891+ edges]
        VoicePipe[Voice pipeline canonical]
        AutoR[AutoResearch — Karpathy pattern]
        Mermaid[Mermaid стек]
        CRM[CRM system — 24 roles / 6 groups]
    end

    subgraph Research[Research depth]
        Monetization[Monetization bank<br/>166 H + 75 test designs]
        PeopleNS[People-NS deep research]
        GameTheory[Game Theory research]
        L1Profiles[9 L1 First Clan profiles]
    end

    subgraph Outreach[Outreach Phase 1 — где я сейчас]
        DocMap[DOCUMENT-MAP — карта местности]
        VideoTseren[Видео-знакомство Цэрэна 15.05]
        DocPool[Document pool + per-L1 sequence]
        DmitryCall[Звонок Дмитрию 16.05 ⭐]
    end
    ...
    style Foundation fill:#1a3a5c,color:#fff,stroke:#333,stroke-width:3px
    style Heptagon fill:#e07b00,color:#fff
    style Charter fill:#6b3fa0,color:#fff
    style Outreach fill:#a0a020,color:#fff
    style Research fill:#3a7aa0,color:#fff
    style DmitryCall fill:#a04a4a,color:#fff,stroke:#fff,stroke-width:2px
```
