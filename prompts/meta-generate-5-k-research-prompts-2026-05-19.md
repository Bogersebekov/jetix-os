---
type: meta-prompt-generate-prompts
date: 2026-05-19 afternoon
session: meta-generate-5-k-research-prompts-2026-05-19
status: AWAITING-RUSLAN-LAUNCH
parent_pattern: prompts/meta-generate-5-deep-research-prompts-2026-05-18.md (gold meta-pattern)
gold_standard_prompt: prompts/ml-ai-engineers-deep-research-2026-05-18.md
existing_deep_research_prompts_reference:
...
estimated_duration: 30-45 min meta-generation
estimated_cost: <€1.50
constitutional_posture: R1 + R2 + R6 + R11 + R12 + IP-1 + EP-5 + append-only + FPF-lens-FIRST + breadth-NOT-selection
...
```mermaid
gantt
    title 5 K-research dispatch sequence (~3 weeks)
    ...
    section Post-K
    C.1 One-pager drafting              :milestone, c1, after k2, 0d
    Aggregate sprint-synthesis-v2       :milestone, agg, after k5, 0d
    C.2 Pitch deck v1 drafting          :milestone, c2, after k2, 0d
```
```
