...
- audio_673@17-05-2026_19-49-05.ogg (последний)
...
### §2.1 Stage 1 — Transcribe (deterministic)
...
### §2.2 Stage 2 — Extract (FPF-lens dispatch)
**Brigadier swarm dispatch** (3 cells параллельно на каждый transcript):
...
Cell drafts: `swarm/wiki/drafts/task-voice-pipeline-2026-05-17-*-audio_NNN.md`
