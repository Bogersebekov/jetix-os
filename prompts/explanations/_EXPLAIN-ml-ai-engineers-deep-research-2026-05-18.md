...
session: Cloud Cowork — ML/AI engineers deep research planning
sibling_prompt: prompts/ml-ai-engineers-deep-research-2026-05-18.md
status: AWAITING-RUSLAN-ACK (Ruslan reviews this → ack → Ruslan launches server CC)
parent_pattern: research/deepening-2026-05-18/ (mirror 14-direction structure with FPF-lens-first discipline)
trigger: Ruslan-shared 2 infographics (Стек ML / Чем занимается ML-инженер) — 2026-05-18 evening
output_namespace: research/ml-ai-engineers-2026-05-18/
constitutional_posture: R1 + R6 + R11 + EP-5 + breadth-research-NOT-selection + FPF-lens-first
estimated_duration: 120-180 min server CC run
estimated_cost: <€3.50 (text generation + WebFetch/WebSearch для tool docs + influencer profiles)
parallel_run: text-008-009-hackathon-integration-2026-05-18 (different namespace, no conflict)
---
...
graph TB
    subgraph "INPUT"
        ...
        I2[text_008+009 Master Workshop<br/>Engineers aspiration]
        I3[research/deepening 09 Karpathy<br/>existing profile]
        I4[research/hackathon-deep<br/>engineer-masterskaya hypothesis]
        I5[research/harari Workshop=4Cs]
        I6[Canonical baselines<br/>vision Workshop Octagon Phase 0]
        I7[External web fetches<br/>tool docs + influencers]
    end

    subgraph "PROCESSING (8 phases)"
        P0[Phase 0: FPF lens scope<br/>WHAT we research]
        P1[Phase 1: Industry mapping<br/>+ mental models]
        P2[Phase 2: Tools deep dive<br/>21 tools × 3 layers]
        P3[Phase 3: 7-step workflow<br/>FPF + universal]
        P4[Phase 4: Engineering pattern<br/>universal pattern]
        P5[Phase 5: Target portrait<br/>5 Jetix classes]
        P6[Phase 6: Hypotheses bank<br/>breadth NOT selection]
        P7[Phase 7: Cross-cutting + summary]
        P8[Phase 8: Commit + push]
    end
    ...
    subgraph "OUTPUT"
        ...
        O4[Hypothesis bank 30-50 H]
        O5[Engineering pattern artefact]
        O6[Target portrait 5-class graph]
    end
    ...
    style O3 fill:#d6f0d6
    style P0 fill:#ffd6f0
```
