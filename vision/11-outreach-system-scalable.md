---
title: Outreach System Scalable — 10-person video → 100 trained → personalized
date: 2026-05-18
type: vision-theme
...
parents:
  - raw/voice-memos-2026-05-17-batch/text_009@2026-05-18_evening.md (Thread 5 + 13 + 14)
  - decisions/strategic/JETIX-OUTREACH-SYSTEM-SCALABLE-2026-05-18.md (concept doc D)
  - vision/08-l1-collaboration-roadmap.md
constitutional_posture: R1 surface + R6 + R11 + R12 anti-extraction + EP-5
F: F2
G: vision-outreach-system-scalable
R: refuted_if_10-person_team_not_assembled_within_60d_OR_personalized_scale_fails_at_100
...
graph LR
    subgraph "Stage 1 (60 days) — 10-person video team"
        ...
        T2[Copywriters x2]
        T3[On-screen Talent x2]
        T4[Researchers x2]
        T5[CRM Operators x2]
    end
    
    subgraph "Stage 2 (Q4 2026) — 100 trained operators"
        OP1[10-team Trains Cohort]
        OP2[TPS Mentor Pairing]
        OP3[Per-target Specialization]
        OP4[100 Operators Active]
    end
    
    subgraph "Stage 3 (Q1 2027+) — Personalized scale"
        PS1[~30 targets/operator/month]
        PS2[36K personalized engagements/year]
        PS3[CRM Pipeline Tracking]
        PS4[Cohort Entry Subset]
    end
    
    subgraph "Target Classes"
        TG1[L1 Key-person ~10-20]
        TG2[Master Workshop ~50-200]
        TG3[3000 миллиардеров]
        TG4[Миллионеры ~10M+]
        TG5[Разрабы/инженеры ~10M+]
        TG6[Платформы ~1K-10K]
    end
    
    subgraph "Constitutional Guards"
        G1[R12 Anti-extraction]
        G2[R1 Ruslan = primary L1 author]
        G3[AP-6 Dissent Preservation]
        G4[Phil Critic Filter Bias Mitigation]
    end
    ...
    style TG1 fill:#ffd6a6
    style TG2 fill:#ffd6a6
    style G1 fill:#ffd6d6
    style G2 fill:#ffd6d6
    style G3 fill:#ffd6d6
    style G4 fill:#ffd6d6
```
