---
title: Jetix as Methodology — FPF-Described (Doc 02)
date: 2026-05-17
...
parents:
  ...
  - reports/phase-0-fpf-scope/01-jetix-objects-inventory.md (O-05 entry)
  - reports/phase-0-fpf-scope/00-JETIX-FPF-MASTER-2026-05-17.md
  - vision/00-MASTER-VISION-PLAN-2026-05-17.md §0 + §1 (text_002 + audio_672/673)
  - decisions/JETIX-FIRST-CLAN-CHARTER-2026-05-12.md §1.0a + §11
  - decisions/STRATEGIC-INSIGHT-JETIX-TRUST-INFRASTRUCTURE-2026-05-17.md §3
  - vision/jetix-fpf-describe/01-jetix-as-self-os-substrate.md (sibling)
F: F2
F_rationale: |
  Floor F2 = O-05 «Methodology» org-reality aspirational (0 forkers; no distributable format).
  Per phil-critic D-DOC02-PHIL-1: «universal language» claim downgraded F4→F3 (audio_673
  itself hedges «в какой-то степени»). Per-claim F2-F5 in §2.
G: jetix-fpf-describe-methodology
R: refuted_if_FPF_universal_language_claim_dropped_by_Ruslan_OR_Fork_guide_v0_rejected_OR_O05_reclassified_as_not_methodology
cells_dispatched:
  - engineering-expert × integrator (draft)
  - philosophy-expert × critic (review)
  - engineering-expert × critic (review)
dissents_preserved: 9
mandatory_disclosures:
  - EP-5: «Jetix F8 / LOCKED» в этом документе = single-author Ruslan ack grade, NOT FPF B.3 F8
  - EP-2: O-05 described as artefact (mention); org reality = aspirational; 0 forkers
  - LIVE-FLAG B2: Aisystant subscription blocked — IWE comparisons scoped to public template v0.31.0 only
live_flags:
  - B2: IWE paid guide (Aisystant) BLOCKED
  - O-05-status: Fork guide v0 = aspirational; 0 forkers as of 2026-05-17
language: russian (narrative) + english (FPF primitives)
doc_series_position: "02 of 07 — Jetix as Methodology"
---
...
flowchart TB
    ...
    subgraph EPISTEME["U.Episteme (A.16) — Methodology as artefact"]
        ...
        ONTOSUBSTRATE["<b>ШСМ/МИМ overlay</b><br/><i>планируемый онтологический субстрат<br/>F2 aspirational — не FPF-typed<br/>OQ-D02-2 pending Ruslan ack</i>"]:::ontoplanned
        MD --> ONTOSUBSTRATE
    end
    ...
    subgraph WORKPLAN["U.WorkPlan-PROTO (A.15.2 candidate)"]
        ...
        WP_FORKER["Forker occurrence<br/>Fork guide v0 = aspirational<br/>0 forkers confirmed<br/>2 of 5 A.15.2 fields satisfied"]:::wpaspirate
    end
    ...
    subgraph DISTRIBUTION["Fork-and-Leave (R12 constitutional)"]
        ...
        R12["<b>R12 Anti-extraction</b><br/>Fork без penalty<br/>retain knowledge + reputation<br/>constitutional guarantee"]:::r12
        FORKER1 --- R12
        FORKER2 --- R12
    end

    subgraph EXPLORATION["B.5.1 Exploration state"]
        EXP["Hypothesis: forkable sector-agnostically<br/><b>Status:</b> 0 forkers / F2 aspirational"]:::explore
    end
    ...
    CROSS03["→ Doc 03<br/>FPF-роли как mutual-instrumentation<br/>primitives (text_004 PRIMARY)"]:::crosslink
