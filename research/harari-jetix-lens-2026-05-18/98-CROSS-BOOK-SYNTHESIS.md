---
title: Cross-book synthesis — Harari corpus 2011→2026 trajectory + Jetix integration matrix
date: 2026-05-18
type: cross-book-synthesis
parent_prompt: prompts/harari-through-jetix-lens-2026-05-18.md
brigadier_phase: 3
constitutional_posture: R1 surface-only + R6 provenance per claim + AP-6 dissent preserved + EP-5 disclosed (F3)
F: F3
G: harari-cross-synthesis-2026-05-18
R: refuted_if_per-book_docs_extract_contradicts_synthesis_pattern OR Jetix_integration_recommendation_overreaches_R1_surface_discipline
themes_covered:
  - "#shared-myths-cooperation"
  ...
  - "#AI-alignment-democracy"
parents:
  - research/harari-jetix-lens-2026-05-18/01-sapiens-jetix-lens.md
  - research/harari-jetix-lens-2026-05-18/02-homo-deus-jetix-lens.md
  - research/harari-jetix-lens-2026-05-18/03-21-lessons-jetix-lens.md
  - research/harari-jetix-lens-2026-05-18/04-nexus-jetix-lens.md
  - research/harari-jetix-lens-2026-05-18/05-sapienship-publications-lens.md
...
graph LR
    ...
    HD[Homo Deus 2016<br/>Dataism warning<br/>useless class]
    L21[21 Lessons 2018<br/>4 Cs + meaning + post-truth]
    NEX[Nexus 2024<br/>3 theories of info<br/>self-correcting]
    SAPS[Sapienship 2026<br/>AI agents policy]

    %% Jetix Octagon
    H1[H1 Foundation Model]
    H2[H2 Partnership Model]
    H3[H3 Tyson Mentorship]
    H4[H4 Balaji Network State]
    H5[H5 Gamified Platform]
    H6[H6 People-NS Heptagon]
    H7[H7 People-NS Heptagon]
    H8[H8 Trust Infrastructure]

    %% Mappings
    SAP -->|shared myths substrate| H1
    SAP -->|cooperation at scale| H6
    SAP -->|cooperation at scale| H7
    SAP -->|inter-subjective reality| H8

    HD -->|datism architectural rejection| H1
    HD -->|useless class counter| H5
    HD -->|dataism warning extension| H8

    L21 -->|4 Cs education| H3
    L21 -->|trustworthy platform| H8
    L21 -->|post-truth literacy| H8
    L21 -->|community decline counter| H7

    NEX -->|3 theories of info / F-G-R| H1
    NEX -->|self-correcting mechanisms| H1
    NEX -->|mythology + bureaucracy| H8
    NEX -->|outlaw fake humans| H8

    SAPS -->|reject AI legal personhood| H1
    SAPS -->|AI agent 3-feature framework| H8
    SAPS -->|outlaw bots| H8

    %% Style
    classDef harari fill:#fef3c7,stroke:#92400e
    classDef octagon fill:#dbeafe,stroke:#1e40af
    class SAP,HD,L21,NEX,SAPS harari
    class H1,H2,H3,H4,H5,H6,H7,H8 octagon
```
