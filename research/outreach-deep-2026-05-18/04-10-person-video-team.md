...
parents:
  - prompts/outreach-system-scalable-deep-research-2026-05-18.md §5 (Phase 3 spec)
  - decisions/strategic/JETIX-OUTREACH-SYSTEM-SCALABLE-2026-05-18.md §3.1 (10-team baseline)
  - 02-cross-precedent-deep-6.md (Sahil augmented-solo + Levels solo discipline + GitHub DevRel role template)
  - 03-6-resources-framework.md (List D synthesised default)
cells_dispatched: mgmt × integrator + eng × scalability
F: F2
G: outreach-deep-2026-05-18-10-team
R: refuted_if_(team assembly fails 60-day OR role boundaries collapse OR R12 compensation extraction emerges)
...
gantt
  ...
  axisFormat %b-%d
  section Recruitment
  Source channels & vetting    :a1, 2026-06-01, 14d
  Final offers + onboarding    :a2, after a1, 7d
  section Onboarding
  Tooling + orientation        :b1, 2026-06-15, 7d
  Trial production round 1     :b2, after b1, 14d
  section Production
  First 10 templates           :c1, 2026-07-06, 7d
  Scale to 25-50/week          :c2, after c1, 14d
  Target 50-100 templates      :c3, after c2, 14d
  section Phase 2 prep
  Train first 10 trainees      :d1, 2026-07-25, 7d
```
...
flowchart TB
  ...
  C -->|script| T[On-screen Talent]
  T -->|raw footage| V
  V -->|final video| O[CRM Operator]
  O -->|target queue| R
  O -->|status digest| L[10-team lead → Ruslan]
  L -->|priority signal| O
