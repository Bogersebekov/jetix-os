---
type: research-phase-4
phase: 4
session: outreach-system-scalable-deep-research-2026-05-18
date: 2026-05-18 evening
parents:
  - prompts/outreach-system-scalable-deep-research-2026-05-18.md §6 (Phase 4 spec)
  - decisions/strategic/JETIX-OUTREACH-SYSTEM-SCALABLE-2026-05-18.md §3.2 (100-trained baseline)
  - research/deepening-2026-05-18/14-tacit-explicit-tps-mechanism.md (TPS mentor-pairing)
  - decisions/strategic/JETIX-EDUCATION-LAYER-SYSTEM-THINKING-2026-05-18.md (Education Layer 4-tier ref)
  - 04-10-person-video-team.md (training substrate)
cells_dispatched: mgmt × integrator + phil × critic
F: F2
G: outreach-deep-2026-05-18-100-trained
R: refuted_if_(100-cohort fails 12mo OR TPS pairing collapses OR R12 extraction emerges in compensation OR paternalism in curriculum imposition)
...
gantt
  ...
  axisFormat %b-%y
  section Cohort 1 (Wave 1, ~20 trainees)
  Tier 1 Foundation     :2026-07-01, 60d
  Tier 2 Methodology    :2026-09-01, 60d
  Tier 3 Specialisation :2026-11-01, 90d
  Tier 4 Mentorship     :2027-02-01, 150d
  section Cohort 2 (Wave 2, ~30 trainees)
  Tier 1                :2026-10-01, 60d
  Tier 2                :2026-12-01, 60d
  Tier 3                :2027-02-01, 90d
  Tier 4                :2027-05-01, 150d
  section Cohort 3 (Wave 3, ~50 trainees)
  Tier 1                :2027-01-01, 60d
  Tier 2                :2027-03-01, 60d
  Tier 3                :2027-05-01, 90d
  Tier 4                :2027-08-01, 150d
  section Milestones
  10-team complete      :milestone, 2026-08-01, 0d
  First 30 graduated    :milestone, 2027-03-01, 0d
  100 graduated         :milestone, 2027-07-01, 0d
```
...
flowchart TB
  ...
  T3 --> T4[Tier 4 Mentorship<br/>TPS pairing + compound<br/>~150d]

  T1 -.opt-out preserved.-> X[Exit no penalty]
  T2 -.opt-out preserved.-> X
  T3 -.opt-out preserved.-> X
  T4 -.opt-out preserved.-> X

  T4 --> M1[Mentor next cohort]
  T4 --> M2[10-team lateral move]
  T4 --> M3[Workshop apprentice]
  T4 --> M4[Master Workshop track]

  style T1 fill:#fff4e6
  style X fill:#ffd6d6
  style M4 fill:#d6f0d6
```
