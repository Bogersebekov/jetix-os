---
title: Diagram 03 — Platform comparison quadrant (8 dimensions)
date: 2026-05-18
type: standalone-mermaid
parent: research/hackathon-deep-2026-05-18/04-inventory.md §2
---
...
quadrantChart
    ...
    y-axis "Low R12 alignment" --> "High R12 alignment"
    quadrant-1 "Depth + High R12<br/>Jetix HIGH FIT"
    quadrant-2 "Volume + High R12<br/>Jetix MEDIUM FIT"
    quadrant-3 "Volume + Low R12<br/>Jetix LOW FIT"
    quadrant-4 "Depth + Low R12<br/>Jetix MEDIUM FIT"
    "g0v.tw / vTaiwan": [0.85, 0.95]
    "AI Grant / NFDG": [0.95, 0.55]
    "ETHGlobal": [0.7, 0.75]
    "Lablab.ai": [0.55, 0.65]
    "Devfolio ETHIndia Villa": [0.75, 0.7]
    "ETHDenver": [0.55, 0.65]
    "MLH": [0.3, 0.6]
    "Devfolio general": [0.4, 0.55]
    "AngelHack": [0.4, 0.4]
    "HackerEarth": [0.3, 0.25]
    "Hackathon.com corporate": [0.35, 0.2]
```
