---
title: Direction 05 — Alexander → Cunningham → Karpathy 50-year lineage (cross-domain transfer)
date: 2026-05-18
...
direction_priority: 2 (high — Master Index §3.1.1 strongest single adjacency)
cross_refs:
  - research/adjacent-ideas-2026-05-17/07-methodology-distribution.md §1.2
  - research/adjacent-ideas-2026-05-17/02-intelligence-as-tool.md §1.1
  - research/adjacent-ideas-2026-05-17/00-MASTER-RESEARCH-INDEX.md §3.1
  - CLAUDE.md «Wiki Architecture v2 (Karpathy LLM Wiki + OmegaWiki)»
constitutional_posture: R1 + R6 + EP-5 disclosed
F: F4
G: alexander-cunningham-karpathy-lineage
R: refuted_if_lineage_continuity_disproven_OR_if_transfer_mechanism_not_replicable_for_FPF
...
timeline
  ...
  1987 : OOPSLA Beck+Cunningham — pattern concept → software (referenced)
  1994 : Design Patterns GoF — 23 patterns, software, 500K+ copies
  1995-03-25 : WikiWikiWeb launches — Cunningham, Portland Pattern Repository
  2001 : Wikipedia — wiki concept generalized
  2015-02-01 : WikiWikiWeb read-only (vandalism)
  2026-04 : Karpathy LLM Wiki Gist — wiki as LLM-living substrate
  2026-04+ : Jetix wiki/ adopts Karpathy++ pattern
```
...
graph LR
  ...
  S3 --> S4[Operationally useful artifact in D2]
  S4 --> S5[Community curates + compounds 5-50 years]

  style S1 fill:#dbeafe,color:#1a202c
  style S2 fill:#fef3c7,color:#1a202c
  style S3 fill:#fef3c7,color:#1a202c
  style S4 fill:#bbf7d0,color:#1a202c
  style S5 fill:#bbf7d0,color:#1a202c
```
