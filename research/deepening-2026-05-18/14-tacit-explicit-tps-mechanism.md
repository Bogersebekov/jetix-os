---
title: Direction 14 — Toyota Production System tacit→explicit transfer mechanism
date: 2026-05-18
...
direction_priority: 14 (medium — Workshop curriculum + mastery transfer)
cross_refs:
  - research/adjacent-ideas-2026-05-17/07-methodology-distribution.md §1.3
  - research/adjacent-ideas-2026-05-17/04-engineering-methodologist-communities.md §1.4
  - research/deepening-2026-05-18/06-success-mondragon-68yr-mechanism.md (cooperative training parallel)
  - vision/jetix-fpf-describe/03-* Workshop / Мастерская (parallel run — NOT touched)
constitutional_posture: R1 + R6 + EP-5 disclosed
F: F3
G: tps-tacit-explicit-mechanism
R: refuted_if_tacit_explicit_pattern_not_applicable_to_FPF_OR_if_Workshop_pattern_disproven
...
graph TD
  ...
  T3 --> T4[Layer 4: Six Sigma fusion + Lean consulting]

  T1 -.tacit knowledge.- T1m[Toyota internal Senseis]
  T2 -.partial extraction.- T2m[Concept brand + research]
  T3 -.codification.- T3m[14 Principles in book]
  T4 -.commoditization.- T4m[Lean consultants + certifications]

  T1m -.lossy transfer.- T2m
  T2m -.lossy transfer.- T3m
  T3m -.lossy transfer.- T4m

  style T1 fill:#bbf7d0,color:#1a202c
  style T2 fill:#fef3c7,color:#1a202c
  style T3 fill:#fef3c7,color:#1a202c
  style T4 fill:#fecaca,color:#1a202c
  style T1m fill:#dbeafe,color:#1a202c
  style T2m fill:#dbeafe,color:#1a202c
  style T3m fill:#dbeafe,color:#1a202c
  style T4m fill:#dbeafe,color:#1a202c
```
