---
title: Direction 10 — Buterin d/acc trajectory (Nov 2023 + Jan 2025 retro) + m/acc positioning hook
date: 2026-05-18
...
direction_priority: 7 (high — m/acc positioning input)
cross_refs:
  - research/adjacent-ideas-2026-05-17/06-virtual-tribes.md §1.1
  - research/adjacent-ideas-2026-05-17/05-trust-beyond-money.md §1.3
  - swarm/wiki/foundations/principles/architecture.md (Pillar C Corrigibility + R12)
  - decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md (FUNDAMENTAL §4.3 Corrigibility)
constitutional_posture: R1 + R6 + EP-5 disclosed
F: F4
G: buterin-dacc-trajectory-macc-hook
R: refuted_if_dacc_retro_misquoted_OR_if_macc_framing_disproven_irrelevant
...
timeline
  ...
  2023-11 : Buterin "My techno-optimism" — d/acc coined
  2023-11 to 2024 : d/aDDy + Devcon — community formation
  2024 : ZK-SNARKs in government IDs deployed
  2024 : Open-source vaccines + Community Notes adoption
  2025-01-05 : Buterin "d/acc one year later" retrospective
  2025+ : Continued maturation; cross-sector practitioner awareness
```
