---
title: Direction 06 — Mondragón 68-year mechanism (R12 + governance proof)
date: 2026-05-18
type: deepening-success-mechanism
status: brigadier-research-surface (R1)
parent: research/deepening-2026-05-18/00-DEEPENING-PLAN.md
direction_priority: medium-high (R12 + H8 long-run substrate evidence)
cross_refs:
  - research/adjacent-ideas-2026-05-17/05-trust-beyond-money.md §1.5
  - swarm/wiki/foundations/principles/architecture.md (Pillar C R12 anti-extraction)
  - decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md (R12 = «no extraction beyond agreed share»)
  - swarm/awaiting-approval/r12-anti-extraction-2026-05-12.md (R12 packet)
constitutional_posture: R1 + R6 + EP-5 disclosed
F: F4
G: mondragon-68yr-r12-evidence
R: refuted_if_governance_mechanisms_inapplicable_to_FPF_OR_if_R12_anti_extraction_disproven_at_scale_by_Mondragon_critiques
...
graph TD
  ...
  M3[One worker one vote] -.maps to.- J3[Pillar C Tier 2 + Corrigibility]
  M4[Mondragón University + 12 tech centers] -.maps to.- J4[Workshop + Train-The-Trainer pattern]
  M5[Caja Laboral 1959] -.maps to.- J5[Internal capital allocation Phase 2-3]
  M6[Cooperative Congress majority rule] -.maps to.- J6[H8 governance protocol]
  M7[Departure tolerance Dec 2022] -.maps to.- J7[R12 fork-and-leave]
  M8[Catholic humanism] -.maps to.- J8[Pillar C Tier 1 manager principles]

  style M1 fill:#dbeafe,color:#1a202c
  style M2 fill:#dbeafe,color:#1a202c
  style M3 fill:#dbeafe,color:#1a202c
  style M4 fill:#dbeafe,color:#1a202c
  style M5 fill:#dbeafe,color:#1a202c
  style M6 fill:#dbeafe,color:#1a202c
  style M7 fill:#dbeafe,color:#1a202c
  style M8 fill:#dbeafe,color:#1a202c
  style J1 fill:#bbf7d0,color:#1a202c
  style J2 fill:#bbf7d0,color:#1a202c
  style J3 fill:#bbf7d0,color:#1a202c
  style J4 fill:#bbf7d0,color:#1a202c
  style J5 fill:#bbf7d0,color:#1a202c
  style J6 fill:#bbf7d0,color:#1a202c
  style J7 fill:#bbf7d0,color:#1a202c
  style J8 fill:#bbf7d0,color:#1a202c
```
