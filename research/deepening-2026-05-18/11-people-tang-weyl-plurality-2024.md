---
title: Direction 11 — Tang + Weyl «Plurality» 2024 book deep profile
date: 2026-05-18
type: deepening-people-profile
status: brigadier-research-surface (R1)
parent: research/deepening-2026-05-18/00-DEEPENING-PLAN.md
direction_priority: 11 (medium — H4 + H7 + H8 cross-cluster overlap)
cross_refs:
  - research/adjacent-ideas-2026-05-17/05-trust-beyond-money.md §1.4
  - research/adjacent-ideas-2026-05-17/06-virtual-tribes.md
  - research/adjacent-ideas-2026-05-17/08-interesting-people-list.md (Top-12 #5 #10)
  - decisions/STRATEGIC-INSIGHT-H4-* (H4 Network State direction)
  - decisions/STRATEGIC-INSIGHT-H8-* (H8 Trust Infrastructure LOCKED)
constitutional_posture: R1 + R6 + EP-5 disclosed — NO outreach without Ruslan ack
F: F3
G: tang-weyl-plurality-book
R: refuted_if_Plurality_thesis_unrelated_to_Jetix_H_clusters_OR_if_open_source_book_facts_disproven
...
graph TD
  ...
  P --> P3[Community 12+ language translation]

  P1 --> T1[vTaiwan platform]
  P1 --> T2[Pol.is deliberation tool]
  P1 --> T3[Quadratic mechanisms in govt]

  P2 --> W1[Quadratic Voting RxC]
  P2 --> W2[SBT paper 2022 co-author]
  P2 --> W3[Plurality Institute MSR]

  P3 --> C1[GitHub pluralitybook/plurality]
  P3 --> C2[CC0 public domain]
  P3 --> C3[Open-source self-governed model]

  style P fill:#dbeafe,color:#1a202c
  style P1 fill:#fef3c7,color:#1a202c
  style P2 fill:#fef3c7,color:#1a202c
  style P3 fill:#fef3c7,color:#1a202c
  style T1 fill:#bbf7d0,color:#1a202c
  style T2 fill:#bbf7d0,color:#1a202c
  style T3 fill:#bbf7d0,color:#1a202c
  style W1 fill:#bbf7d0,color:#1a202c
  style W2 fill:#bbf7d0,color:#1a202c
  style W3 fill:#bbf7d0,color:#1a202c
  style C1 fill:#bbf7d0,color:#1a202c
  style C2 fill:#bbf7d0,color:#1a202c
  style C3 fill:#bbf7d0,color:#1a202c
```
