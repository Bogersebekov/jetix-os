---
title: Direction 09 — Andrej Karpathy + Eureka Labs + LLM101n deep profile
date: 2026-05-18
...
direction_priority: 9 (medium — direct ancestor wiki/ substrate)
cross_refs:
  - research/adjacent-ideas-2026-05-17/02-intelligence-as-tool.md §1.1
  - research/adjacent-ideas-2026-05-17/07-methodology-distribution.md §1.5
  - research/adjacent-ideas-2026-05-17/08-interesting-people-list.md (Top-12 #1 priority)
  - CLAUDE.md «Wiki Architecture v2 (Karpathy LLM Wiki + OmegaWiki)»
  - research/deepening-2026-05-18/05-success-alexander-cunningham-karpathy-lineage.md
constitutional_posture: R1 + R6 + EP-5 disclosed — NO outreach without Ruslan ack
F: F4
G: karpathy-eureka-llm101n-deep
R: refuted_if_Eureka_LLM101n_facts_disproven_OR_if_outreach_discipline_breached
...
graph TB
  ...
  K --> C[LLM Wiki Gist April 2026]

  A --> J1[Jetix Workshop AI-native infrastructure inspiration]
  B --> J2[Workshop hands-on cohort+self-paced — direct precedent]
  C --> J3[Jetix wiki/ substrate direct adoption]

  J1 --> JJ[Jetix Foundation Architecture]
  J2 --> JJ
  J3 --> JJ

  K -.future-collab.- JJ

  style K fill:#dbeafe,color:#1a202c
  style A fill:#fef3c7,color:#1a202c
  style B fill:#fef3c7,color:#1a202c
  style C fill:#fef3c7,color:#1a202c
  style J1 fill:#bbf7d0,color:#1a202c
  style J2 fill:#bbf7d0,color:#1a202c
  style J3 fill:#bbf7d0,color:#1a202c
  style JJ fill:#bbf7d0,color:#1a202c
```
