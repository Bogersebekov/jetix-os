---
title: Direction 04 — Engelbart H-LAM/T deep mapping → FPF primitives
date: 2026-05-18
...
direction_priority: 3 (high — Foundation-anchor reference candidate)
cross_refs:
  - research/adjacent-ideas-2026-05-17/02-intelligence-as-tool.md §1.1
  - research/adjacent-ideas-2026-05-17/09-jetix-positioning-sharpened.md §5
  - design/JETIX-FPF.md (FPF Constitutional Spec; A.6.B + B.3 F-G-R)
  - swarm/wiki/foundations/part-4-role-taxonomy-coordination-protocol/architecture.md
  - vision/jetix-fpf-describe/* (parallel run — NOT touched)
constitutional_posture: R1 + R6 + EP-5 disclosed
F: F4
G: engelbart-h-lam-t-fpf-mapping
R: refuted_if_4-tuple_mapping_disproven_OR_if_co-evolution_thesis_unrelated_to_FPF
...
graph TD
  ...
  H --> M[Methodology: cross-domain engineering FPF]
  H --> T[Training: Workshop + Train-Trainer]
  H --> N[Network: multi-Clan + role-attestation H8]
  ...
  style H fill:#dbeafe,color:#1a202c
  style A fill:#bbf7d0,color:#1a202c
  style L fill:#bbf7d0,color:#1a202c
  style M fill:#bbf7d0,color:#1a202c
  style T fill:#bbf7d0,color:#1a202c
  style N fill:#fef3c7,color:#1a202c
```
