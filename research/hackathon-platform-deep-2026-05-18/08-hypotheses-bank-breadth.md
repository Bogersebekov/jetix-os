...
type: research-doc
phase: 7
title: Hypothesis bank — breadth NOT selection (40 H with refutation conditions)
...
constitutional_posture: breadth-NOT-selection + R1 surface + R6 + EP-5 F-grade explicit
acceptance_predicate: refuted_if_(<30_H_with_refutation_conditions OR any_H_promoted_to_recommendation OR no_cross_ref_to_ML_45_H)
language: russian + english
parents:
  - All phases 0-6
  - research/ml-ai-engineers-2026-05-18/09-hypotheses-bank-breadth.md (cross-ref H-ML-10/38/39/44 + 41 others)
  - research/hackathon-deep-2026-05-18/03-jetix-hypotheses-deep.md (4 ranked hypotheses A/B/C/D)
---
