...
type: research-doc
phase: 6
title: Multi-rhythm Year-1 calendar (Q3 2026 → Q3 2027)
date: 2026-05-18 evening
authored_by: brigadier-scribe
word_budget: ~2500
cell_dispatch: mgmt × integrator
fpf_layer: A.3.1 method + A.17 trajectory + U.MethodDescription (Phase 0 scope 1+2 dominant)
constitutional_posture: R1 surface + R6 + EP-5 F2 + dependency-explicit
acceptance_predicate: refuted_if_(<6_events OR no_per_event_budget OR no_dependencies OR no_Gantt)
language: russian + english
parents:
  - 03-per-rhythm-mechanism-spec.md (6 rhythms)
  - 06-first-event-Q3-2026-blueprint.md (Q3 anchor)
  - decisions/strategic/JETIX-AS-HACKATHON-PLATFORM-2026-05-18.md §7 Activation Gantt + §8 progression
---
...
gantt
    ...
    section Event 4 - Year (multi-clan)
    ...
    section Event 6 - Week cross-disciplinary
...
graph TD
    ...
    E3[Event 3: Week, Q4<br/>engineer-mode]
    E4[Event 4: Year, Q1 2027<br/>multi-clan]
    E5[Event 5: Weekend, Q1-Q2<br/>RU L2]
    E6[Event 6: Week, Q2-Q3<br/>cross-disciplinary]
    Concept[Concept doc A acked]
    Anthropic[Anthropic sponsor signed]
    Customer[Customer brief signed]
    AlumniPool[Alumni mentor pool ≥5]
    Charter[Charter clan ≥3 signatories]
    Workshop[Master Workshop activated]
    Funding[AI Grant OR substitute funding]
    Concept --> E1
    Anthropic --> E1
    E1 --> AlumniPool
    AlumniPool --> E2
