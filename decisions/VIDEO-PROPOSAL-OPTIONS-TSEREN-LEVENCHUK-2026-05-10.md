---
title: Video Proposal Options — Цэрэн + Левенчук + ШСМ/МИМ (comprehensive brainstorm)
date: 2026-05-10
type: proposal-options-brainstorm
status: draft (awaiting Ruslan picks)
audience: Цэрэн Цэрэнов (МИМ Managing Partner) / Анатолий Левенчук (ШСМ научный руководитель) / МИМ-сообщество
...
parent_research:
  - raw/research/2026-04-28-tseren-tg-export/analysis-report.md (618 posts, 2021-2026)
  - raw/research/2026-04-28-tseren-yt-export/analysis-report.md (127 videos, 26 months)
  - crm/people/tseren-tserenov.md
constitutional_anchor:
  - Tier 2 Rule 1 (AI = brainstorm + structure options; Ruslan = sole decider)
  - Tier 2 Rule 6 (provenance per option — source path / memo / insight ref)
  - Append-only (existing canonical / action plan untouched)
  - Default-Deny (draft → ack → only then video script as separate task)
F: F4
...
flowchart LR
    %% --- LEFT — Audience entities ---
    subgraph AUDIENCE ["🎯 <b>Audience</b><br/><small>3 entities</small>"]
        direction TB
        TSEREN["👤 <b>Цэрэн Цэрэнов</b><br/><small>МИМ Managing Partner<br/>~54 yo, ex-реформатор<br/>2026 #1 word: claude</small>"]:::partner_a
        LEVENCHUK["👤 <b>Анатолий Левенчук</b><br/><small>ШСМ научный руководитель<br/>методология lead<br/>11-year partner</small>"]:::partner_b
        MIM["🏛 <b>МИМ-сообщество</b><br/><small>~7K+ members<br/>Aisystant platform<br/>10-я конференция (Apr 2026)</small>"]:::partner_c
    end

    %% --- CENTER — 8 collaboration formats ---
    subgraph FORMATS ["🤝 <b>8 Collaboration Formats</b>"]
        direction TB
        F1["⭐ <b>F1 Founding Partner</b><br/><small>Doc 1B §9.1 / equity-leaning<br/>RES.3 deferred — Stage 4+</small>"]:::ladder_l5
        F2["<b>F2 Operating Partner</b><br/><small>Joint product development<br/>Doc 1B §9.1 Operating subtype</small>"]:::ladder_l3
        F3["<b>F3 Mentor / Advisor</b><br/><small>Periodic guidance<br/>⚠ AP risk if framed wrong</small>"]:::ladder_l1
        F4["✅ <b>F4 Co-creation specific</b><br/><small>Workshop integration<br/>30-60 day MVP — Stage 1 ready</small>"]:::ladder_l2
        F5["⚠ <b>F5 Investment</b><br/><small>NOT propose Stage 1-2<br/>Premature ask = downgrade</small>"]:::ladder_l0
        F6["<b>F6 Endorsement</b><br/><small>Distribution amplifier<br/>Stage 3+ post case study</small>"]:::ladder_l2
        F7["⛔ <b>F7 Affiliate</b><br/><small>Style mismatch<br/>Probably skip</small>"]:::ladder_l0
        F8["⭐ <b>F8 Combined phased</b><br/><small>F4 → F2 → F6 → F1<br/>Adaptive trajectory</small>"]:::ladder_l4
    end

    %% --- BOTTOM — 5 disclosure stages ---
    subgraph STAGES ["📅 <b>5 Disclosure Stages</b>"]
        direction LR
        S1["⚡ <b>Stage 1</b><br/><small>This video<br/>M1/M5/M7/M8<br/>D1+Q1+CTA</small>"]:::ladder_l0
        S2["📅 <b>Stage 2</b><br/><small>First call<br/>D3/D4/D6/D7<br/>F-format menu</small>"]:::ladder_l1
        S3["📆 <b>Stage 3</b><br/><small>2-я call<br/>D8/D10/M3<br/>Format chosen</small>"]:::ladder_l3
        S4["🚀 <b>Stage 4</b><br/><small>Post commit<br/>Full access<br/>Council names</small>"]:::ladder_l4
        S5["🎯 <b>Stage 5</b><br/><small>Phase 1→2<br/>D9 Foundation Model<br/>RES.3 unlock</small>"]:::ladder_l5
    end

    %% --- RIGHT — Outcomes ---
    subgraph OUTCOMES ["📤 <b>Possible Outcomes</b>"]
        direction TB
        O_HOT["🔥 <b>Synergy unlock ✅</b><br/><small>A3.1 ШСМ deep dive<br/>$100K к концу лета<br/>Council expansion</small>"]:::ladder_l5
        O_COLD["❄ <b>Polite decline</b><br/><small>Per Doc 1B §10.4<br/>fallback — solo path<br/>$100K к концу года</small>"]:::ladder_l1
        O_SLOW["🐢 <b>Slow positive</b><br/><small>F3/F4 light start<br/>30-60 day re-engage<br/>Phase 2 escalation</small>"]:::ladder_l2
    end

    %% --- Anti-patterns guard ---
    AP["⛔ <b>Anti-patterns 12</b><br/><small>AP1 Foundation Model<br/>AP2 desperation<br/>AP3 financial Stage 1<br/>... 9 more</small>"]:::guard
    ...
    AP -.->|"avoid all stages"| STAGES

    %% --- classDef block ---
    classDef partner_a fill:#fce4ec,stroke:#ad1457,stroke-width:3px,color:#000
    classDef partner_b fill:#e3f2fd,stroke:#1565c0,stroke-width:3px,color:#000
    classDef partner_c fill:#e8f5e9,stroke:#2e7d32,stroke-width:3px,color:#000
    ...
    style AUDIENCE fill:#fff8e1,stroke:#f57c00,stroke-width:4px
    style FORMATS fill:#fff8e1,stroke:#f57c00,stroke-width:4px
    style STAGES fill:#fff8e1,stroke:#f57c00,stroke-width:4px
    style OUTCOMES fill:#fff8e1,stroke:#f57c00,stroke-width:4px
```
