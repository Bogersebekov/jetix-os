...
parent_insights:
  ...
  - decisions/STRATEGIC-INSIGHT-BALAJI-NETWORK-STATE-2026-05-10.md            # H4
...
constitutional_anchor: principles/tier-2-system/foundation-generic/ai-does-not-extract-value-beyond-agreed-share.md  # R12 Tier 2
related_canonical:
  - decisions/JETIX-CORPORATION-2026-05-05.md          # Doc 1B
  - decisions/JETIX-WORKSHOP-CONCEPT-2026-04-30.md     # Workshop
  - decisions/JETIX-TRM-MODEL-2026-04-30.md            # TRM
  - decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md   # FUNDAMENTAL
parent_decisions:
  - reports/strategic-decisions-2026-05-12.md  # Q1-Q7 + Q-D1..Q-D4
F: F5
G: charter-applied-now
R: refuted_if_no_first_signature_within_60d_OR_Ruslan_rejects_draft
blast_radius: F5
signatories_target: "5 base / 10 target / 10-15 ambition flex (per Q7 ack 2026-05-12)"
signatories_confirmed: 0
launch_mode: stealth  # per Q-D3 ack 2026-05-12
source_of_truth: filesystem  # per Q-D1 ack 2026-05-12
realm_scope: "FULL 6 archetypes — Hunter / Guardian / Scholar / Creator / Architect / Merchant (per Q-D2 ack 2026-05-12)"
monetization: "all 3 variants open — consulting / правая рука / subscription (per Q-D4 ack 2026-05-12)"
---
...
flowchart TB
    ...
    H3["<b>H3 R&amp;D Flywheel</b><br/><small>90% reinvest / anti-extract</small>"]:::guard
...
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#fff8e1', 'primaryTextColor':'#000', 'primaryBorderColor':'#f57c00', 'lineColor':'#555', 'fontFamily':'Inter, system-ui, sans-serif', 'fontSize':'14px'}}}%%
flowchart LR
    L0["<b>L0</b><br/>1<br/><small>NOW<br/>Founder solo</small>"]:::ladder_l0
    L1["<b>L1</b><br/>5-15<br/><small>30-60d<br/>First Clan</small>"]:::ladder_l1
    L2["<b>L2</b><br/>100<br/><small>6-12mo<br/>Multi-clan</small>"]:::ladder_l2
...
> Brigadier appends per voice-pipeline-2026-05-18-batch-3 Phase 2 integration. R1 surface + R6 + append-only. Charter content LOCKED 2026-05-12 = PRESERVED; this section = overlay clarification (no overwrite).

### §APPEND.1 — Clan-warfare mode = hackathon-mode operational identity

text_009 Thread 11 (¶10): «хакатоны будут это как раз вот эти клановые войны соответственно они будут там вообще разных режимов ритмов».

Charter §clan-warfare-mode (LOCKED 2026-05-12) acquires explicit operational identity: clan-wars = hackathons across multi-rhythm:
- **Day-rhythm** — sprint-mode (high-complexity solved «за день» per text_009 Thread 3).
- **Month-rhythm** — sponsor cycles, medium-complexity projects.
- **Year-rhythm** — major marathon collaborations, deep apprenticeship cycles.

### §APPEND.2 — Multi-rhythm Year-1 cadence proposal (R1 surface)

Brigadier surfaces proposal (Ruslan picks):
- Q3 2026: 3 day-rhythm + 1 month-rhythm hackathons (bloggers + sponsor mode).
- Q4 2026: 2 day-rhythm + 2 month-rhythm + 1 year-rhythm (engineer-mode + Master Workshop).
- 2027+: Full multi-rhythm calendar.

NOT autonomous; Ruslan picks first event + cadence.

### §APPEND.3 — R12 anti-extraction preservation в clan-wars

R12 anti-extraction (Tier 2 rule 12 LOCKED 2026-05-12) applies к clan-wars revenue distribution: Quadratic Funding per Ethereum architecture (acked 2026-05-18 commit `8a3d800`). Hackathon prize pools = QF distribution (NOT shareholder). Fork-and-leave preserved.
...
- `decisions/strategic/JETIX-ETHEREUM-ARCHITECTURE-2026-05-18/05-dao-governance-multi-clan.md` (clan governance substrate)
- `swarm/awaiting-approval/r12-programmable-ethereum-2026-05-18.md` (R12 enforcement substrate)

---

*§APPEND-2026-05-18-evening generated by brigadier per voice-pipeline-2026-05-18-batch-3 Phase 2. Charter content LOCKED 2026-05-12 PRESERVED; overlay clarification only.*
