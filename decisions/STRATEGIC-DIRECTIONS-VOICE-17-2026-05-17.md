---
title: Strategic Directions captured — voice batch 17.05 (SD-01..SD-06)
date: 2026-05-17
type: strategic-directions-capture
status: surfaced-pending-Ruslan-priority
authored_by: brigadier scribe (verbatim extraction from work-plan §3 + cross-cell triangulation)
prose_authored_by: ruslan (voice) + brigadier (structuring scribe)
ack_record:
  - date: 2026-05-17
    ack_type: explicit-ack-via-prompt
    ack_text: "Ruslan §0.5: «Все SD-01..SD-06 зафиксировать в decisions/STRATEGIC-DIRECTIONS-VOICE-17-2026-05-17.md чтобы НЕ потерялись. Phase C work подойдём к ним позже.»"
    ack_source: prompts/phase-0-plus-ruslan-acks-2026-05-17.md §0.5
parent_reports:
  - reports/voice-pipeline-2026-05-17-batch/04-detailed-work-plan.md §3
  - reports/voice-pipeline-2026-05-17-batch/00-MASTER-INDEX.md
  - reports/voice-pipeline-2026-05-17-batch/05-wiki-candidates.md
F: F3
G: strategic-directions-voice-17-capture
R: refuted_if_SD_entries_diverge_from_voiced_articulation_OR_action_priority_assigned_without_Ruslan_ack
constitutional_posture: R1 surface only — no auto-prioritization; Ruslan = sole strategist for promotion → Octagon insight OR project / phase plan
...
graph TD
    ...
    SD03[SD-03 Meta-communities on rails] --> NC2[NC-2 road metaphor concept]
    SD03 --> SD06[SD-06 системные мыслители community]
    SD06 --> Clan[O-13 Clan first cohort]
    SD04[SD-04 человек-армия] --> LifeOS[life-os P3]
    SD04 -.-> Clan
    SD05[SD-05 Gaming ontology] --> ET[engineering-thinking P3]
    ET --> O09[O-09 Octagon NQD alternatives]
    H8 --> SD01
    H8 --> SD03
```
