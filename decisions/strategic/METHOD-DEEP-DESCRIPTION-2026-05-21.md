...
F: F2-F3
F_breakdown: F2 substrate cross-cite (Ruslan voice / acked LOCKs) + F3 brigadier analysis (synthesis layer)
...
substrate_consolidated_from:
  - reports/method-deep-description-2026-05-21/phase-0-fpf-lens-scope.md
  - reports/method-deep-description-2026-05-21/01-canonical-definition.md
  - reports/method-deep-description-2026-05-21/02-31-components.md
  - reports/method-deep-description-2026-05-21/03-layers.md
  - reports/method-deep-description-2026-05-21/04-mechanics.md
  - reports/method-deep-description-2026-05-21/05-8-doc-inventory.md
  - reports/method-deep-description-2026-05-21/06-comparison.md
  - reports/method-deep-description-2026-05-21/07-fpf-universal-language.md
  - reports/method-deep-description-2026-05-21/08-use-cases-workflows.md
diagrams_count: 27
phase_count: 10
status: brigadier-scribe-surface (R1)
---
...
```mermaid
mindmap
  root((Jetix-метод<br/>O-107 one-liner))
    метод
      1st-class object<br/>Левенчук MG4
      input space
      transformation rule
      output space
      F-G-R grade
      carrier ≠ method<br/>IP-1
    по объединению методов
      operator на множестве методов
      классификация по F-G-R / domain / leverage
      composition в стек / pipeline
      ROY 5 experts × 4 modes = 20 cells
    по улучшению системы
      delta-target per cycle
      Meadows hierarchy of leverage points
      Individual / Composite / Society / Planet-scale
    самой себя
      Hofstadter strange-loop GEB 1979
      Engelbart H-LAM/T 1962
      Boyd OODA recursion
      8-step lifecycle K-6 §B.18
      Recursive Engine 5-cycles trial
```
