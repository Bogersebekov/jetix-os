---
title: "Lock D-07 — Community cast — 11 archetypes (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-07
slug: community-cast-11-archetypes
candidate_source:
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 7
Extracted candidate (verbatim from source / synthesized from recon):

Union обоих списков → 10 base archetypes (Предприниматели / Ресёрчеры / Инженеры / Инвесторы / Политики / Продавцы / Менеджеры / Философы / Разработчики идей / Разработчики жизни). +Блогеры (Stage 3) = 11.
...
- SPLIT: candidate is multi-Lock; split into D-07-a, D-07-b → scaffold
...
# Lock D-07 — Community cast — 11 archetypes
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 7
