---
title: "Lock D-21 — Partnership-matchmaker + Roy-replication (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-21
slug: partnership-matchmaker-roy-replication
candidate_source:
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED-STAGE-2B.md §Decision 21
Extracted candidate (verbatim from source / synthesized from recon):

Jetix = matchmaker (complex tasks ↔ specialists с AI-agent coordination smoothing) + roy-replication (own roy 10 people $10M-$100M; methodology distributed → other roys / niches / countries; meta-coordination).
...
- SPLIT: candidate is multi-Lock; split into D-21-a, D-21-b → scaffold
...
# Lock D-21 — Partnership-matchmaker + Roy-replication
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED-STAGE-2B.md §Decision 21
