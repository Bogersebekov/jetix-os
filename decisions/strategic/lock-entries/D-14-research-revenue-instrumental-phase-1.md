---
title: "Lock D-14 — Research = revenue-instrumental Phase 1 (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 14 (T6)
Extracted candidate (verbatim from source / synthesized from recon):

Phase 1 research разрешён только если serves revenue (ICP / sales / competitor / AI-tools / pricing / industry). Philosophy / любопытство / civilizational framing parked Phase 2+.
...
- SPLIT: candidate is multi-Lock; split into D-14-a, D-14-b → scaffold
...
# Lock D-14 — Research = revenue-instrumental Phase 1
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 14 (T6)
