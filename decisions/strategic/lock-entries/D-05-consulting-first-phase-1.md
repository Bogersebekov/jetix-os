---
title: "Lock D-05 — Consulting-first Phase 1 (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 5
Extracted candidate (verbatim from source / synthesized from recon):

Phase 1 = Consulting-first. Community = попутно в чате. Secure Network = natural evolution Phase 2+.
...
- SPLIT: candidate is multi-Lock; split into D-05-a, D-05-b → scaffold
...
# Lock D-05 — Consulting-first Phase 1
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 5
