---
title: "Lock D-03 — Closed outside / Open inside (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-03
slug: closed-outside-open-inside
candidate_source:
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 3
Extracted candidate (verbatim from source / synthesized from recon):

Closed для внешнего мира; open для команды/community (inside members) — privileged access для partners, не public open-source.
...
- SPLIT: candidate is multi-Lock; split into D-03-a, D-03-b → scaffold
...
# Lock D-03 — Closed outside / Open inside
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 3
