---
title: "Lock D-22 — ICP 5-criteria + direction-of-life axis (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-22
slug: icp-5-criteria-direction-of-life
candidate_source:
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED-STAGE-2B.md §Decision 22
Extracted candidate (verbatim from source / synthesized from recon):

ICP filter (поверх 11 archetypes D-7) = startupper-mindset + entrepreneurial azart + stable + adequate + upward-direction (vertical axis: development vs degradation). Self-selection через «самая большая авантюра века».
...
- SPLIT: candidate is multi-Lock; split into D-22-a, D-22-b → scaffold
...
# Lock D-22 — ICP 5-criteria + direction-of-life axis
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED-STAGE-2B.md §Decision 22
