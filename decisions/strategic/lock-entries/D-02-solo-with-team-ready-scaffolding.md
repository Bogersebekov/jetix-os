---
title: "Lock D-02 — Solo-with-team-ready scaffolding (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-02
slug: solo-with-team-ready-scaffolding
candidate_source:
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 2
Extracted candidate (verbatim from source / synthesized from recon):

Действуем соло прямо сейчас, НО архитектура с Day 1 готова к 2-3 пилоту без refactor. Документы / процессы build'ятся под multi-pilot inheritance.
...
- SPLIT: candidate is multi-Lock; split into D-02-a, D-02-b → scaffold
...
# Lock D-02 — Solo-with-team-ready scaffolding
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 2
