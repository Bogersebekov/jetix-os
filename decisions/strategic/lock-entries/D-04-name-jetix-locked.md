---
title: "Lock D-04 — Name Jetix LOCKED (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 4
Extracted candidate (verbatim from source / synthesized from recon):

Jetix — name не меняется. Все упоминания «Jackson/Джек» — speech-recognition artefacts.
...
- SPLIT: candidate is multi-Lock; split into D-04-a, D-04-b → scaffold
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 4
