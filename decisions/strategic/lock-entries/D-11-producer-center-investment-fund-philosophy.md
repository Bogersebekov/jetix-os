---
title: "Lock D-11 — Producer center + Investment-fund philosophy Day 1 (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-11
slug: producer-center-investment-fund-philosophy
candidate_source:
  path: "raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md"
  section: "§Decision 11 (T3)"
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 11 (T3)
Extracted candidate (verbatim from source / synthesized from recon):

Phase 1 core = Consulting + Продюсерский центр (parallel). Investment-fund = operating philosophy Day 1 (Resource-Allocation Engine: time/attention/money). Ideas-platform + Job-matching = Phase 2+ Secure Network features.
...
- SPLIT: candidate is multi-Lock; split into D-11-a, D-11-b → scaffold
...
# Lock D-11 — Producer center + Investment-fund philosophy Day 1
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 11 (T3)
