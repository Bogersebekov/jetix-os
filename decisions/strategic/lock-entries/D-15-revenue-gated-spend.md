---
title: "Lock D-15 — Revenue-gated spend (phased unlocks) (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 15 (T7)
Extracted candidate (verbatim from source / synthesized from recon):

Heavy-spend gated by revenue thresholds. Phase 0 essentials only → Phase 1 early ($20-30K) GmbH+Stripe → Phase 1→2 (€200K) патенты+hires → Phase 2 (€1M) revenue-share → Phase 3 ($1M+) full investment-fund.
...
- SPLIT: candidate is multi-Lock; split into D-15-a, D-15-b → scaffold
...
# Lock D-15 — Revenue-gated spend (phased unlocks)
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 15 (T7)
