---
title: "Lock D-09 — Pain primary / Opportunity secondary (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 9 (T1)
Extracted candidate (verbatim from source / synthesized from recon):

Outbound messaging: Pain-based primary («AI ускоряет — замедлитесь, не успеете») + Opportunity-based secondary («показываем что возможно»). Pain dominant, both used.
...
- SPLIT: candidate is multi-Lock; split into D-09-a, D-09-b → scaffold
...
# Lock D-09 — Pain primary / Opportunity secondary
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 9 (T1)
