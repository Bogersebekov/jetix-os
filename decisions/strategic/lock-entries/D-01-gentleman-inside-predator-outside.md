---
title: "Lock D-01 — Gentleman inside / Predator outside (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-01
slug: gentleman-inside-predator-outside
candidate_source:
  path: "raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md"
  section: "§Decision 1"
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 1
Extracted candidate (verbatim from source / synthesized from recon):

Brand identity formula: Gentleman inside (member↔member: civility, knowledge-packaging, value-exchange) / Predator outside (network↔world: max-defence, retaliation, organizational weight). Membrane = quality-gate + subscription.
...
- SPLIT: candidate is multi-Lock; split into D-01-a, D-01-b → scaffold
...
# Lock D-01 — Gentleman inside / Predator outside
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 1
