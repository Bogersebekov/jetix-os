---
title: "Lock D-12 — Content strategy — smart audience + site primary + соцсети max TOF (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-12
slug: content-strategy-smart-audience-site-primary
candidate_source:
  path: "raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md"
  section: "§Decision 12 (T4)"
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 12 (T4)
Extracted candidate (verbatim from source / synthesized from recon):

Target audience = умные. Основа = сайт + 10 шаблонов + видео + PDF. Соцсети = TOF на максимум (блогеры / collabs / подкасты / реклама). Substance — на сайте + Secure Network deep.
...
- SPLIT: candidate is multi-Lock; split into D-12-a, D-12-b → scaffold
...
# Lock D-12 — Content strategy — smart audience + site primary + соцсети max TOF
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 12 (T4)
