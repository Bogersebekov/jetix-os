---
title: "Lock D-16 — Phase 1 community = simple chat; formal mechanics Phase 2+/3+ (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 16 (T8)
Extracted candidate (verbatim from source / synthesized from recon):

Phase 1 community = простой chat (Telegram/Discord), invite-based, no formal anti-free-riding. Phase 2+ subscription = baseline filter; Phase 3+ tiered membership only when scale forces.
...
- SPLIT: candidate is multi-Lock; split into D-16-a, D-16-b → scaffold
...
# Lock D-16 — Phase 1 community = simple chat; formal mechanics Phase 2+/3+
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 16 (T8)
