---
title: "Lock D-17 — Filesystem = source of truth (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 17 (T9)
Extracted candidate (verbatim from source / synthesized from recon):

Filesystem = единственный source of truth. Notion = collaboration / planning / UI tool, не authoritative. Conflict → filesystem wins.
...
- SPLIT: candidate is multi-Lock; split into D-17-a, D-17-b → scaffold
...
# Lock D-17 — Filesystem = source of truth
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED.md §Decision 17 (T9)
