---
title: "Lock D-08 — Layered identity — multiplicity frames (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-08
slug: layered-identity-multiplicity-frames
candidate_source:
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 8
Extracted candidate (verbatim from source / synthesized from recon):

Jetix = layered identity. Один объект с разными faces зависимо от observer и phase: methodology / company / network / club / corporation / civilizational infrastructure. Не противоречия — grammar.
...
- SPLIT: candidate is multi-Lock; split into D-08-a, D-08-b → scaffold
...
# Lock D-08 — Layered identity — multiplicity frames
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 8
