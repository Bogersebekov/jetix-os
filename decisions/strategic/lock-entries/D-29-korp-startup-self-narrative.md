---
title: "Lock D-29 — Korp-startup self-narrative (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-29
slug: korp-startup-self-narrative
candidate_source:
  path: "decisions/LOCKS-D29-ADDENDUM-2026-04-26.md"
  section: "§D29"
...
Source: decisions/LOCKS-D29-ADDENDUM-2026-04-26.md §D29
Extracted candidate (verbatim from source / synthesized from recon):

Jetix = «корпорация-стартап» Day 1: стартап-аппарат на корпоративной траектории, founder ответственен за сотни тысяч людей и миллионы $; не фрилансер / не AI-консультант / не solo-SaaS. Self-narrative + external messaging + team-hire framing + brand voice anchor.
...
- SPLIT: candidate is multi-Lock; split into D-29-a, D-29-b → scaffold
...
# Lock D-29 — Korp-startup self-narrative
...
- Original location: decisions/LOCKS-D29-ADDENDUM-2026-04-26.md §D29
