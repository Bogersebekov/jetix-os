---
title: "Lock D-27 — Fork-and-merge evolution architecture (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
Source: decisions/LOCKS-D25-D28-ADDENDUM-2026-04-24.md §D27
Extracted candidate (verbatim from source / synthesized from recon):

Fork-and-merge upstream-controller architecture: canonical Jetix + downstream forks (different verticals/niches/countries) + merge-back лучших мутаций upstream. Phase-3+ activity. Governance model TBD.
...
- SPLIT: candidate is multi-Lock; split into D-27-a, D-27-b → scaffold
...
# Lock D-27 — Fork-and-merge evolution architecture
...
- Original location: decisions/LOCKS-D25-D28-ADDENDUM-2026-04-24.md §D27
