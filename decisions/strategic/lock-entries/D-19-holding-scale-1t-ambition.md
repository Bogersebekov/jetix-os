---
title: "Lock D-19 — Holding-scale $1T ambition (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-19
slug: holding-scale-1t-ambition
candidate_source:
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED-STAGE-2B.md §Decision 19
Extracted candidate (verbatim from source / synthesized from recon):

Jetix targets world-record speed для $1T market cap. Layered: €50K (Q2 2026) → €200K validation → $100M revenue → $100B revenue → $1T market cap. Engineering-faith framed (real tools / methodology / team).
...
- SPLIT: candidate is multi-Lock; split into D-19-a, D-19-b → scaffold
...
# Lock D-19 — Holding-scale $1T ambition
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-RESOLVED-STAGE-2B.md §Decision 19
