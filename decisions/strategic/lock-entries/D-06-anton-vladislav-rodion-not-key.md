---
title: "Lock D-06 — Anton/Vladislav/Rodion not key (SCAFFOLD-PENDING-REVIEW)"
type: lock-entry
version: 1.0
...
lock_id: D-06
slug: anton-vladislav-rodion-not-key
candidate_source:
...
Source: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 6
Extracted candidate (verbatim from source / synthesized from recon):

Не ключевые. Убрать из core документов, не упоминать. Advisory layer parked до actual advisor появится.
...
- SPLIT: candidate is multi-Lock; split into D-06-a, D-06-b → scaffold
...
# Lock D-06 — Anton/Vladislav/Rodion not key
...
- Original location: raw/research/architecture-variants-2026-04-22/TENSIONS-PRE-RESOLVED.md §Decision 6
