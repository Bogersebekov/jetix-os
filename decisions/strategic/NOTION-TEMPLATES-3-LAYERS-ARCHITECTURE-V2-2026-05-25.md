...
страниц-документов**: три про направление (куда иду) и философский лист (что хочу помнить).
...
**пишет и курирует человек**. CC только предзаполняет данные в базе Goals, подтягивает цифры и
**показывает** философский лист по просьбе — «куда я иду», «как хочу жить» и «что для меня мудро»
решает только человек (правило конституции №1).
...
| **Новое в v2** | усиленный Daily Log + Habits база + Strategic (Vision/Goals/Точка А→Б + Философский лист) + 2 ревью + «посмотреть позже» | Generic/Jetix split + Brand pattern | Hypotheses + Vision/Goals страницы + L1↔L3 connect |
