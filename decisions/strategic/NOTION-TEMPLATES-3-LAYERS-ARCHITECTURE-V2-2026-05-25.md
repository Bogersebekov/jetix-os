...
| **Новое в v2** | усиленный Daily Log + Habits база + Strategic + 2 ревью + «посмотреть позже» | Generic/Jetix split + Brand pattern | Hypotheses + Vision/Goals страницы + L1↔L3 connect |
