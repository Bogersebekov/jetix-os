...
> **Jetix Corporation** — это **AI-native operational корпорация**, построенная как **applied use case** Базовой Системы Управления (Документ 1A). Главная метафора — **мета-мастерская** среди других мастерских: умная за счёт сети специализированных мастеров (AI / cybersec / legal / research / investment / etc.) под одной крышей, работающая с информацией как с главным сырьём. Центральное коммерческое предложение — **Total Resource Management (TRM)**: управление 6 ресурсами клиента одновременно (💰 финансы / ⏱️ время CEO / 📢 аудитория / 📚 знания / 💻 compute / 🤝 команда) за mgmt fee + performance fee, через лестницу L0-L5 (€3K гипотеза → €40-60K/мес TRM-full). Платформа имеет **3 уровня вовлечения** — Партнёры (top tier с existing capital, financial participation 5 вариантов), Клиенты (TRM ladder, mgmt + performance), Работники (зарплата + portable accumulation = антипаттерн corporate slavery), плюс **4 источника проектов** (Jetix internal / TRM-driven / external owners / самостоятельные участники). Главная амбиция — **«объединить всех авантюристов в самую большую авантюру»** (engineering-faith bet, не pyramid): улучшение общества + лучшие способы жизни + изменение того **кому доверяют управление** в обществе. Trajectory: €5K (now) → **$100K к концу лета 2026** → €500K+ ARR Y1 → **€100M+ ARR через 3 года** → 10y будет огромное и масштабное (стыдно даже думать конкретные numbers — ограничивает upside). Главный stopper now — synergy с мастерской инженеров-менеджеров (Tseren / Левенчук / ШСМ); после unlock — 8-step roadmap к $100K через продажи Jetix системы предпринимателям. Jetix — **НЕ classic consulting / НЕ AI-стартап / НЕ holding / НЕ accelerator / НЕ social network / НЕ pyramid / НЕ traditional employer / НЕ автономный AI** (см. §12 anti-patterns с тестами). Главный moat — **network effects через Reed's Law** (2^N group formations) × **compound learning накопление методологий** через всех participants × **cross-resource synergy** (6 operators per client) — uncopyable за 5-10 лет curated quality + accumulated wisdom.
...
> **Цель раздела:** explicit отграничение Jetix Corp от похожих по виду, но принципиально других концепций. Это **дополнение** к Документу 1A §7 (anti-patterns Базовой Системы) — здесь специфика **Jetix как applied use case**.
>
> *Каждый anti-pattern: похоже потому что → принципиально отличается → конкретный тест.*

---

## 12.1 НЕ classic consulting firm (vs McKinsey / BCG / Bain / Big 4)

### Похоже потому что
Делаем strategic / advisory / management работу. Производим artifacts (reports / presentations / методологии). Работаем на нескольких клиентов параллельно.

### Принципиально отличается
- ❌ **Они продают слайды + почасовку.** Закончили проект — ушли. Клиент несёт risk выполнения.
- ✅ **Мы продаём управление + ответственность.** Performance fee = skin-in-game. Не уходим пока не сработало.

| Параметр | Big 4 / McKinsey | Jetix |
|----------|------------------|-------|
| Что покупает клиент | Рекомендации | Управление + результат |
| Pricing | Fixed fee / hourly | Mgmt fee + **performance fee** |
| Skin-in-game | Минимальный | Существенный |
| Зависимость выручки от роста клиента | Минимальная | Высокая (растёт с ростом клиента) |
| Scale | Линейный (через найм) | Экспоненциальный (через AI) |

### Тест
Если консалтинг **гарантирует получить такую же оплату** независимо от того сработала ли рекомендация — это classic consulting. Если **половина оплаты зависит от того что клиент реально вырастет** — это Jetix-style.

> **Jetix = networks-layer над consulting world, не compete-layer с McKinsey.** Можем работать вместе — McKinsey делает их часть, Jetix управляет операционно. См. §11.3 (joint products).

---

## 12.2 НЕ AI-стартап с продуктом (vs OpenAI / Anthropic / Cursor / etc.)

### Похоже потому что
Активно используем AI. 12 AI-агентов в системе. Speak the same vocabulary как AI startups.

### Принципиально отличается
- ❌ **Они делают AI-инструменты** (chatbots / dashboards / automations / SaaS) — продают **сам tool**.
- ✅ **Мы делаем методологию AI-leverage** — продаём **способ применения** AI инструментов для real outcomes.

### Аналогия Westinghouse / Ford
| Эпоха | Технология | Methodology | Исполнители |
|-------|------------|-------------|-------------|
| Электричество (1880-1920) | AC/DC power | Электрический завод (Ford) | Электрики |
| AI (2020+) | LLMs / agents / models | **Jetix methodology** | Operators / специалисты |

### Тест
Если у компании **главный продукт = software / API / SaaS** который другие используют для своих целей — это AI startup. Если главный продукт = **методология применения готового AI** для achieving operational results — это Jetix-class.

### Конкретно
Jetix НЕ строит «ещё один tool» — Jetix строит **способ применения tools**. Используем Anthropic / OpenAI / etc. через MCP integrations — но **не пытаемся сделать своего конкурента** этим vendors.

---

## 12.3 НЕ holding company (vs BlackRock / Berkshire / family offices)

### Похоже потому что
Управляем ресурсами клиентов. Получаем performance fee. Долгосрочная ориентация. Сторонняя интеграция.

### Принципиально отличается
- ❌ **Они управляют одним типом ресурса** — деньгами (investment portfolio).
- ✅ **Мы управляем 6 типами ресурсов одновременно** (TRM см. §3) — финансы / время / аудитория / знания / compute / команда.
- ❌ Holding **покупает компании** (controlling stake / acquisition).
- ✅ Jetix **помогает владельцу управлять** (operational layer + ownership остаётся у клиента).

### Тест
Если бизнес-модель = **acquire companies → optimize → exit** — это holding. Если = **augment existing owners' management capability через AI-augmented operators** — это Jetix.

### Не путать с подходом BlackRock
> **BlackRock:** «Дай нам деньги, мы их инвестируем за тебя.»  
> **Jetix:** «Дай нам управлять твоими operations и ресурсами, мы помогаем тебе вырасти + делим прибыль.»

---

## 12.4 НЕ accelerator / incubator (vs YC / TechStars / 500 Startups)

### Похоже потому что
Помогаем founders. Имеем portfolio. Может быть equity component. Network effects.

### Принципиально отличается
- ❌ **Они тренируют founders + дают seed money + network** — преимущественно **early-stage**, **3-6 mes program**, потом founder сам.
- ✅ **Мы не тренируем — мы реальный operational partner**. Long-term (2+ years). Не «обучили — отпустили».

### Тест
Accelerator берёт **equity 5-10%** + tickets $100-500K + 3-6 mes program. Jetix — **mgmt + performance fees** (recurring) + ongoing engagement. Не graduation program.

### Конкретно НЕ
- ❌ Demo days
- ❌ Cohort batches
- ❌ Startup curriculum
- ❌ Mass scale (хорошие accelerators делают 50-100 startups/год; Jetix curated maybe 50-100 clients за 2-3 года)

---

## 12.5 НЕ social network / open community (vs LinkedIn / Discord / Slack)

### Похоже потому что
Имеем community аспект. Phase 3 vision = network of mastersких. Cross-pollination между participants.

### Принципиально отличается
- ❌ **Они open** (любой может присоединиться). Massevich. Attention economy.
- ✅ **Мы curated, closed network** (особенно Phase 1-2). Quality > quantity. **Anti-attention-economy**.

### Verbatim Ruslan
> *«Это не хуйня типа тиктока, инстаграма, ютуба — а которая просто всё дерьмо вместе… это тоже не LinkedIn где быдло одно которое ищет каких-то рабов.»*

### Тест
Если кто угодно может join + получить value через bare присутствие — social network. Если **входной фильтр + reputation system + earned access** — Jetix-class community.

### Mafia → Community evolution (§4.7)
- **Phase 1:** mafia-style closed circle
- **Phase 2:** carefully expanded curated trust network
- **Phase 3:** community с входным фильтром (5 critical filter)

**Никогда** — не open mass-market.

---

## 12.6 НЕ Notion-стек / Obsidian-стек / productivity stack

### Похоже потому что
Используем Notion / git / scripts / files. Работаем с knowledge management. Многие участники — knowledge workers.

### Принципиально отличается
- ❌ **Stack of products:** «я использую Notion + Todoist + Cal + Toggl» — фрагменты, не система. Каждый product управляет своим уголком.
- ✅ **Jetix Corp:** архитектурный фундамент (Базовая Система Документ 1A) + applied implementation, который **использует** эти tools как components в L1 Storage / Part 10 External.

### Тест
Что произойдёт если **Notion завтра упадёт навсегда**?
- Stack: работа парализована
- Jetix: можем продолжить через filesystem + git + ручной ввод (Kay-принцип, ADR-005)

> Notion ≠ Jetix. Notion — это один из tools которые мы используем. Jetix — methodology + system + people поверх.

---

## 12.7 НЕ pyramid / scam / Oriflame / hype-driven (vs MLM / crypto pump)

### Похоже потому что
Большая ambition ($1T trajectory). Сообщество. Multi-level (clients / partners / workers). Token economy planned (Phase 2-3).

### Принципиально отличается
- ❌ **Pyramid:** payouts depend on recruiting more people, not on real value created
- ✅ **Jetix:** payouts depend on real outcomes (performance fees on actual client growth)

> **Verbatim Ruslan:** *«Это всё должно быть не какая-то там ебаная пирамида. Нет. А реально адекватные инструменты, наработки, технологий.»*

### Тест (5 проверок)
| Параметр | Pyramid / Scam | Jetix |
|----------|----------------|-------|
| Источник revenue | Recruitment fees | Real client outcomes |
| Transparency | Закрытые detail | Public-company-style |
| Founder skin-in-game | Часто отсутствует | Full-time + full life investment |
| Real product / service | Слабый или нет | TRM management + Foundation infrastructure |
| Verifiable track record | Нет | Building через milestones (€50K → €100K → €1M) |

### Anti-pyramid mechanism — public company from Day 1
- Метрики / decisions / structure — **видимы для аналитика**
- Любой потенциальный participant может **сам проверить** через open data
- Cross-cuts §6.8 engineering-faith bet

---

## 12.8 НЕ traditional employer (vs corporate / consulting firm employment)

### Похоже потому что
Имеем работников. Платим зарплату. Имеем core team / structure / hierarchy.

### Принципиально отличается
- ❌ **Traditional:** уходишь — теряешь access к knowledge / network / reputation built within. Accumulation испаряется.
- ✅ **Jetix:** уходишь — **накопление остаётся с тобой** (см. §9.3 portable accumulation).

### Конкретно НЕ
- ❌ NDAs которые блокируют using personal learnings post-employment
- ❌ Non-compete clauses ограничивающие future career
- ❌ Proprietary "knowledge of Jetix" lock-in
- ❌ Status games / corporate ladder politics

### Конкретно ЕСТЬ
- ✅ Open methodology library (всё доступно для personal use)
- ✅ Reputation portable (LinkedIn / personal brand остаётся с человеком)
- ✅ Network portable (connections — твои)
- ✅ Skills portable (всё что освоил — твоё)

> **Это fundamentally lower-risk** для skilled people. Даже если не понравится через год — выходишь сильнее чем входил.

---

## 12.9 НЕ автономный AI / AGI / agent-driven enterprise

### Похоже потому что
Активно используем AI agents. 12 ролей. Plan Mode. Compound learning. Methodology library.

### Принципиально отличается
- ❌ **Автономный AI:** работает сам, принимает strategic decisions, действует без human approval.
- ✅ **Jetix:** **autonomy budget = 0** в v1-beta (ADR-004). **Human Gate (Part 6b)** на любых novel actions. AI = augmenter человека, не replacer.

### Тест
Кто принимает финальные strategic decisions?
- AI без human ack — это автономный agent (опасно).
- Каждое крупное действие через Human Gate — это Jetix.

### Будущая эволюция
- **v1-beta (now):** autonomy = 0
- **v1-final:** selective automation для maintenance (lint / build-graph weekly)
- **v2+:** active mode skills с approval flow
- **Никогда:** AI как final decision maker для strategic / financial / values-relevant choices

---

## 12.10 НЕ pure equity-based investor pitch (vs venture capital / angel)

### Похоже потому что
Большая ambition. Phase 2+ может включать equity для founding partners. $1T trajectory.

### Принципиально отличается
- ❌ **Venture pitch:** «дай инвестицию X, через N лет получишь Y× return».
- ✅ **Jetix Phase 1:** **revenue-funded growth** (€50K → €200K → €1M через actual клиентов). Investors приходят в Phase 2+ **с validation**, не до.

### Skin-in-game founder
- $20-30K self-funded базовый перед раскрытием investors
- **D15 revenue-gated unlocks** — каждая фаза unlock'ается **через actual revenue**, не через more funding rounds
- Investors как partners (см. §9.1 Investor Partner subtype) с aligned long-term, не как pure capital providers

### Тест
Если бизнес зависит от **next funding round** для survival — это venture-style. Если **revenue-funded growth** + investors как **strategic partners** — Jetix-style.

---

## 12.11 НЕ pure think-tank / philosophy retreat (vs research foundations)

### Похоже потому что
Имеем methodology development. Knowledge accumulation. Long-term horizon (200y vision). Philosophical discussion.

### Принципиально отличается
- ❌ **Think-tank:** philosophical work first, application secondary. Revenue often grant-funded.
- ✅ **Jetix Phase 1:** **revenue + action первичны**. Philosophy и research-direction — Phase 2+.

> **Hard rule (D14):** research = revenue-instrumental в Phase 1. 200-year vision **informs** architecture decisions, но Phase 1 execution — только то что **serves near-term revenue**.

### Тест
Если основная activity = thinking / writing / discussing **без shipping artifacts** — think-tank. Если **shipped artifacts + paying customers** + thinking как support — Jetix.

---

## 12.X Сводка anti-patterns

| # | НЕ это | Главное отличие | Quick тест |
|---|--------|-----------------|------------|
| 12.1 | Classic consulting firm | Performance fee + ownership результата | Зависит ли revenue от роста клиента? |
| 12.2 | AI-стартап с продуктом | Methodology > tool | Главный продукт = software или methodology? |
| 12.3 | Holding / family office | 6 ресурсов одновременно vs 1 | Покупаем ли компании или augment'им владельцев? |
| 12.4 | Accelerator / incubator | Long-term operational partner vs program | Cohort batches + demo days? |
| 12.5 | Social network / open community | Curated closed network | Открытая регистрация для всех? |
| 12.6 | Notion-стек / productivity stack | Архитектура vs collection of tools | Парализованы при падении любого вендора? |
| 12.7 | Pyramid / scam / hype | Real outcomes vs recruitment fees | Транспарентность founder skin-in-game? |
| 12.8 | Traditional employer | Portable accumulation | Можно ли использовать learnings после exit? |
| 12.9 | Автономный AI / AGI | Human Gate на decisions | AI принимает final strategic decisions сам? |
| 12.10 | Pure venture pitch | Revenue-funded growth | Зависим от next funding round? |
| 12.11 | Think-tank / philosophy retreat | Revenue + action первичны | Shipping artifacts + paying customers? |

> **Главный вывод:** Jetix Corp существует в **нестандартной категории** — она **новая**, поэтому instinctively сравнивается с похожими но фундаментально другими формами бизнеса. Этот раздел должен быть **первым обязательным reading** для любого потенциального участника — чтобы не было mismatch expectations.

---

# 📎 Appendix

> Дополнительные материалы — справки / источники / глоссарий / changelog. **Не обязательны** для понимания основного текста, но полезны при углублённом изучении.

---

## A. 📚 Источники этого документа

> Откуда взяты ключевые тезисы / numbers / framings.

### A.1 Canonical Jetix LOCKED documents
- **`decisions/JETIX-WORKSHOP-CONCEPT-2026-04-30.md`** — Workshop metaphor v1 LOCKED (271 строка, источник для §1, §2)
- **`decisions/JETIX-TRM-MODEL-2026-04-30.md`** — TRM business model LOCKED (источник для §3, §5)
- **`decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md`** — constitutional anchor (§6.1 11 hard rules → Pillar C Tier 2)
- **`decisions/JETIX-VISION.md`** — D1 Identity Document (источник layered identity §1.2, ICP archetypes)
- **`decisions/JETIX-PHILOSOPHY.md`** — D2 (philosophy frame)
- **`decisions/JETIX-PLAN.md`** — D3 (Phase 0/1 actions, used in §10)

### A.2 Parent document (Базовая Система)
- **`decisions/BASE-MANAGEMENT-SYSTEM-2026-05-04.md`** — Документ 1A LOCKED v1.0 2026-05-05 — каркас на котором Jetix Corp = applied use case

### A.3 Synthesis / voice extracts
- `swarm/wiki/synthesis/voice-extract-workshop-people-2026-05-01.md` — voice insights под Workshop углом
- `swarm/wiki/synthesis/foundation-master-overview-human-2026-04-29.md` — Foundation overview reference
- `reports/jetix-source-collection-2026-05-05.md` — comprehensive source collection (1870 строк, базис для этого документа)

### A.4 Wiki concepts / ideas
- `wiki/concepts/korporaciya-startup-concept.md` — D29 корпорация-стартап
- `wiki/concepts/jetix-open-source-principles.md` — Linux philosophy / Revenue Share
- `wiki/concepts/curated-community-access.md` — Phase 3 community model
- `wiki/concepts/founder-isolation-as-stopper-class.md` — operational blocker
- `wiki/ideas/jetix-as-infrastructure-metaphor.md` — alternative дорога/машины
- `wiki/ideas/jetix-agency-strategic-ai-partners.md` — лестница ценности
- `wiki/ideas/200-year-vision-jetix-humanity.md` — long-term horizon
- `wiki/ideas/founder-responsibility-jetix-constitution.md` — built-in safeguards

### A.5 Architecture / design
- `design/JETIX-ARCHITECTURE-WORKING.md` — 8-layer business architecture (parallel concept)
- `design/SYSTEM-DESIGN-HUMAN.md` — стратегический якорь
- `design/SYSTEM-DESIGN-TECH-SUMMARY.md` v1-beta-FINAL (approved 18.04)
- `design/JETIX-FPF.md` — Foundation Pillar Framework

### A.6 Foundation v1.0 LOCKED (для context Pillar C / Parts)
...
- `swarm/wiki/foundations/part-11-strategic-direction-substrate/architecture.md` — Strategic Direction
- Git tag: `foundation-architecture-locked-2026-04-28`

### A.7 Retrospective / context
- `reports/retrospective_2025-05_to_2026-04.md` — 12-month retrospective (Phase 1/2/3 trajectory)

### A.8 Verbatim audio sources (key quotes)
- audio_401 — "Объединить всех авантюристов..." (D1 tagline)
- audio_488 — Jetix как самая пиздатая через работу с другими
- audio_495 — Капитализм → коммунизм на высоких уровнях
- audio_496 — Сопоставимо со странами
- audio_502 — "Jetix это методология ёбаная..."
- audio_503 — "Тактически прибыль, стратегически польза"
- audio_536 — Phase 1 → 2 mechanism (партнёры приводят)
- audio_537 — 6-component synergy formula
- audio_553 — Public dashboard для accountability
- audio_554 — Cooperation, не extraction
- audio_556 — Public-company-style transparency
- audio_557 — Полный набор корпоративного toolkit
- audio_562 — Foundation готов trigger
- audio_563 — Mafia-style closed circle Phase 1
- audio_565 — "Полный набор мега корпорации в одной программке"
- audio_576 — Phase 3 trigger ("когда задачи > одной мастерской")
- audio_582 — "Бульдозер для работы с информацией" (proto-Workshop)
- audio_583, audio_585, audio_586 — Master vs non-master / specialization
- holding-vision-2026-04-21 — Note 5 ($1T trajectory + engineering-faith)

---

## B. 🔗 Связанные документы — что читать дальше

### B.1 Прямой parent (универсальный foundation)
- **`decisions/BASE-MANAGEMENT-SYSTEM-2026-05-04.md`** — Документ 1A LOCKED v1.0 — universal каркас (на нём Jetix построена)

### B.2 Operational support
- `swarm/wiki/operations/quick-log-template.md` — quick-log для Toggl daily
- `swarm/wiki/operations/time-tracking-categories.md` — canonical doc по time tracking v1.1
- Notion Daily Log DB (`30a24963-33bf-8005-817a-000beb10bcd4`) — ежедневные планы

### B.3 Foundation deep dives
Каждая из 11 Foundation Parts имеет свой полный architecture.md в `swarm/wiki/foundations/part-N-*/`. Plus Pillar C — `swarm/wiki/foundations/principles/architecture.md`. Read order — см. Документ 1A Appendix B.

### B.4 Jetix-specific deep dives
- Workshop concept v1 LOCKED — детально про метафору + 7 элементов мастерской
- TRM model LOCKED — детально про 6 ресурсов + лестницу + 4 варианта реализации + market analysis
- D1 Vision — детально про layered identity + 11 archetypes + ICP filter
- Korporaciya-Startup concept — D29 positioning

### B.5 Constitution и принципы
- `decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md` — 11 constitutional hard rules
- `CLAUDE.md` (root проекта) — главные конвенции
- Pillar C Tier 1 (Manager principles) — для всех participants

---

## C. 📖 Глоссарий — Jetix-specific термины

> **Note:** generic термины (Adaptable станки / Compound learning / Foundation Part / Mastersкая / etc.) — см. Документ 1A Appendix C. Здесь **только** Jetix-specific термины.

---

### **AI Brain on Demand**
Выделенный L0-L1 product Jetix — внешний мозг клиента для разбора одного вопроса. €1500-5000 за гипотезу, маржа 70-90%. См. **§3.7**.

### **Asset Owner**
В Phase 3 платформе — клиент с ресурсами, ищущий Operator. Одна из двух сторон marketplace. См. **§4.5**.

### **Авантюрист (в контексте Jetix)**
Профессионал с personal авантюрой + готовностью вкладываться + long-term mindset. Calculated risk taker, НЕ gambler. 11 типов (founder / менеджер / инвестор / etc.). См. **§6.2**.

### **Авантюра века (главная)**
Главная цель Jetix — улучшение общества + лучшие способы жизни + новые инструменты + новая культура. См. **§6.5**.

### **Авантюра управления**
Гипотеза №4 которую Jetix тестирует — изменение того кому доверяют управление в обществе через demonstration competence-based selection. См. **§6.7**.

### **Cross-resource synergy**
Уникальное преимущество TRM — до 6 operators работают для одного клиента, обмениваются контекстом. См. **§3.12**, **§11.2**.

### **D8 Layered identity**
8 разных лиц Jetix per observer / phase (Methodology+OS / Корпорация-стартап / Consulting / Network / Club / USB-C / Corporation / Civilizational infrastructure). LOCKED Decision 8 в JETIX-VISION. См. **§1.2**.

### **Engineering-faith**
Вера выраженная через resource allocation + engineering preparation, НЕ через affirmations. Главный антипаттерн от blind faith / pyramid / hype. См. **§6.8**.

### **Источник проекта**
Один из 4 типов входящих проектов на платформу (1: Internal Jetix / 2: TRM-driven / 3: External owners / 4: Внутренние участники приводят клиентов). См. **§4.3**.

### **L0-L5 Ladder (Land-and-Expand)**
6 уровней TRM offering от €1.5-5k гипотеза до €30-60k/мес TRM-full. Главный sales motion — «не продаём TRM, продаём гипотезу за €3k и доращиваем». См. **§3.5**.

### **Mafia inside / Predator outside**
Организационная грамматика: внутри cohesion (mafia-style closed trust), снаружи competition (но НЕ aggression at people). См. **§4.7**, **§6.1**.

### **Mittelstand (outdated frame)**
...
В Phase 3 платформе — профессионал управляющий конкретным ресурсом для клиентов. Одна из двух сторон marketplace. См. **§4.5**.

### **Partner (с большой буквы — Уровень 1)**
Top tier participant Jetix с existing capital (audience / tools / resources / influence). Получает доступ к Jetix resources в обмен на contribution + financial participation (5 вариантов A-E). См. **§9.1**.

### **Phase 1 / 2 / 3 эволюция Jetix**
- Phase 1 (2026-2027): сервисная компания, одна мастерская одного владельца
- Phase 2 (2027-2029): управляющая компания, команда + одна мастерская
- Phase 3 (2029+): двусторонняя платформа, community мастеров с мастерскими  

См. **§2 (Workshop frame)**, **§3.11 (TRM frame)**.

### **Portable accumulation (для работников)**
Главный антипаттерн corporate slavery в Jetix — всё что работник накопил (skills / connections / methodology / reputation) **остаётся с ним** после exit. Делает Jetix lower-risk option для skilled people. См. **§9.3**.

### **Reed's Law (применимо к Jetix)**
Network effects formula 2^N (group formations) — стандартное формула для networks с group formation. Jetix имеет это property благодаря multiple value flows + curated quality. См. **§11.4**.

### **TRM (Total Resource Management)**
Центральная business модель Jetix — управление 6 ресурсами клиента одновременно (финансы / время CEO / аудитория / знания / compute / команда) за mgmt fee + performance fee. См. **§3**.

### **TRM Alliance (Variant D)**
Самый быстрый path реализации TRM — альянс-модель где Jetix управляет общей AI-инфраструктурой и знанием для 5-10 клиентов одновременно. См. **§3.6**.

### **TRM-full (L5)**
Финальный уровень Land-and-Expand ladder — все 6 ресурсов под Jetix mgmt, deep integration. €30-60k/мес mgmt + 20-25% performance. ~€670k/год total. См. **§3.4-§3.5**.

### **Tseren / Tseren Tserenov**
Конкретный человек — first concrete Phase 2 partnership target Ruslan'а. Упомянут в §10 Roadmap как critical synergy counterpart.

### **Левенчук / ШСМ**
Анатолий Левенчук — автор школы Системного Мышления (ШСМ). Реальная работающая методология которая может усилить Jetix. Упомянут в §10 Roadmap как critical synergy counterpart.

### **Мастерская инженеров-менеджеров**
Реализация ШСМ Левенчука как operational system. Упоминается в §10 Roadmap как target для synergy.

### **Vision $1T trajectory**
Главная амбиция Jetix — first компания достигшая $1T market cap. XEI precedent: $100B за 2 года. Engineering-faith bet (не gambling). См. **§6.11**, **§8.4**.

### **Worker (Уровень 3)**
Член команды Jetix — entry уровень (basic discipline) или core team (track record + knowledge & skills > просто финансы). Получает зарплату + место созидания + portable accumulation. См. **§7.7**, **§9.3**.
...
| 2026-05-05 | v0.2 | §1 Что такое Jetix — 4 one-liner кандидата + развёрнутое определение (8 направлений + value generation + layered identity 8 лиц) + что НЕ есть + связь с 1A |
| 2026-05-05 | v0.3 | §2 Метафора Мастерской — 3 фазы (Phase 1 одна → Phase 2 команда → Phase 3 community) + Jetix-specific станки + Visual/View principle + Mafia→Community evolution + 10 specializations Phase 3 |
| 2026-05-05 | v0.4 | §3 TRM filled deeply (12 subsections — 6 ресурсов / 3 волны why now / fees / Land-and-Expand L0-L5 / 4 варианта реализации / AI Brain on Demand / архитектура / 6 рисков / vs classic / 3 phase evolution / 3 advantages) |
| 2026-05-05 | v0.5 | §4 Платформа filled (4 источника проектов — добавлен Source 4 «внутренние участники приводят клиентов» / 5 функций / 5 levels проектов / take rate 15-25% / 7 layers anti-disintermediation / Mafia-Predator / chicken-egg / 5 advantages) |
| 2026-05-05 | v0.6 | §5 Управляющая компания filled (key thesis + 5 reasons почему Jetix может брать ответственность + risk-sharing asymmetric + 6 depth levels + trust ladder + юр.структура + 8-параметр comparison + 5 anti-patterns) |
| 2026-05-05 | v0.7 | §6 Авантюра века filled (главная мысль + 11 типов авантюристов + вера в будущее + 4 функции Jetix + 4 направления главной авантюры + 5 гипотез + АВАНТЮРА УПРАВЛЕНИЯ ⭐ + engineering-faith + cooperation + fallback + что если получится) |
| 2026-05-05 | v0.8 | §6.2 cleanup. §7.7 Команда Jetix — entry/core team levels. Knowledge+skills > просто финансы. Manifestation авантюры управления изнутри |
| 2026-05-05 | v0.9 | §8 Видение filled (1y €500K/50clients/10partners + 3y €100M/500+/20+/1000+community + 10y honest 'не ебём но огромное и масштабное' + visible roadmap milestones + 200y horizon) |
...
- §0 TL;DR ✓
- §1 Что такое Jetix Corporation ✓
- §2 Метафора Мастерской — 3 фазы ✓
- §3 TRM ✓ (12 подразделов)
- §4 Платформа ✓ (с 4 источниками + 7 layers anti-disintermediation)
- §5 Управляющая компания ✓
- §6 Авантюра века ✓ (с авантюрой управления)
- §7 ICP ✓ (концептуальный portrait + команда §7.7)
- §8 Видение 1/3/10y ✓
- §9 Предложение — 3 уровня ✓
- §10 Roadmap к $100K ✓
...
**Workflow:** AI = scribe для strategic docs. Все content диктовал Ruslan + extracted из existing canonical docs. AI не предлагал свой content — только структурировал + синтезировал.
