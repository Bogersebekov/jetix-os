---
title: Action Plan — Phase 1 Near Future (May 2026)
date: 2026-05-10
type: action-plan
status: draft (awaiting Ruslan ack)
authored_by: ai-scribe (server-cc, parallel cloud-cowork session)
parent_voice_pipeline: reports/voice-pipeline-2026-05-10/
...
constitutional_anchor:
  - Tier 2 Rule 1 (AI = scribe + analyst + structurer; Ruslan = sole strategist)
  - Tier 2 Rule 2 (no architectural execution without gate; this doc = options paper)
  - Tier 2 Rule 6 (provenance per voice item — memo:line)
  - Append-only (canonical untouched, only new doc + cross-references)
  - Default-Deny (draft → ack → optional canonical updates separately)
F: F4
G: action-plan-phase-1
R: refuted_if_action_items_disconnected_from_voice_provenance OR strategy_authored_instead_of_options_offered
---
...
flowchart LR
    %% --- Current State (left) ---
    subgraph CURRENT_STATE ["📚 <b>Current State</b><br/><small>2026-05-10</small>"]
        direction TB
        FOUNDATION["🏗 <b>Foundation v1.0</b><br/><small>LOCKED 2026-04-28</small>"]:::substrate
        DOC_1B["📄 <b>Document 1B</b><br/><small>LOCKED 2026-05-05<br/>§10 8-step roadmap</small>"]:::substrate
        WORKSHOP["🛠 <b>Workshop concept</b><br/><small>LOCKED 2026-04-30</small>"]:::substrate
        TRM["🏦 <b>TRM model L0-L5</b><br/><small>LOCKED 2026-04-30</small>"]:::substrate
        INSIGHT_FM["💡 Foundation Model<br/><small>deferred Phase-2+</small>"]:::storage
        INSIGHT_PARTNER["🤝 Partnership Model<br/><small>RES.1 / RES.2 / RES.3</small>"]:::storage
    end

    %% --- Voice Insights (47 memos) ---
    subgraph VOICE_INSIGHTS ["🎤 <b>Voice Insights</b><br/><small>47 memos / 1627 items / top-20 lens</small>"]
        direction TB
        T_WORKSHOP["1️⃣ «Мастерская» dominant<br/><small>15+ items</small>"]:::ladder_l0
        T_LEVENCHUK["2️⃣ Levenchuk + Цэрэн<br/><small>critical path</small>"]:::ladder_l0
        T_COUNCIL["3️⃣ Strategic Council 7-8<br/><small>topshorts</small>"]:::ladder_l0
        T_FOUNDATION["4️⃣ Personal Foundation<br/><small>Founder readiness</small>"]:::ladder_l0
        T_OUTREACH["5️⃣ Outreach mechanics<br/><small>FOMO / каскад / гивер</small>"]:::ladder_l0
        T_ONLINE["6️⃣ Online-First pivot<br/><small>RES.1 binding</small>"]:::ladder_l0
        T_OPS["7️⃣ Quitting + reinvest<br/><small>RES.2 binding</small>"]:::ladder_l0
    end

    %% --- Action Ladder (4 tiers) ---
    subgraph ACTION_LADDER ["🪜 <b>Action Ladder</b>"]
        direction TB
        TIER_1["⚡ <b>Tier 1 — 24-48h</b><br/><small>4 actions<br/>⭐ A1.1 Цэрэн video<br/>⭐ A1.2 Levenchuk msg<br/>⭐ A1.3 cash runway</small>"]:::ladder_l1
        TIER_2["📅 <b>Tier 2 — 7 days</b><br/><small>6 actions<br/>A2.1 Council shortlist<br/>A2.2 §7 ICP rewrite<br/>A2.3 verticals pick<br/>A2.4 video drafts<br/>A2.5 Кто я doc<br/>A2.6 outreach posture</small>"]:::ladder_l2
        TIER_3["📆 <b>Tier 3 — 30 days</b><br/><small>6 actions<br/>⭐ A3.1 ШСМ deep dive<br/>A3.2 Document of Truth<br/>⭐ A3.3 first L0 €3K<br/>A3.4 personal practices<br/>A3.5 Council talks<br/>A3.6 cash model</small>"]:::ladder_l3
        TIER_4["📈 <b>Tier 4 — 60-90d</b><br/><small>4 actions<br/>⭐ A4.1 $100K hit<br/>A4.2 Strategic session 2<br/>A4.3 §9 partnership rev<br/>A4.4 reinvest matrix</small>"]:::ladder_l4
    end

    %% --- Phase 1 Success (right) ---
    subgraph PHASE_1_SUCCESS ["🎯 <b>Phase 1 Success</b><br/><small>end-summer 2026</small>"]
        direction TB
        REVENUE["💰 <b>$100K cumulative</b><br/><small>5-10 paying clients<br/>L0-L2 mostly</small>"]:::ladder_l5
        ONLINE_PARTNERS["🌐 Online vertical partners<br/><small>1-2 verticals focused<br/>Цэрэн first instantiation</small>"]:::ladder_l5
        TEAM["👥 Команда 5-10 active<br/><small>Strategic Council 3-5<br/>Workshop integrated ШСМ</small>"]:::ladder_l5
        TRANSITION["🚀 Phase 2 ready<br/><small>Strategic session #2<br/>RES.3 partnership terms<br/>RES.2 90% reinvest baseline</small>"]:::ladder_l5
    end

    %% --- Critical Path Edges ---
    FOUNDATION ==> T_WORKSHOP
    DOC_1B ==> T_LEVENCHUK
    WORKSHOP ==> T_WORKSHOP
    TRM ==> T_OUTREACH
    INSIGHT_PARTNER ==> T_ONLINE
    INSIGHT_PARTNER ==> T_OPS
    ...
    style CURRENT_STATE fill:#fff8e1,stroke:#f57c00,stroke-width:4px
    style VOICE_INSIGHTS fill:#fff8e1,stroke:#f57c00,stroke-width:4px
    style ACTION_LADDER fill:#fff8e1,stroke:#f57c00,stroke-width:4px
    style PHASE_1_SUCCESS fill:#fff8e1,stroke:#f57c00,stroke-width:4px
```
