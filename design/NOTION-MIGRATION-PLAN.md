...
Этого хватит чтобы описать все 6 частей SYSTEM-DESIGN-HUMAN.md.
...
**Объём:** 6 частей документа + 4+ Miro-визуализации + новая секция про миграцию.
...
### 9.1 В Часть 3 "Потоки информации" добавится секция

```
### 3.N Miграция из Notion
...
### 9.2 Новая Часть 7 SYSTEM-DESIGN-HUMAN.md — "Правила миграции Notion"

(Пишется на Фазе β после первого прохода 1-6)

Именно эти правила становятся input'ом для Фазы γ. Без них — хаос.
...
| 2.β | SYSTEM-DESIGN-HUMAN заполнено | ⏳ | 2026-04-17..18 | A |
