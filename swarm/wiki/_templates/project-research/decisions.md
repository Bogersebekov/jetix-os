...
- **Decision:** Bootstrap research project {{SLUG}} at {{PRIORITY}}.
- **Reasoning:** {{FILL_IN — why this research project was started.}}
- **Result:** Scaffold created; mini-swarm spawned (if P1/P2); state: active.
- **Review:** At SG-rd-1 firing or after first cycle, verify problem_statement is still
