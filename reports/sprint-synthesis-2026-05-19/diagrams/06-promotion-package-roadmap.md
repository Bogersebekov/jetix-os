---
title: "Diagram 06 — Promotion Package 6-Doc Roadmap"
date: 2026-05-19
...
gantt
    ...
    section P1 P1 minimum-viable
    C.7 Monetization model (prerequisite) :crit, m, 2026-05-20, 7d
    C.1 Pitch one-pager (1-page A4 RU+EN) :crit, c1, after m, 4d
    C.2 Pitch deck v1 (8-12 slides RU+EN) :crit, c2, after m, 7d

    section P2 Mid-term
    C.3 Technical doc (engineer audience)  :c3, after c1, 7d
    C.4 Vision narrative (L3 audience)     :c4, 2026-06-02, 14d

    section P3 Long-term
    C.5 Onboarding doc (post-cohort)       :c5, 2026-07-01, 14d
    C.6 Case study (Foundation build)      :c6, 2026-06-10, 14d

    section Operational specs (parallel)
    C.8 Workshop infrastructure spec       :c8, after c1, 3d
    C.9 Outreach queue ops spec            :c9, 2026-05-20, 4d
    C.10 Equal-conditions hackathon design :c10, 2026-06-10, 5d

    section AAP packets (Ruslan-ack required)
    C.11 H9 Responsibility-Era             :c11, 2026-05-22, 7d
    C.12 O-35 Virtual State Legal          :c12, 2026-05-22, 14d
    C.13 R12 explicit clauses §APPEND      :crit, c13, 2026-05-20, 4d
```
