---
title: "Wave 2 — Cross-Pollination Matrix"
date: 2026-05-14
...
flowchart LR
    ...
    HM4[H-M-004 TRM retainer]
    HM5[H-M-005 perf fee]
    HM3[H-M-003 lump-sum]
    HM10[H-M-010 brokerage]
    HM13[H-M-013 marketplace]
    HM8[H-M-008 cert fee]
    HM6[H-M-006 subscription]
    HM2[H-M-002 equity]
    HM16[H-M-016 R&D fund]

    %% Audience earnings
    HA1[H-A-001 Quest bounty]
    HA2[H-A-002 freelance bid]
    HA4[H-A-004 cert uplift]
    HA10[H-A-010 mentor cascade]
    HA13[H-A-013 Realm goods]
    HA16[H-A-016 rank uplift]

    %% Cooperation
    HC1[H-C-001 rank vis]
    HC2[H-C-002 Season retro]
    HC3[H-C-003 long-cycle]
    HC7[H-C-007 Charter sign]
    HC8[H-C-008 Manifest]
    HC9[H-C-009 archetypes]
    HC10[H-C-010 joint Quest split]
    HC11[H-C-011 cross-Clan bonus]
    HC15[H-C-015 self-image]
    HC16[H-C-016 rituals]
    HC17[H-C-017 friendship]

    %% Federation
    HF1[H-F-001 Joint Quests]
    HF5[H-F-005 shared KB]

    %% Onboarding
    HO5[H-O-005 influencer funnel]
    HO7[H-O-007 Charter funnel]

    %% Strong amplification edges
    HM4 ===|A| HM1
    HM4 ===|A| HM5
    HM3 ===|C| HM4
    HM1 ===|C| HM10
    ...
    HM6 -.->|R| HM9[H-M-009]
    HM6 -.->|R| HM7[H-M-007]
    HC6[H-C-006 no-poach] -.->|B| HF6[H-F-006 cross-mentor]

    style HM4 fill:#003355,stroke:#0099cc,color:#fff
    style HC7 fill:#003355,stroke:#0099cc,color:#fff
    style HM1 fill:#335533,stroke:#44cc44,color:#fff
    style HM6 fill:#553333,stroke:#cc4444,color:#fff
```
