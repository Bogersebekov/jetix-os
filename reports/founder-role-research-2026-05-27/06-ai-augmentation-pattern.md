...
**Важно (memory note):** прямые API-вызовы (ANTHROPIC_API_KEY/GROQ_API_KEY) стоят
реальных денег — пользоваться встроенными инструментами Max-подписки, не
API-скриптами, где возможно.
