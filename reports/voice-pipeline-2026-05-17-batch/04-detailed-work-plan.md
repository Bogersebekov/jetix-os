---
title: Voice batch 17.05 — Detailed Work Plan (brigadier-integrated)
date: 2026-05-17
batch_id: voice-pipeline-2026-05-17-batch
phase: Stage 3 per voice-pipeline-2026-05-17-fpf-filtered.md §1.2 + §3.2
type: brigadier-integration
status: brigadier-integrated (3 cells)
F: F4
G: voice-pipeline-2026-05-17-workplan
R: refuted_if_extraction_invents_actions_not_voiced_OR_critical_blockers_not_cross_refd_OR_text_001_work_implications_unsurfaced_OR_R1_violated
cell_drafts:
  - swarm/wiki/drafts/task-voice-pipeline-2026-05-17-mgmt-integrator-workplan-batch.md
  - swarm/wiki/drafts/task-voice-pipeline-2026-05-17-engineering-integrator-fpf-batch.md (work items §6 cross-cell)
  - swarm/wiki/drafts/task-voice-pipeline-2026-05-17-philosophy-critic-reflection-batch.md (use-mention calibration §3)
parents:
  - reports/phase-0-fpf-scope/04-kasha-cleanup-flags.md
  - reports/phase-0-fpf-scope/00-JETIX-FPF-MASTER-2026-05-17.md §QR-CARD critical blockers
...
gantt
    ...
    IA-01 trust-mechanism capture  :crit, ia01, 2026-05-17, 1d
    IA-02 ICP fork ack            :crit, ia02, 2026-05-17, 2d
    IA-03 Tseren+Levenchuk send   :crit, ia03, 2026-05-17, 1d
    IA-04 EP-5 disclosure patch   :crit, ia04, 2026-05-18, 1d

    section This week
    ST-01 FPF collab doc          :active, st01, 2026-05-18, 5d
    ST-02 Plans → FPF translation :st02, 2026-05-19, 4d
    ST-03 Onboarding hypothesis   :st03, 2026-05-19, 3d
    ST-04 B2 Aisystant unblock    :st04, 2026-05-18, 2d
    ST-05 Strategic Council       :st05, 2026-05-18, 2d
    ST-06 Human-readable Jetix    :st06, 2026-05-20, 3d

    section Blockers (resolve before ST-01 publishes)
    BL-05 Foundation dead-link    :bl05, 2026-05-19, 3d

    section Strategic (month+)
    SD-01 FPF cooperation framing :sd01, 2026-06-01, 30d
    SD-02 Trust narrative         :sd02, 2026-06-01, 30d
    SD-04 Human-army elaboration  :sd04, 2026-06-15, 45d
```
