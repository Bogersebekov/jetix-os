...
## §3 Что это такое Jetix — в 1 абзаце

**Jetix = Workshop + Realm + People-Network-State (Heptagon synthesis).** Координирующий substrate для top-tier профессионалов — поверх корпоративных границ и национальных государств. Workshop (мастерская) = substrate engine: знания, методологии, артефакты компаундируются через git-tracked filesystem. Realm = operational layer с геймификацией без cringe (6 archetypes / Marathon Seasons / Clans / Quests / reputation ledger). People-Network-State = эмерджентный класс, гибрид Mondragón pattern (cooperative ownership) + PayPal Mafia pattern (mobility-driven ecosystem) + Network State framework (Balaji — 5/7 steps без cryptohistory / diplomatic recognition). Marathon 10-15 лет, L1 → L6 ladder (1 человек → 10M+). [src: H7 People-Network-State §1-§6]
...
- **Marathon Seasons** — 3-месячные циклы / 10-15 лет horizon. Не «спринт до конца квартала». [src: H6 §4]
...
flowchart TB
    ...
    H7["<b>H7 People-Network-State</b><br/><small>synthesis substrate</small><br/>L0→L6 / 10-15y horizon"]:::storage
