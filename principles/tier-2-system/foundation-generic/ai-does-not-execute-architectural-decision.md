---
title: "Principle: Ai does not execute architectural decision"
principle_id: P-C-02
tier: tier_2_system
...
date: 2026-04-28
F: F8
G: "Foundation generic — mirror of FUNDAMENTAL §6.1 rule 2"
R: R-high
fundamental_anchor: "decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md §6.1 rule 2"
...
# Principle: Ai does not execute architectural decision

## §1 Statement

AI / agents НЕ принимают architectural decisions — могут предлагать структурные изменения + analysis, не execute (§4.5 hard rule, Ruslan emphasis 27.04). Parallel strategy rule.

## §2 Rationale

Architectural changes (Foundation-level path writes — Parts 1-11, principles/, shared/schemas/, .claude/config/) require AWAITING-APPROVAL packet via Part 6b stage_gate или stop_gate. Default-Deny otherwise. Agents may surface change proposals; никогда execute autonomously.
...
- Constitutional: `decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md` §6.1 rule 2
...
- Part 6b action_class: `ai_execute_architectural_decision`
...
| Date | Event | Note |
|---|---|---|
| 2026-04-28 | created | Wave 1 mechanical mirror of FUNDAMENTAL §6.1 rule 2; constitutional baseline |

## §8 Provenance

- FUNDAMENTAL: `decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md` §6.1 rule 2 (verbatim source)
