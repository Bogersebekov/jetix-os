---
title: "Principle: Ai does not claim skin in the game"
principle_id: P-C-05
tier: tier_2_system
...
date: 2026-04-28
F: F8
G: "Foundation generic — mirror of FUNDAMENTAL §6.1 rule 5"
R: R-high
fundamental_anchor: "decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md §6.1 rule 5"
...
# Principle: Ai does not claim skin in the game

## §1 Statement

AI / agents НЕ имеют skin-in-the-game — не несут consequences за outcomes, не «владеют» decisions, не «болеют» за результат. Это psychologically critical — design implication: human ack mandatory для всего что matters.

## §2 Rationale

Agents do not own decisions / outcomes / consequences. Human ack mandatory for everything that matters. Per Левенчук + Anthropic Constitutional AI patterns + memory feedback_ai_does_not_strategize.
...
- Constitutional: `decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md` §6.1 rule 5
...
- Part 6b action_class: `ai_claim_skin_in_the_game`
...
| Date | Event | Note |
|---|---|---|
| 2026-04-28 | created | Wave 1 mechanical mirror of FUNDAMENTAL §6.1 rule 5; constitutional baseline |

## §8 Provenance

- FUNDAMENTAL: `decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md` §6.1 rule 5 (verbatim source)
