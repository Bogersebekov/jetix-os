---
title: "Principle: Ai does not strategize"
principle_id: P-C-01
tier: tier_2_system
...
date: 2026-04-28
F: F8
G: "Foundation generic — mirror of FUNDAMENTAL §6.1 rule 1"
R: R-high
fundamental_anchor: "decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md §6.1 rule 1"
...
# Principle: Ai does not strategize

## §1 Statement

AI / agents НЕ принимают strategic decisions — могут предлагать варианты + reasoning + pros/cons, не имеют authority. Final strategy — sole human responsibility.

## §2 Rationale

Founder = sole strategic authority per FUNDAMENTAL §6.2 founder-agency и Левенчук D2 §13. Agents may surface options + reasoning, never decide. Strategic prose в Pillar A docs carries `prose_authored_by:` field; LOCKED state requires `ruslan` или `hybrid-with-ack-trail`. Agent first-pass prose entering strategic doc без owner pass = halt_log_alert violation.
...
- Constitutional: `decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md` §6.1 rule 1
...
- Part 6b action_class: `ai_strategize_or_set_direction`
...
| Date | Event | Note |
|---|---|---|
| 2026-04-28 | created | Wave 1 mechanical mirror of FUNDAMENTAL §6.1 rule 1; constitutional baseline |

## §8 Provenance

- FUNDAMENTAL: `decisions/JETIX-VISION-FUNDAMENTAL-2026-04-27.md` §6.1 rule 1 (verbatim source)
