---
title: "Principle: Voice pipeline draft only (SCAFFOLD-PENDING-REVIEW)"
principle_id: P-S-06
tier: tier_2_system
category: ruslan_layer_overrides
slug: voice-pipeline-draft-only
date: 2026-04-28
...
candidate_source:
  path: "CLAUDE.md"
  line_range: "164 + 253 (CRM voice-integration discipline)"
...
Candidate source: CLAUDE.md line 164 + 253 (CRM voice-integration discipline)
...
# Principle: Voice pipeline draft only
...
- Original location: CLAUDE.md line 164 + 253 (CRM voice-integration discipline)
